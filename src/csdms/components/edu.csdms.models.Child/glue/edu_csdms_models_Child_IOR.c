/*
 * File:          edu_csdms_models_Child_IOR.c
 * Symbol:        edu.csdms.models.Child-v0.0
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Intermediate Object Representation for edu.csdms.models.Child
 * 
...
static struct edu_csdms_models_Child__epv s_my_epv__edu_csdms_models_child;

static struct edu_csdms_models_Child__epv 
  s_my_epv_contracts__edu_csdms_models_child;

static struct edu_csdms_models_Child__epv 
  s_my_epv_hooks__edu_csdms_models_child;
...
static struct edu_csdms_models_Child__pre_epv s_preEPV;
static struct edu_csdms_models_Child__post_epv s_postEPV;
...
extern void edu_csdms_models_Child__set_epv(
  struct edu_csdms_models_Child__epv* epv,
    struct edu_csdms_models_Child__pre_epv* pre_epv,
    struct edu_csdms_models_Child__post_epv* post_epv);

extern void edu_csdms_models_Child__call_load(void);
#ifdef __cplusplus
}
#endif

static void
edu_csdms_models_Child_boccaSetServices__exec(
  ...
  services = skel_edu_csdms_models_Child_fconnect_gov_cca_Services(services_str,
    TRUE, _ex);SIDL_CHECK(*_ex);
#else
  services_bc = sidl_rmi_InstanceRegistry_getInstanceByString(services_str, 
    _ex);SIDL_CHECK(*_ex);
  if(services_bc != NULL) {
    services= (struct edu_csdms_models_Child__object*) (
      *services_bc->d_epv->f__cast)(services_bc, "edu.csdms.models.Child", _ex);
    if(services != NULL) {
...
static void
edu_csdms_models_Child_boccaReleaseServices__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_boccaForceUsePortInclude__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  int64_t dummy2_tmp= 0;
  int64_t dummy2 = edu_csdms_openmi_ElementType_IDBased;
  char* dummy3_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy3_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_tools_TemplateFiles__object* dummy3 = NULL;
  char* dummy4_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy4_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_tools_IRFPortQueue__object* dummy4 = NULL;
  char* dummy5_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy5_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_tools_Verbose__object* dummy5 = NULL;
  char* dummy6_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy6_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ElementMapper__object* dummy6 = NULL;
...
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ElementSet__object* dummy9 = NULL;
  ...
  dummy0_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy0_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy0_bc != NULL) {
    dummy0= (struct edu_csdms_models_Child__object*) (
      *dummy0_bc->d_epv->f__cast)(dummy0_bc, "edu.csdms.models.Child", _ex);
    if(dummy0 != NULL) {
  ...
  dummy1 = skel_edu_csdms_models_Child_fconnect_edu_csdms_ports_IRFPort(
    dummy1_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy1_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy1_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy1_bc != NULL) {
    dummy1= (struct edu_csdms_models_Child__object*) (
      *dummy1_bc->d_epv->f__cast)(dummy1_bc, "edu.csdms.models.Child", _ex);
    if(dummy1 != NULL) {
...
#endif /* WITH_RMI */
  sidl_rmi_Call_unpackLong( inArgs, "dummy2", &dummy2_tmp, _ex);SIDL_CHECK(
    *_ex);
  dummy2 = (int64_t)dummy2_tmp;
  sidl_rmi_Call_unpackString( inArgs, "dummy3", &dummy3_str, _ex);SIDL_CHECK(
    *_ex);
#ifdef WITH_RMI

  dummy3 = skel_edu_csdms_models_Child_fconnect_edu_csdms_tools_TemplateFiles(
    dummy3_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy3_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy3_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy3_bc != NULL) {
    dummy3= (struct edu_csdms_models_Child__object*) (
      *dummy3_bc->d_epv->f__cast)(dummy3_bc, "edu.csdms.models.Child", _ex);
    if(dummy3 != NULL) {
  ...
  dummy4 = skel_edu_csdms_models_Child_fconnect_edu_csdms_tools_IRFPortQueue(
    dummy4_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy4_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy4_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy4_bc != NULL) {
    dummy4= (struct edu_csdms_models_Child__object*) (
      *dummy4_bc->d_epv->f__cast)(dummy4_bc, "edu.csdms.models.Child", _ex);
    if(dummy4 != NULL) {
  ...
  dummy5 = skel_edu_csdms_models_Child_fconnect_edu_csdms_tools_Verbose(
    dummy5_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy5_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy5_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy5_bc != NULL) {
    dummy5= (struct edu_csdms_models_Child__object*) (
      *dummy5_bc->d_epv->f__cast)(dummy5_bc, "edu.csdms.models.Child", _ex);
    if(dummy5 != NULL) {
  ...
  dummy6 = skel_edu_csdms_models_Child_fconnect_edu_csdms_openmi_ElementMapper(
    dummy6_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy6_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy6_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy6_bc != NULL) {
    dummy6= (struct edu_csdms_models_Child__object*) (
      *dummy6_bc->d_epv->f__cast)(dummy6_bc, "edu.csdms.models.Child", _ex);
    if(dummy6 != NULL) {
  ...
  dummy7 = skel_edu_csdms_models_Child_fconnect_edu_csdms_openmi_ScalarSet(
    dummy7_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy7_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy7_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy7_bc != NULL) {
    dummy7= (struct edu_csdms_models_Child__object*) (
      *dummy7_bc->d_epv->f__cast)(dummy7_bc, "edu.csdms.models.Child", _ex);
    if(dummy7 != NULL) {
  ...
  dummy8 = skel_edu_csdms_models_Child_fconnect_edu_csdms_tools_ConfigDialog(
    dummy8_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy8_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy8_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy8_bc != NULL) {
    dummy8= (struct edu_csdms_models_Child__object*) (
      *dummy8_bc->d_epv->f__cast)(dummy8_bc, "edu.csdms.models.Child", _ex);
    if(dummy8 != NULL) {
  ...
  dummy9 = skel_edu_csdms_models_Child_fconnect_edu_csdms_openmi_ElementSet(
    dummy9_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy9_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy9_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy9_bc != NULL) {
    dummy9= (struct edu_csdms_models_Child__object*) (
      *dummy9_bc->d_epv->f__cast)(dummy9_bc, "edu.csdms.models.Child", _ex);
    if(dummy9 != NULL) {
  ...
  dummy10 = skel_edu_csdms_models_Child_fconnect_edu_csdms_tools_PrintQueue(
    dummy10_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy10_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy10_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy10_bc != NULL) {
    dummy10= (struct edu_csdms_models_Child__object*) (
      *dummy10_bc->d_epv->f__cast)(dummy10_bc, "edu.csdms.models.Child", _ex);
    if(dummy10 != NULL) {
...
static void
edu_csdms_models_Child_addRef__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_deleteRef__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_isSame__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_edu_csdms_models_Child_fconnect_sidl_BaseInterface(iobj_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct edu_csdms_models_Child__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "edu.csdms.models.Child", _ex);
    if(iobj != NULL) {
...
static void
edu_csdms_models_Child_isType__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_getClassInfo__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_setServices__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_releaseServices__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_go__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_initialize__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_run__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_finalize__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_getRaster_nx__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_getRaster_ny__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_getRaster_dx__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_getRaster_dy__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_getRaster_ulx__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_getRaster_uly__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_getRaster_grid__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_get_raster_dimen__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_get_raster_res__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_get_raster_data__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_get_time_span__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_get_element_set__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_get_value_set__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_get_value_set_data__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Child_set_value_set__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  values = skel_edu_csdms_models_Child_fconnect_edu_csdms_openmi_IValueSet(
    values_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  values_bc = sidl_rmi_InstanceRegistry_getInstanceByString(values_str, 
    _ex);SIDL_CHECK(*_ex);
  if(values_bc != NULL) {
    values= (struct edu_csdms_models_Child__object*) (
      *values_bc->d_epv->f__cast)(values_bc, "edu.csdms.models.Child", _ex);
    if(values != NULL) {
...
static void
edu_csdms_models_Child__cast__exec(
        struct edu_csdms_models_Child__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_edu_csdms_models_Child__set_contracts(
  struct edu_csdms_models_Child__object* self,
  sidl_bool   enable,
...
static void ior_edu_csdms_models_Child__dump_stats(
  struct edu_csdms_models_Child__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_edu_csdms_models_Child__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    edu_csdms_models_Child__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_edu_csdms_models_Child__cast(
  struct edu_csdms_models_Child__object* self,
...
static void ior_edu_csdms_models_Child__set_hooks(
  struct edu_csdms_models_Child__object* self,
...
static void ior_edu_csdms_models_Child__delete(
  struct edu_csdms_models_Child__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  edu_csdms_models_Child__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct edu_csdms_models_Child__object));
  free((void*) self);
}

static char*
ior_edu_csdms_models_Child__getURL(
  struct edu_csdms_models_Child__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_edu_csdms_models_Child__raddRef(
    struct edu_csdms_models_Child__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_edu_csdms_models_Child__isRemote(
    struct edu_csdms_models_Child__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct edu_csdms_models_Child__method {
  const char *d_name;
  void (*d_func)(struct edu_csdms_models_Child__object*,
...
static void
ior_edu_csdms_models_Child__exec(
  struct edu_csdms_models_Child__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct edu_csdms_models_Child__method  s_methods[] = {
    { "_cast", edu_csdms_models_Child__cast__exec },
    { "addRef", edu_csdms_models_Child_addRef__exec },
    { "boccaForceUsePortInclude", 
      edu_csdms_models_Child_boccaForceUsePortInclude__exec },
    { "boccaReleaseServices", edu_csdms_models_Child_boccaReleaseServices__exec 
      },
    { "boccaSetServices", edu_csdms_models_Child_boccaSetServices__exec },
    { "deleteRef", edu_csdms_models_Child_deleteRef__exec },
    { "finalize", edu_csdms_models_Child_finalize__exec },
    { "getClassInfo", edu_csdms_models_Child_getClassInfo__exec },
    { "getRaster_dx", edu_csdms_models_Child_getRaster_dx__exec },
    { "getRaster_dy", edu_csdms_models_Child_getRaster_dy__exec },
    { "getRaster_grid", edu_csdms_models_Child_getRaster_grid__exec },
    { "getRaster_nx", edu_csdms_models_Child_getRaster_nx__exec },
    { "getRaster_ny", edu_csdms_models_Child_getRaster_ny__exec },
    { "getRaster_ulx", edu_csdms_models_Child_getRaster_ulx__exec },
    { "getRaster_uly", edu_csdms_models_Child_getRaster_uly__exec },
    { "get_element_set", edu_csdms_models_Child_get_element_set__exec },
    { "get_raster_data", edu_csdms_models_Child_get_raster_data__exec },
    { "get_raster_dimen", edu_csdms_models_Child_get_raster_dimen__exec },
    { "get_raster_res", edu_csdms_models_Child_get_raster_res__exec },
    { "get_time_span", edu_csdms_models_Child_get_time_span__exec },
    { "get_value_set", edu_csdms_models_Child_get_value_set__exec },
    { "get_value_set_data", edu_csdms_models_Child_get_value_set_data__exec },
    { "go", edu_csdms_models_Child_go__exec },
    { "initialize", edu_csdms_models_Child_initialize__exec },
    { "isSame", edu_csdms_models_Child_isSame__exec },
    { "isType", edu_csdms_models_Child_isType__exec },
    { "releaseServices", edu_csdms_models_Child_releaseServices__exec },
    { "run", edu_csdms_models_Child_run__exec },
    { "setServices", edu_csdms_models_Child_setServices__exec },
    { "set_value_set", edu_csdms_models_Child_set_value_set__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct edu_csdms_models_Child__method);
  *_ex  = NULL; /* default to no exception */
...
static void edu_csdms_models_Child__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct edu_csdms_models_Child__epv*   epv  = &s_my_epv__edu_csdms_models_child;
  ...
  epv->f__cast                    = ior_edu_csdms_models_Child__cast;
  epv->f__delete                  = ior_edu_csdms_models_Child__delete;
  epv->f__exec                    = ior_edu_csdms_models_Child__exec;
  epv->f__getURL                  = ior_edu_csdms_models_Child__getURL;
  epv->f__raddRef                 = ior_edu_csdms_models_Child__raddRef;
  epv->f__isRemote                = ior_edu_csdms_models_Child__isRemote;
  epv->f__set_hooks               = ior_edu_csdms_models_Child__set_hooks;
  epv->f__set_contracts           = ior_edu_csdms_models_Child__set_contracts;
  epv->f__dump_stats              = ior_edu_csdms_models_Child__dump_stats;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  ...
  epv->f_addRef                   = (void (*)(struct edu_csdms_models_Child__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef                = (void (*)(struct edu_csdms_models_Child__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct edu_csdms_models_Child__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct edu_csdms_models_Child__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct edu_csdms_models_Child__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  ...
  edu_csdms_models_Child__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  ior_edu_csdms_models_Child__ensure_load_called();
}

/*
 * edu_csdms_models_Child__getEPVs: Get my version of all relevant EPVs.
 */

void edu_csdms_models_Child__getEPVs (
  ...
  struct edu_csdms_models_Child__epv **s_arg_epv__edu_csdms_models_child,
  struct edu_csdms_models_Child__epv **s_arg_epv_hooks__edu_csdms_models_child)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    edu_csdms_models_Child__init_epv();
  }
  ...
  *s_arg_epv__edu_csdms_models_child = &s_my_epv__edu_csdms_models_child;
  *s_arg_epv_hooks__edu_csdms_models_child = &s_my_epv_hooks__edu_csdms_models_child;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* edu_csdms_models_Child__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "edu.csdms.models.Child", _ex);
...
static void
initMetadata(struct edu_csdms_models_Child__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * edu_csdms_models_Child__createObject: Allocate the object and initialize it.
 */

struct edu_csdms_models_Child__object*
edu_csdms_models_Child__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct edu_csdms_models_Child__object* self =
    (struct edu_csdms_models_Child__object*) sidl_malloc(
      sizeof(struct edu_csdms_models_Child__object),
      "Object allocation failed for struct edu_csdms_models_Child__object",
        __FILE__, __LINE__, "edu_csdms_models_Child__createObject", _ex);
  if (!self) goto EXIT;
  edu_csdms_models_Child__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void edu_csdms_models_Child__init(
  struct edu_csdms_models_Child__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_models_Child__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv                            = &s_my_epv__edu_csdms_models_child;
...
void edu_csdms_models_Child__fini(
  struct edu_csdms_models_Child__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_models_Child__object* s0 = self;
...
void
edu_csdms_models_Child__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct edu_csdms_models_Child__external
s_externalEntryPoints = {
  edu_csdms_models_Child__createObject,
  edu_csdms_models_Child__getSuperEPV,
  2, 
  0
};
...
const struct edu_csdms_models_Child__external*
edu_csdms_models_Child__externals(void)
{
