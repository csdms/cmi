/*
 * File:          edu_csdms_models_Child_IOR.h
...
#define included_edu_csdms_models_Child_IOR_h
...
struct edu_csdms_models_Child__array;
...
struct edu_csdms_models_Child__epv {
  ...
  int32_t (*f_go)(
    /* in */ struct edu_csdms_models_Child__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in edu.csdms.models.Child-v0.0 */
...
struct edu_csdms_models_Child__pre_epv {
...
struct edu_csdms_models_Child__post_epv {
...
struct edu_csdms_models_Child__cstats {
  sidl_bool use_hooks;
};
...
struct edu_csdms_models_Child__object {
  ...
  struct edu_csdms_models_Child__epv*     d_epv;
  struct edu_csdms_models_Child__cstats   d_cstats;
  void*                                   d_data;
};

struct edu_csdms_models_Child__external {
  struct edu_csdms_models_Child__object*
...
extern struct edu_csdms_models_Child__object*
edu_csdms_models_Child__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Child__init(
  struct edu_csdms_models_Child__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Child__getEPVs(
...
extern void edu_csdms_models_Child__fini(
  struct edu_csdms_models_Child__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Child__IOR_version(int32_t *major, int32_t *minor);
...
struct edu_csdms_tools_IRFPortQueue__object* 
  skel_edu_csdms_models_Child_fconnect_edu_csdms_tools_IRFPortQueue(const char* 
  url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct gov_cca_ports_ParameterPortFactory__object* 
  skel_edu_csdms_models_Child_fconnect_gov_cca_ports_ParameterPortFactory(const 
  char* url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_openmi_IValueSet__object* 
  skel_edu_csdms_models_Child_fconnect_edu_csdms_openmi_IValueSet(const char* 
  url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_tools_ConfigDialog__object* 
  skel_edu_csdms_models_Child_fconnect_edu_csdms_tools_ConfigDialog(const char* 
  url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct gov_cca_Services__object* 
...
struct edu_csdms_ports_IRFPort__object* 
  skel_edu_csdms_models_Child_fconnect_edu_csdms_ports_IRFPort(const char* url, 
  sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_tools_Verbose__object* 
  skel_edu_csdms_models_Child_fconnect_edu_csdms_tools_Verbose(const char* url, 
  sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_openmi_ScalarSet__object* 
  skel_edu_csdms_models_Child_fconnect_edu_csdms_openmi_ScalarSet(const char* 
  url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_openmi_ElementSet__object* 
  skel_edu_csdms_models_Child_fconnect_edu_csdms_openmi_ElementSet(const char* 
  url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_models_Child__remote{
  int d_refcount;
