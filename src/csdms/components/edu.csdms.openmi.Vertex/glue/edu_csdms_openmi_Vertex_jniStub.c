/*
 * File:          edu_csdms_openmi_Vertex_jniStub.c
 * Symbol:        edu.csdms.openmi.Vertex-v0.0
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Client-side JNI glue code for edu.csdms.openmi.Vertex
 * 
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t edu_csdms_openmi_Vertex__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &edu_csdms_openmi_Vertex__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &edu_csdms_openmi_Vertex__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &edu_csdms_openmi_Vertex__mutex )==EDEADLOCK) */
#else
...
static struct edu_csdms_openmi_Vertex__epv s_rem_epv__edu_csdms_openmi_vertex;
...
static void* remote_edu_csdms_openmi_Vertex__cast(
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    cmp = strcmp(name, "edu.csdms.openmi.Vertex");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = ((struct edu_csdms_openmi_Vertex__object*)self);
      return cast;
    }
  }
  else if (cmp > 0) {
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct 
      edu_csdms_openmi_Vertex__remote*)self->d_data)->d_ih, _ex);
  }
...
static void remote_edu_csdms_openmi_Vertex__delete(
  struct edu_csdms_openmi_Vertex__object* self,
...
static char* remote_edu_csdms_openmi_Vertex__getURL(
  struct edu_csdms_openmi_Vertex__object* self, struct 
    sidl_BaseInterface__object* *_ex)
{
  struct sidl_rmi_InstanceHandle__object *conn = ((struct 
    edu_csdms_openmi_Vertex__remote*)self->d_data)->d_ih;
  *_ex = NULL;
  if(conn != NULL) {
...
static void remote_edu_csdms_openmi_Vertex__raddRef(
  struct edu_csdms_openmi_Vertex__object* self,struct 
    sidl_BaseInterface__object* *_ex)
{
...
static sidl_bool
remote_edu_csdms_openmi_Vertex__isRemote(
    struct edu_csdms_openmi_Vertex__object* self, 
    struct sidl_BaseInterface__object* *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_edu_csdms_openmi_Vertex__set_hooks(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      ...
      "Exception unserialized from edu.csdms.openmi.Vertex._set_hooks.",
        &throwaway_exception);
...
static void
remote_edu_csdms_openmi_Vertex__set_contracts(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex._set_contracts.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_openmi_Vertex__dump_stats(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex._dump_stats.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void remote_edu_csdms_openmi_Vertex__exec(
  struct edu_csdms_openmi_Vertex__object* self,const char* methodName,
...
/* REMOTE METHOD STUB:getX */
static double
remote_edu_csdms_openmi_Vertex_getX(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex.getX.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
/* REMOTE METHOD STUB:getY */
static double
remote_edu_csdms_openmi_Vertex_getY(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex.getY.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
/* REMOTE METHOD STUB:getZ */
static double
remote_edu_csdms_openmi_Vertex_getZ(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex.getZ.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
/* REMOTE METHOD STUB:setX */
static void
remote_edu_csdms_openmi_Vertex_setX(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* in */ double x,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex.setX.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
/* REMOTE METHOD STUB:setY */
static void
remote_edu_csdms_openmi_Vertex_setY(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* in */ double y,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex.setY.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
/* REMOTE METHOD STUB:setZ */
static void
remote_edu_csdms_openmi_Vertex_setZ(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* in */ double z,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex.setZ.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_openmi_Vertex_boccaForceUsePortInclude(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex.boccaForceUsePortInclude.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_openmi_Vertex_addRef(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    struct edu_csdms_openmi_Vertex__remote* r_obj = (struct 
      edu_csdms_openmi_Vertex__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: addRef %p new count %d (type %s)\n",
      r_obj, r_obj->d_refcount, 
      "edu.csdms.openmi.Vertex Remote Stub");
...
static void
remote_edu_csdms_openmi_Vertex_deleteRef(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    r_obj->d_refcount--;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: deleteRef %p new count %d (type %s)\n",r_obj, r_obj->d_refcount, "edu.csdms.openmi.Vertex Remote Stub");
#endif /* SIDL_DEBUG_REFCOUNT */ 
...
static sidl_bool
remote_edu_csdms_openmi_Vertex_isSame(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex.isSame.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static sidl_bool
remote_edu_csdms_openmi_Vertex_isType(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* in */ const char* name,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex.isType.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
remote_edu_csdms_openmi_Vertex_getClassInfo(
  /* in */ struct edu_csdms_openmi_Vertex__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vertex.getClassInfo.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void edu_csdms_openmi_Vertex__init_remote_epv(void)
{
  /* assert( HAVE_LOCKED_STATIC_GLOBALS ); */
  struct edu_csdms_openmi_Vertex__epv* epv = 
    &s_rem_epv__edu_csdms_openmi_vertex;
  struct sidl_BaseClass__epv*          e0  = &s_rem_epv__sidl_baseclass;
  struct sidl_BaseInterface__epv*      e1  = &s_rem_epv__sidl_baseinterface;

  epv->f__cast                         = remote_edu_csdms_openmi_Vertex__cast;
  epv->f__delete                       = remote_edu_csdms_openmi_Vertex__delete;
  epv->f__exec                         = remote_edu_csdms_openmi_Vertex__exec;
  epv->f__getURL                       = remote_edu_csdms_openmi_Vertex__getURL;
  epv->f__raddRef                      = 
    remote_edu_csdms_openmi_Vertex__raddRef;
  epv->f__isRemote                     = 
    remote_edu_csdms_openmi_Vertex__isRemote;
  epv->f__set_hooks                    = 
    remote_edu_csdms_openmi_Vertex__set_hooks;
  ...
  epv->f__ctor2                        = NULL;
  epv->f__dtor                         = NULL;
  epv->f_getX                          = remote_edu_csdms_openmi_Vertex_getX;
  epv->f_getY                          = remote_edu_csdms_openmi_Vertex_getY;
  epv->f_getZ                          = remote_edu_csdms_openmi_Vertex_getZ;
  epv->f_setX                          = remote_edu_csdms_openmi_Vertex_setX;
  epv->f_setY                          = remote_edu_csdms_openmi_Vertex_setY;
  epv->f_setZ                          = remote_edu_csdms_openmi_Vertex_setZ;
  epv->f_boccaForceUsePortInclude      = 
    remote_edu_csdms_openmi_Vertex_boccaForceUsePortInclude;
  epv->f_addRef                        = remote_edu_csdms_openmi_Vertex_addRef;
  epv->f_deleteRef                     = 
    remote_edu_csdms_openmi_Vertex_deleteRef;
  epv->f_isSame                        = remote_edu_csdms_openmi_Vertex_isSame;
  epv->f_isType                        = remote_edu_csdms_openmi_Vertex_isType;
  epv->f_getClassInfo                  = 
    remote_edu_csdms_openmi_Vertex_getClassInfo;
...
edu_csdms_openmi_Vertex__remoteConnect(const char *url, sidl_bool ar, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct edu_csdms_openmi_Vertex__object* self = NULL;

  struct edu_csdms_openmi_Vertex__object* s0;
  struct sidl_BaseClass__object* s1;

  struct edu_csdms_openmi_Vertex__remote* r_obj = NULL;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    struct edu_csdms_openmi_Vertex__object* retobj = NULL;
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_BaseInterface bi = (
      sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(objectID,
      _ex); SIDL_CHECK(*_ex);
    (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    retobj = (struct edu_csdms_openmi_Vertex__object*) (*bi->d_epv->f__cast)(
      bi->d_object, "edu.csdms.openmi.Vertex", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, 
    "edu.csdms.openmi.Vertex", ar, _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct edu_csdms_openmi_Vertex__object*) malloc(
      sizeof(struct edu_csdms_openmi_Vertex__object));

  r_obj =
    (struct edu_csdms_openmi_Vertex__remote*) malloc(
      sizeof(struct edu_csdms_openmi_Vertex__remote));
  ...
  if(!self || !r_obj) {
    ...
    sidl_MemAllocException_add(ex, __FILE__, __LINE__, 
      "edu.csdms.openmi.Vertex.EPVgeneration", _ex);
    SIDL_CHECK(*_ex);
  ...
  if (!s_remote_initialized) {
    edu_csdms_openmi_Vertex__init_remote_epv();
  }
  UNLOCK_STATIC_GLOBALS;
  ...
  s0->d_epv  = &s_rem_epv__edu_csdms_openmi_vertex;
...
static struct edu_csdms_openmi_Vertex__object*
edu_csdms_openmi_Vertex__IHConnect(sidl_rmi_InstanceHandle instance, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct edu_csdms_openmi_Vertex__object* self = NULL;
...
static struct edu_csdms_openmi_Vertex__object*
edu_csdms_openmi_Vertex__remoteCreate(const char *url, struct 
  sidl_BaseInterface__object **_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "edu.csdms.openmi.Vertex", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct edu_csdms_openmi_Vertex__object*) malloc(
      sizeof(struct edu_csdms_openmi_Vertex__object));
...
edu_csdms_openmi_Vertex__connectI(const char* url, sidl_bool ar, struct 
  sidl_BaseInterface__object **_ex)
{
  return edu_csdms_openmi_Vertex__remoteConnect(url, ar, _ex);
}
...
static struct edu_csdms_openmi_Vertex__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct edu_csdms_openmi_Vertex__object*) ptr;
}
...
static const struct edu_csdms_openmi_Vertex__external* s_external = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(edu_csdms_openmi_Vertex__remoteCreate(_tmp_url, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject obj)
{
  ...
  struct edu_csdms_openmi_Vertex__object *_ptr = (*s_external->createObject)(
    g_data, &_ex);
  (void) env;
  (void) cls;
  if(_ex) {
  ...
  jstring url)
{
  ...
  struct sidl_BaseInterface__object *_ex = NULL;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(edu_csdms_openmi_Vertex__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject obj)
{
  ...
  struct edu_csdms_openmi_Vertex__object* _ior = NULL;
  double _ior_res = 0.0;
  jdouble _res = 0.0;
  struct sidl_BaseInterface__object *_ex = NULL;
...
void edu_csdms_openmi_Vertex__register(JNIEnv* env)
{
  JNINativeMethod methods[13];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = edu_csdms_openmi_Vertex__externals();
#else
  s_external = (struct edu_csdms_openmi_Vertex__external*)sidl_dynamicLoadIOR(
    "edu.csdms.openmi.Vertex","edu_csdms_openmi_Vertex__externals") ;
  sidl_checkIORVersion("edu.csdms.openmi.Vertex", 
  ...
  methods[2].signature = "(Ledu/csdms/openmi/Vertex;)J";
  ...
  methods[6].name      = "getX";
  methods[6].signature = "()D";
  methods[6].fnPtr     = (void *)jni_getX;
  methods[7].name      = "getY";
  methods[7].signature = "()D";
  methods[7].fnPtr     = (void *)jni_getY;
  methods[8].name      = "getZ";
  methods[8].signature = "()D";
  methods[8].fnPtr     = (void *)jni_getZ;
  methods[9].name      = "setX";
  methods[9].signature = "(D)V";
  methods[9].fnPtr     = (void *)jni_setX;
  methods[10].name      = "setY";
  methods[10].signature = "(D)V";
  methods[10].fnPtr     = (void *)jni_setY;
  methods[11].name      = "setZ";
  methods[11].signature = "(D)V";
  methods[11].fnPtr     = (void *)jni_setZ;
  methods[12].name      = "boccaForceUsePortInclude";
  methods[12].signature = "()V";
  methods[12].fnPtr     = (void *)jni_boccaForceUsePortInclude;


  cls = (*env)->FindClass(env, "edu/csdms/openmi/Vertex");
  if (cls) {
