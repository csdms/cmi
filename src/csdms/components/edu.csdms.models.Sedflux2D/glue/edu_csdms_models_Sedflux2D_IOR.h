/*
 * File:          edu_csdms_models_Sedflux2D_IOR.h
...
#define included_edu_csdms_models_Sedflux2D_IOR_h
...
struct edu_csdms_models_Sedflux2D__epv {
  ...
  int32_t (*f_go)(
    /* in */ struct edu_csdms_models_Sedflux2D__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in edu.csdms.models.Sedflux2D-v0.0 */
...
struct edu_csdms_models_Sedflux2D__pre_epv {
...
struct edu_csdms_models_Sedflux2D__post_epv {
...
struct edu_csdms_models_Sedflux2D__cstats {
  sidl_bool use_hooks;
};
...
struct edu_csdms_models_Sedflux2D__object {
  ...
  struct edu_csdms_models_Sedflux2D__epv*   d_epv;
  struct edu_csdms_models_Sedflux2D__cstats d_cstats;
  void*                                     d_data;
};

struct edu_csdms_models_Sedflux2D__external {
  struct edu_csdms_models_Sedflux2D__object*
...
extern struct edu_csdms_models_Sedflux2D__object*
edu_csdms_models_Sedflux2D__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Sedflux2D__init(
  struct edu_csdms_models_Sedflux2D__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Sedflux2D__getEPVs(
  ...
  struct edu_csdms_models_Sedflux2D__epv 
    **s_arg_epv__edu_csdms_models_sedflux2d,
  struct edu_csdms_models_Sedflux2D__epv 
    **s_arg_epv_hooks__edu_csdms_models_sedflux2d);

extern void edu_csdms_models_Sedflux2D__fini(
  struct edu_csdms_models_Sedflux2D__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Sedflux2D__IOR_version(int32_t *major, int32_t 
  *minor);
...
struct edu_csdms_openmi_IValueSet__object* 
  ...
  char* url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_models_Sedflux2D__remote{
  int d_refcount;
