/*
 * File:          ElementSet.java
 * Symbol:        edu.csdms.openmi.ElementSet-v0.0
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Client-side glue code for edu.csdms.openmi.ElementSet
 * 
 ...
 */
public class ElementSet extends
  ...
  sidl.BaseInterface
{
  ...
  static {
    gov.llnl.sidl.BaseClass._registerNatives("edu.csdms.openmi.ElementSet");
  }
   ...
   */
  protected static native long _wrap(ElementSet ddata);

  /**
   * Remote constructor for the class.
   */
  public ElementSet(java.lang.String url) {
  ...
  public static gov.llnl.sidl.BaseClass _connect(java.lang.String url) {
    return (gov.llnl.sidl.BaseClass) new ElementSet(_connect_remote_ior(url));
  }
  ...
  public native void setElements(
    edu.csdms.openmi.Element.Array1 values);

  /**
   * Method:  addElement[]
   */
  public native void addElement(
    edu.csdms.openmi.Element element);

  /**
   * Method:  setElementType[]
   */
  public native void setElementType(
    long elementType);

  /**
   * Method:  setSpatialReference[]
   */
  public native void setSpatialReference(
    edu.csdms.openmi.ISpatialReference spatialReference);

  /**
   * Method:  setRasterGrid[]
   */
  public native void setRasterGrid(
    int nx,
    int ny,
    double dx,
    double dy,
  ...
  public native void boccaForceUsePortInclude(
    edu.csdms.openmi.SpatialReference dummy0,
    edu.csdms.openmi.Element dummy1,
    edu.csdms.openmi.ISpatialReference dummy2);
   ...
   */
  public native edu.csdms.openmi.ISpatialReference getSpatialReference();

  /**
   * Method:  getElementType[]
   */
  public native long getElementType();
   ...
   */
  public native int getElementIndex(
    java.lang.String elementID);

  /**
   * Method:  getElementID[]
   */
  public native java.lang.String getElementID(
    int elementIndex);
   ...
   */
  public native sidl.Integer.Array1 getFaceVertexIndices(
    int elementIndex,
    int faceIndex);
   ...
   */
  public native double getXCoordinate(
    int elementIndex,
    int vertexIndex);
   ...
   */
  public native double getYCoordinate(
    int elementIndex,
    int vertexIndex);
   ...
   */
  public native double getZCoordinate(
    int elementIndex,
    int vertexIndex);
  ...
  public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
    ...
    long ior = obj._cast_ior("edu.csdms.openmi.ElementSet");
    if (ior != 0) {
      Class java_class = null;
      try {
        java_class = Class.forName("edu.csdms.openmi.ElementSet");
      } catch (Exception ex) {
  ...
  public static class Holder {
    private edu.csdms.openmi.ElementSet d_obj;
     ...
     */
    public Holder(edu.csdms.openmi.ElementSet obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(edu.csdms.openmi.ElementSet obj) {
      d_obj = obj;
    }
     ...
     */
    public edu.csdms.openmi.ElementSet get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public edu.csdms.openmi.ElementSet _get(int i, int j, int k, int l, int m, 
      int n, int o) {
      edu.csdms.openmi.ElementSet ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (edu.csdms.openmi.ElementSet) preCast._cast2(
          "edu.csdms.openmi.ElementSet");
      } else {
        return null;
      }
      return (edu.csdms.openmi.ElementSet) ret;
    }
    ...
    public void _set(int i, int j, int k, int l, int m, int n, int o, 
      edu.csdms.openmi.ElementSet value) {
     ...
     */
    public edu.csdms.openmi.ElementSet.Array _slice(int dimen, int[] numElem, 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new edu.csdms.openmi.ElementSet.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new edu.csdms.openmi.ElementSet.Array(
        preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(edu.csdms.openmi.ElementSet.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        edu.csdms.openmi.ElementSet.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new edu.csdms.openmi.ElementSet.Array1(
            getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new edu.csdms.openmi.ElementSet.Array2(
            getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new edu.csdms.openmi.ElementSet.Array3(
            getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new edu.csdms.openmi.ElementSet.Array4(
            getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new edu.csdms.openmi.ElementSet.Array5(
            getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new edu.csdms.openmi.ElementSet.Array6(
            getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new edu.csdms.openmi.ElementSet.Array7(
            getBaseInterfaceArray());
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.ElementSet.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.ElementSet.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.ElementSet.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.ElementSet.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.ElementSet 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(edu.csdms.openmi.ElementSet[] array, boolean isRow) {
      super();
     ...
     */
    public edu.csdms.openmi.ElementSet _get( int j0) {
      return (edu.csdms.openmi.ElementSet)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.ElementSet get( int j0) {
      checkBounds(  j0);
      edu.csdms.openmi.ElementSet ret = null;
      ret = (edu.csdms.openmi.ElementSet) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public edu.csdms.openmi.ElementSet.Array1 smartCopy() {
      edu.csdms.openmi.ElementSet.Array1 ret = null;
      edu.csdms.openmi.ElementSet.Array preCast = null;
      preCast = (edu.csdms.openmi.ElementSet.Array) _smartCopy();
      return new edu.csdms.openmi.ElementSet.Array1(
     ...
     */
    public void copy(edu.csdms.openmi.ElementSet.Array1 dest) {
      _copy((edu.csdms.openmi.ElementSet.Array) dest);
    }
     ...
     */
    public void _set( int j0,edu.csdms.openmi.ElementSet value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,edu.csdms.openmi.ElementSet value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( edu.csdms.openmi.ElementSet[] orray , boolean inRow) 
      {
      int[] lower = new int[7];
     ...
     * 
     */
    public edu.csdms.openmi.ElementSet[] toArray() {
      edu.csdms.openmi.ElementSet[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new edu.csdms.openmi.ElementSet[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.ElementSet.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.ElementSet.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.ElementSet.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.ElementSet.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.ElementSet 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(edu.csdms.openmi.ElementSet[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.ElementSet _get( int j0, int j1) {
      return (edu.csdms.openmi.ElementSet)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.ElementSet get( int j0, int j1) {
      checkBounds(  j0,  j1);
      edu.csdms.openmi.ElementSet ret = null;
      ret = (edu.csdms.openmi.ElementSet) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.ElementSet.Array2 smartCopy() {
      edu.csdms.openmi.ElementSet.Array2 ret = null;
      edu.csdms.openmi.ElementSet.Array preCast = null;
      preCast = (edu.csdms.openmi.ElementSet.Array) _smartCopy();
      return new edu.csdms.openmi.ElementSet.Array2(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.ElementSet.Array2 dest) {
      _copy((edu.csdms.openmi.ElementSet.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,edu.csdms.openmi.ElementSet value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,edu.csdms.openmi.ElementSet value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( edu.csdms.openmi.ElementSet[][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
    ...
    public edu.csdms.openmi.ElementSet[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new edu.csdms.openmi.ElementSet[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new edu.csdms.openmi.ElementSet[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.ElementSet.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.ElementSet.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.ElementSet.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.ElementSet.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.ElementSet 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(edu.csdms.openmi.ElementSet[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.ElementSet _get( int j0, int j1, int j2) {
      return (edu.csdms.openmi.ElementSet)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.ElementSet get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      edu.csdms.openmi.ElementSet ret = null;
      ret = (edu.csdms.openmi.ElementSet) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.ElementSet.Array3 smartCopy() {
      edu.csdms.openmi.ElementSet.Array3 ret = null;
      edu.csdms.openmi.ElementSet.Array preCast = null;
      preCast = (edu.csdms.openmi.ElementSet.Array) _smartCopy();
      return new edu.csdms.openmi.ElementSet.Array3(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.ElementSet.Array3 dest) {
      _copy((edu.csdms.openmi.ElementSet.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,edu.csdms.openmi.ElementSet value) 
      {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,edu.csdms.openmi.ElementSet value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public edu.csdms.openmi.ElementSet[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new edu.csdms.openmi.ElementSet[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new edu.csdms.openmi.ElementSet[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.ElementSet.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.ElementSet.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.ElementSet.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.ElementSet.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.ElementSet 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(edu.csdms.openmi.ElementSet[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.ElementSet _get( int j0, int j1, int j2, int j3) {
      return (edu.csdms.openmi.ElementSet)_get(  j0,  j1,  j2,  j3, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.ElementSet get( int j0, int j1, int j2, int j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      edu.csdms.openmi.ElementSet ret = null;
      ret = (edu.csdms.openmi.ElementSet) _get(  j0,  j1,  j2,  j3, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.ElementSet.Array4 smartCopy() {
      edu.csdms.openmi.ElementSet.Array4 ret = null;
      edu.csdms.openmi.ElementSet.Array preCast = null;
      preCast = (edu.csdms.openmi.ElementSet.Array) _smartCopy();
      return new edu.csdms.openmi.ElementSet.Array4(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.ElementSet.Array4 dest) {
      _copy((edu.csdms.openmi.ElementSet.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,
      edu.csdms.openmi.ElementSet value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,edu.csdms.openmi.ElementSet 
      value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new edu.csdms.openmi.ElementSet[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new edu.csdms.openmi.ElementSet[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.ElementSet.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.ElementSet.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.ElementSet.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.ElementSet.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.ElementSet 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(edu.csdms.openmi.ElementSet[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public edu.csdms.openmi.ElementSet _get( int j0, int j1, int j2, int j3, 
      int j4) {
      return (edu.csdms.openmi.ElementSet)_get(  j0,  j1,  j2,  j3,  j4, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.ElementSet get( int j0, int j1, int j2, int j3, int 
      j4) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      edu.csdms.openmi.ElementSet ret = null;
      ret = (edu.csdms.openmi.ElementSet) _get(  j0,  j1,  j2,  j3,  j4, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.ElementSet.Array5 smartCopy() {
      edu.csdms.openmi.ElementSet.Array5 ret = null;
      edu.csdms.openmi.ElementSet.Array preCast = null;
      preCast = (edu.csdms.openmi.ElementSet.Array) _smartCopy();
      return new edu.csdms.openmi.ElementSet.Array5(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.ElementSet.Array5 dest) {
      _copy((edu.csdms.openmi.ElementSet.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( edu.csdms.openmi.ElementSet[][][][][] orray , 
      boolean inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new edu.csdms.openmi.ElementSet[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new edu.csdms.openmi.ElementSet[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.ElementSet.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.ElementSet.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.ElementSet.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.ElementSet.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.ElementSet 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(edu.csdms.openmi.ElementSet[][][][][][] array, boolean isRow) 
      {
      super();
      fromArray(array, isRow);
    }
    ...
    public edu.csdms.openmi.ElementSet _get( int j0, int j1, int j2, int j3, 
      int j4, int j5) {
      return (edu.csdms.openmi.ElementSet)_get(  j0,  j1,  j2,  j3,  j4,  j5, 
        0);
    }
    ...
    public edu.csdms.openmi.ElementSet get( int j0, int j1, int j2, int j3, int 
      ...
      edu.csdms.openmi.ElementSet ret = null;
      ret = (edu.csdms.openmi.ElementSet) _get(  j0,  j1,  j2,  j3,  j4,  j5, 
        0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.ElementSet.Array6 smartCopy() {
      edu.csdms.openmi.ElementSet.Array6 ret = null;
      edu.csdms.openmi.ElementSet.Array preCast = null;
      preCast = (edu.csdms.openmi.ElementSet.Array) _smartCopy();
      return new edu.csdms.openmi.ElementSet.Array6(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.ElementSet.Array6 dest) {
      _copy((edu.csdms.openmi.ElementSet.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                ...
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new 
                    edu.csdms.openmi.ElementSet[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.ElementSet.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.ElementSet.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.ElementSet.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.ElementSet.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.ElementSet 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(edu.csdms.openmi.ElementSet[][][][][][][] array, boolean 
      isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.ElementSet.Array7 smartCopy() {
      edu.csdms.openmi.ElementSet.Array7 ret = null;
      edu.csdms.openmi.ElementSet.Array preCast = null;
      preCast = (edu.csdms.openmi.ElementSet.Array) _smartCopy();
      return new edu.csdms.openmi.ElementSet.Array7(
        preCast.getBaseInterfaceArray());
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.ElementSet.Array7 dest) {
      _copy((edu.csdms.openmi.ElementSet.Array) dest);
    }
                ...
                for (int m = l4; m <= u4; m++) {
                  ...
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new 
                      edu.csdms.openmi.ElementSet[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.ElementSet.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.ElementSet.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.ElementSet.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.ElementSet.Array7 get() {
        return d_obj;
      }
