/*
 * File:          edu_csdms_models_Sedflux3D_IOR.h
...
#define included_edu_csdms_models_Sedflux3D_IOR_h
...
struct edu_csdms_tools_TemplateFiles__array;
...
struct edu_csdms_models_Sedflux3D__epv {
  ...
  int32_t (*f_go)(
    /* in */ struct edu_csdms_models_Sedflux3D__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in edu.csdms.models.Sedflux3D-v0.0 */
...
struct edu_csdms_models_Sedflux3D__pre_epv {
...
struct edu_csdms_models_Sedflux3D__post_epv {
...
struct edu_csdms_models_Sedflux3D__cstats {
  sidl_bool use_hooks;
};
...
struct edu_csdms_models_Sedflux3D__object {
  ...
  struct edu_csdms_models_Sedflux3D__epv*   d_epv;
  struct edu_csdms_models_Sedflux3D__cstats d_cstats;
  void*                                     d_data;
};

struct edu_csdms_models_Sedflux3D__external {
  struct edu_csdms_models_Sedflux3D__object*
...
extern struct edu_csdms_models_Sedflux3D__object*
edu_csdms_models_Sedflux3D__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Sedflux3D__init(
  struct edu_csdms_models_Sedflux3D__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Sedflux3D__getEPVs(
  ...
  struct edu_csdms_models_Sedflux3D__epv 
    **s_arg_epv__edu_csdms_models_sedflux3d,
  struct edu_csdms_models_Sedflux3D__epv 
    **s_arg_epv_hooks__edu_csdms_models_sedflux3d);

extern void edu_csdms_models_Sedflux3D__fini(
  struct edu_csdms_models_Sedflux3D__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Sedflux3D__IOR_version(int32_t *major, int32_t 
  *minor);
...
struct edu_csdms_openmi_ScalarSet__object* 
  ...
  char* url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_models_Sedflux3D__remote{
  int d_refcount;
