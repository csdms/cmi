/*
 * File:          edu_csdms_models_Sedflux3D_IOR.c
 * Symbol:        edu.csdms.models.Sedflux3D-v0.0
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Intermediate Object Representation for edu.csdms.models.Sedflux3D
 * 
...
#include "sidlOps.h"
#endif
#include "edu_csdms_models_Sedflux3D_IOR.h"
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t edu_csdms_models_Sedflux3D__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &edu_csdms_models_Sedflux3D__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &edu_csdms_models_Sedflux3D__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &edu_csdms_models_Sedflux3D__mutex )==EDEADLOCK) */
#else
...
static struct edu_csdms_models_Sedflux3D__epv 
  s_my_epv__edu_csdms_models_sedflux3d;

static struct edu_csdms_models_Sedflux3D__epv 
  s_my_epv_contracts__edu_csdms_models_sedflux3d;

static struct edu_csdms_models_Sedflux3D__epv 
  s_my_epv_hooks__edu_csdms_models_sedflux3d;
...
static struct edu_csdms_models_Sedflux3D__pre_epv s_preEPV;
static struct edu_csdms_models_Sedflux3D__post_epv s_postEPV;
...
extern void edu_csdms_models_Sedflux3D__set_epv(
  struct edu_csdms_models_Sedflux3D__epv* epv,
    struct edu_csdms_models_Sedflux3D__pre_epv* pre_epv,
    struct edu_csdms_models_Sedflux3D__post_epv* post_epv);

extern void edu_csdms_models_Sedflux3D__call_load(void);
#ifdef __cplusplus
}
#endif

static void
edu_csdms_models_Sedflux3D_boccaSetServices__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
  ...
  services = skel_edu_csdms_models_Sedflux3D_fconnect_gov_cca_Services(
    services_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  services_bc = sidl_rmi_InstanceRegistry_getInstanceByString(services_str, 
    _ex);SIDL_CHECK(*_ex);
  if(services_bc != NULL) {
    services= (struct edu_csdms_models_Sedflux3D__object*) (
      *services_bc->d_epv->f__cast)(services_bc, "edu.csdms.models.Sedflux3D", 
      _ex);
    if(services != NULL) {
...
static void
edu_csdms_models_Sedflux3D_boccaReleaseServices__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_checkException__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  excpt = skel_edu_csdms_models_Sedflux3D_fconnect_sidl_BaseInterface(excpt_str,
    TRUE, _ex);SIDL_CHECK(*_ex);
#else
  excpt_bc = sidl_rmi_InstanceRegistry_getInstanceByString(excpt_str, 
    _ex);SIDL_CHECK(*_ex);
  if(excpt_bc != NULL) {
    excpt= (struct edu_csdms_models_Sedflux3D__object*) (
      *excpt_bc->d_epv->f__cast)(excpt_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(excpt != NULL) {
...
static void
edu_csdms_models_Sedflux3D_boccaForceUsePortInclude__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
#endif /* WITH_RMI */
  struct edu_csdms_ports_IRFPort__object* dummy1 = NULL;
  char* dummy2_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy2_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_ports_IRFPort__object* dummy2 = NULL;
  char* dummy3_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy3_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_tools_IRFPortQueue__object* dummy3 = NULL;
  char* dummy4_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy4_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_tools_Verbose__object* dummy4 = NULL;
  char* dummy5_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy5_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ValueSet__object* dummy5 = NULL;
  char* dummy6_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy6_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_tools_TemplateFiles__object* dummy6 = NULL;
  char* dummy7_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy7_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ScalarSet__object* dummy7 = NULL;
  char* dummy8_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy8_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_tools_ConfigDialog__object* dummy8 = NULL;
  char* dummy9_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy9_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_IScalarSet__object* dummy9 = NULL;
  char* dummy10_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy10_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_tools_PrintQueue__object* dummy10 = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  ...
  dummy0 = 
    skel_edu_csdms_models_Sedflux3D_fconnect_gov_cca_ports_ParameterPortFactory(
    dummy0_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy0_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy0_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy0_bc != NULL) {
    dummy0= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy0_bc->d_epv->f__cast)(dummy0_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(dummy0 != NULL) {
  ...
  dummy1 = skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_ports_IRFPort(
    dummy1_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy1_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy1_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy1_bc != NULL) {
    dummy1= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy1_bc->d_epv->f__cast)(dummy1_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(dummy1 != NULL) {
  ...
  dummy2 = skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_ports_IRFPort(
    dummy2_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy2_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy2_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy2_bc != NULL) {
    dummy2= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy2_bc->d_epv->f__cast)(dummy2_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(dummy2 != NULL) {
  ...
  dummy3 = 
    skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_tools_IRFPortQueue(
    dummy3_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy3_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy3_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy3_bc != NULL) {
    dummy3= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy3_bc->d_epv->f__cast)(dummy3_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(dummy3 != NULL) {
  ...
  dummy4 = skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_tools_Verbose(
    dummy4_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy4_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy4_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy4_bc != NULL) {
    dummy4= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy4_bc->d_epv->f__cast)(dummy4_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(dummy4 != NULL) {
  ...
  dummy5 = skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_openmi_ValueSet(
    dummy5_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy5_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy5_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy5_bc != NULL) {
    dummy5= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy5_bc->d_epv->f__cast)(dummy5_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(dummy5 != NULL) {
...
#endif /* WITH_RMI */
  sidl_rmi_Call_unpackString( inArgs, "dummy6", &dummy6_str, _ex);SIDL_CHECK(
    *_ex);
#ifdef WITH_RMI

  dummy6 = 
    skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_tools_TemplateFiles(
    dummy6_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy6_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy6_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy6_bc != NULL) {
    dummy6= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy6_bc->d_epv->f__cast)(dummy6_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(dummy6 != NULL) {
      (((struct sidl_BaseInterface__object*)(dummy6))->d_epv->f_deleteRef)(((
        struct sidl_BaseInterface__object*)dummy6)->d_object, _ex); SIDL_CHECK(
        *_ex);
    } else {
      (*dummy6_bc->d_epv->f_deleteRef)(dummy6_bc, _ex);
    }
  }
#endif /* WITH_RMI */
  sidl_rmi_Call_unpackString( inArgs, "dummy7", &dummy7_str, _ex);SIDL_CHECK(
    *_ex);
#ifdef WITH_RMI

  dummy7 = skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_openmi_ScalarSet(
    dummy7_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy7_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy7_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy7_bc != NULL) {
    dummy7= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy7_bc->d_epv->f__cast)(dummy7_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(dummy7 != NULL) {
      (((struct sidl_BaseInterface__object*)(dummy7))->d_epv->f_deleteRef)(((
        struct sidl_BaseInterface__object*)dummy7)->d_object, _ex); SIDL_CHECK(
        *_ex);
    } else {
      (*dummy7_bc->d_epv->f_deleteRef)(dummy7_bc, _ex);
    }
  }
#endif /* WITH_RMI */
  sidl_rmi_Call_unpackString( inArgs, "dummy8", &dummy8_str, _ex);SIDL_CHECK(
    *_ex);
#ifdef WITH_RMI

  dummy8 = 
    skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_tools_ConfigDialog(
    dummy8_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy8_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy8_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy8_bc != NULL) {
    dummy8= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy8_bc->d_epv->f__cast)(dummy8_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(dummy8 != NULL) {
      (((struct sidl_BaseInterface__object*)(dummy8))->d_epv->f_deleteRef)(((
        struct sidl_BaseInterface__object*)dummy8)->d_object, _ex); SIDL_CHECK(
        *_ex);
    } else {
      (*dummy8_bc->d_epv->f_deleteRef)(dummy8_bc, _ex);
    }
  }
#endif /* WITH_RMI */
  sidl_rmi_Call_unpackString( inArgs, "dummy9", &dummy9_str, _ex);SIDL_CHECK(
    *_ex);
#ifdef WITH_RMI

  dummy9 = skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_openmi_IScalarSet(
    dummy9_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy9_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy9_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy9_bc != NULL) {
    dummy9= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy9_bc->d_epv->f__cast)(dummy9_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(dummy9 != NULL) {
      (((struct sidl_BaseInterface__object*)(dummy9))->d_epv->f_deleteRef)(((
        struct sidl_BaseInterface__object*)dummy9)->d_object, _ex); SIDL_CHECK(
        *_ex);
    } else {
      (*dummy9_bc->d_epv->f_deleteRef)(dummy9_bc, _ex);
    }
  }
#endif /* WITH_RMI */
  sidl_rmi_Call_unpackString( inArgs, "dummy10", &dummy10_str, _ex);SIDL_CHECK(
    *_ex);
#ifdef WITH_RMI

  dummy10 = skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_tools_PrintQueue(
    dummy10_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy10_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy10_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy10_bc != NULL) {
    dummy10= (struct edu_csdms_models_Sedflux3D__object*) (
      *dummy10_bc->d_epv->f__cast)(dummy10_bc, "edu.csdms.models.Sedflux3D", 
      _ex);
    if(dummy10 != NULL) {
      (((struct sidl_BaseInterface__object*)(dummy10))->d_epv->f_deleteRef)(((
        struct sidl_BaseInterface__object*)dummy10)->d_object, _ex); SIDL_CHECK(
        *_ex);
    } else {
      (*dummy10_bc->d_epv->f_deleteRef)(dummy10_bc, _ex);
    }
  }
#endif /* WITH_RMI */
  ...
  if(dummy6_str) {free(dummy6_str);}
  if(dummy6) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)dummy6, &_ex3); EXEC_CHECK(
      _ex3);
  }
  if(dummy7_str) {free(dummy7_str);}
  if(dummy7) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)dummy7, &_ex3); EXEC_CHECK(
      _ex3);
  }
  if(dummy8_str) {free(dummy8_str);}
  if(dummy8) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)dummy8, &_ex3); EXEC_CHECK(
      _ex3);
  }
  if(dummy9_str) {free(dummy9_str);}
  if(dummy9) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)dummy9, &_ex3); EXEC_CHECK(
      _ex3);
  }
  if(dummy10_str) {free(dummy10_str);}
  if(dummy10) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)dummy10, &_ex3); 
      EXEC_CHECK(_ex3);
  }
  EXEC_ERR:
  if(*_ex) { 
...
static void
edu_csdms_models_Sedflux3D_addRef__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_deleteRef__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_isSame__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_edu_csdms_models_Sedflux3D_fconnect_sidl_BaseInterface(iobj_str, 
    TRUE, _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct edu_csdms_models_Sedflux3D__object*) (
      *iobj_bc->d_epv->f__cast)(iobj_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(iobj != NULL) {
...
static void
edu_csdms_models_Sedflux3D_isType__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_getClassInfo__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_setServices__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_releaseServices__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_go__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_initialize__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_run__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_finalize__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_getRaster_nx__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_getRaster_ny__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_getRaster_dx__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_getRaster_dy__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_getRaster_ulx__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_getRaster_uly__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_getRaster_grid__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_get_raster_dimen__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_get_raster_res__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_get_raster_data__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_get_time_span__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_get_element_set__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_get_value_set__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_get_value_set_data__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Sedflux3D_set_value_set__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  values = skel_edu_csdms_models_Sedflux3D_fconnect_edu_csdms_openmi_IValueSet(
    values_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  values_bc = sidl_rmi_InstanceRegistry_getInstanceByString(values_str, 
    _ex);SIDL_CHECK(*_ex);
  if(values_bc != NULL) {
    values= (struct edu_csdms_models_Sedflux3D__object*) (
      *values_bc->d_epv->f__cast)(values_bc, "edu.csdms.models.Sedflux3D", _ex);
    if(values != NULL) {
...
static void
edu_csdms_models_Sedflux3D__cast__exec(
        struct edu_csdms_models_Sedflux3D__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_edu_csdms_models_Sedflux3D__set_contracts(
  struct edu_csdms_models_Sedflux3D__object* self,
  sidl_bool   enable,
...
static void ior_edu_csdms_models_Sedflux3D__dump_stats(
  struct edu_csdms_models_Sedflux3D__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_edu_csdms_models_Sedflux3D__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    edu_csdms_models_Sedflux3D__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_edu_csdms_models_Sedflux3D__cast(
  struct edu_csdms_models_Sedflux3D__object* self,
  ...
  if (!cmp) {
    ...
    if (!cmp) {
      ...
      if (!cmp) {
        ...
        cmp = strcmp(name, "edu.csdms.models.Sedflux3D");
        if (!cmp) {
          (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
          cast = ((struct edu_csdms_models_Sedflux3D__object*)self);
          return cast;
        }
      }
    }
...
static void ior_edu_csdms_models_Sedflux3D__set_hooks(
  struct edu_csdms_models_Sedflux3D__object* self,
...
static void ior_edu_csdms_models_Sedflux3D__delete(
  struct edu_csdms_models_Sedflux3D__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  edu_csdms_models_Sedflux3D__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct edu_csdms_models_Sedflux3D__object));
  free((void*) self);
}

static char*
ior_edu_csdms_models_Sedflux3D__getURL(
  struct edu_csdms_models_Sedflux3D__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_edu_csdms_models_Sedflux3D__raddRef(
    struct edu_csdms_models_Sedflux3D__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_edu_csdms_models_Sedflux3D__isRemote(
    struct edu_csdms_models_Sedflux3D__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct edu_csdms_models_Sedflux3D__method {
  const char *d_name;
  void (*d_func)(struct edu_csdms_models_Sedflux3D__object*,
...
static void
ior_edu_csdms_models_Sedflux3D__exec(
  struct edu_csdms_models_Sedflux3D__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct edu_csdms_models_Sedflux3D__method  s_methods[] = {
    { "_cast", edu_csdms_models_Sedflux3D__cast__exec },
    { "addRef", edu_csdms_models_Sedflux3D_addRef__exec },
    { "boccaForceUsePortInclude", 
      edu_csdms_models_Sedflux3D_boccaForceUsePortInclude__exec },
    { "boccaReleaseServices", 
      edu_csdms_models_Sedflux3D_boccaReleaseServices__exec },
    { "boccaSetServices", edu_csdms_models_Sedflux3D_boccaSetServices__exec },
    { "checkException", edu_csdms_models_Sedflux3D_checkException__exec },
    { "deleteRef", edu_csdms_models_Sedflux3D_deleteRef__exec },
    { "finalize", edu_csdms_models_Sedflux3D_finalize__exec },
    { "getClassInfo", edu_csdms_models_Sedflux3D_getClassInfo__exec },
    { "getRaster_dx", edu_csdms_models_Sedflux3D_getRaster_dx__exec },
    { "getRaster_dy", edu_csdms_models_Sedflux3D_getRaster_dy__exec },
    { "getRaster_grid", edu_csdms_models_Sedflux3D_getRaster_grid__exec },
    { "getRaster_nx", edu_csdms_models_Sedflux3D_getRaster_nx__exec },
    { "getRaster_ny", edu_csdms_models_Sedflux3D_getRaster_ny__exec },
    { "getRaster_ulx", edu_csdms_models_Sedflux3D_getRaster_ulx__exec },
    { "getRaster_uly", edu_csdms_models_Sedflux3D_getRaster_uly__exec },
    { "get_element_set", edu_csdms_models_Sedflux3D_get_element_set__exec },
    { "get_raster_data", edu_csdms_models_Sedflux3D_get_raster_data__exec },
    { "get_raster_dimen", edu_csdms_models_Sedflux3D_get_raster_dimen__exec },
    { "get_raster_res", edu_csdms_models_Sedflux3D_get_raster_res__exec },
    { "get_time_span", edu_csdms_models_Sedflux3D_get_time_span__exec },
    { "get_value_set", edu_csdms_models_Sedflux3D_get_value_set__exec },
    { "get_value_set_data", edu_csdms_models_Sedflux3D_get_value_set_data__exec 
      },
    { "go", edu_csdms_models_Sedflux3D_go__exec },
    { "initialize", edu_csdms_models_Sedflux3D_initialize__exec },
    { "isSame", edu_csdms_models_Sedflux3D_isSame__exec },
    { "isType", edu_csdms_models_Sedflux3D_isType__exec },
    { "releaseServices", edu_csdms_models_Sedflux3D_releaseServices__exec },
    { "run", edu_csdms_models_Sedflux3D_run__exec },
    { "setServices", edu_csdms_models_Sedflux3D_setServices__exec },
    { "set_value_set", edu_csdms_models_Sedflux3D_set_value_set__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct edu_csdms_models_Sedflux3D__method);
  *_ex  = NULL; /* default to no exception */
...
static void edu_csdms_models_Sedflux3D__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct edu_csdms_models_Sedflux3D__epv*  epv  = &s_my_epv__edu_csdms_models_sedflux3d;
  ...
  epv->f__cast                    = ior_edu_csdms_models_Sedflux3D__cast;
  epv->f__delete                  = ior_edu_csdms_models_Sedflux3D__delete;
  epv->f__exec                    = ior_edu_csdms_models_Sedflux3D__exec;
  epv->f__getURL                  = ior_edu_csdms_models_Sedflux3D__getURL;
  epv->f__raddRef                 = ior_edu_csdms_models_Sedflux3D__raddRef;
  epv->f__isRemote                = ior_edu_csdms_models_Sedflux3D__isRemote;
  epv->f__set_hooks               = ior_edu_csdms_models_Sedflux3D__set_hooks;
  epv->f__set_contracts           = ior_edu_csdms_models_Sedflux3D__set_contracts;
  epv->f__dump_stats              = ior_edu_csdms_models_Sedflux3D__dump_stats;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  ...
  epv->f_addRef                   = (void (*)(struct edu_csdms_models_Sedflux3D__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef                = (void (*)(struct edu_csdms_models_Sedflux3D__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct edu_csdms_models_Sedflux3D__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct edu_csdms_models_Sedflux3D__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct edu_csdms_models_Sedflux3D__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  ...
  edu_csdms_models_Sedflux3D__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  ior_edu_csdms_models_Sedflux3D__ensure_load_called();
}

/*
 * edu_csdms_models_Sedflux3D__getEPVs: Get my version of all relevant EPVs.
 */

void edu_csdms_models_Sedflux3D__getEPVs (
  ...
  struct edu_csdms_models_Sedflux3D__epv **s_arg_epv__edu_csdms_models_sedflux3d,
  struct edu_csdms_models_Sedflux3D__epv **s_arg_epv_hooks__edu_csdms_models_sedflux3d)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    edu_csdms_models_Sedflux3D__init_epv();
  }
  ...
  *s_arg_epv__edu_csdms_models_sedflux3d = &s_my_epv__edu_csdms_models_sedflux3d;
  *s_arg_epv_hooks__edu_csdms_models_sedflux3d = &s_my_epv_hooks__edu_csdms_models_sedflux3d;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* edu_csdms_models_Sedflux3D__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "edu.csdms.models.Sedflux3D", _ex);
...
static void
initMetadata(struct edu_csdms_models_Sedflux3D__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * edu_csdms_models_Sedflux3D__createObject: Allocate the object and initialize it.
 */

struct edu_csdms_models_Sedflux3D__object*
edu_csdms_models_Sedflux3D__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct edu_csdms_models_Sedflux3D__object* self =
    (struct edu_csdms_models_Sedflux3D__object*) sidl_malloc(
      sizeof(struct edu_csdms_models_Sedflux3D__object),
      "Object allocation failed for struct edu_csdms_models_Sedflux3D__object",
        __FILE__, __LINE__, "edu_csdms_models_Sedflux3D__createObject", _ex);
  if (!self) goto EXIT;
  edu_csdms_models_Sedflux3D__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void edu_csdms_models_Sedflux3D__init(
  struct edu_csdms_models_Sedflux3D__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_models_Sedflux3D__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv                            = &s_my_epv__edu_csdms_models_sedflux3d;
...
void edu_csdms_models_Sedflux3D__fini(
  struct edu_csdms_models_Sedflux3D__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_models_Sedflux3D__object* s0 = self;
...
void
edu_csdms_models_Sedflux3D__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct edu_csdms_models_Sedflux3D__external
s_externalEntryPoints = {
  edu_csdms_models_Sedflux3D__createObject,
  edu_csdms_models_Sedflux3D__getSuperEPV,
  2, 
  0
};
...
const struct edu_csdms_models_Sedflux3D__external*
edu_csdms_models_Sedflux3D__externals(void)
{
