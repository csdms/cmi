// 
// File:          edu_csdms_models_stm_GravelSandTransition_Impl.hxx
...
#ifndef included_edu_csdms_models_stm_GravelSandTransition_Impl_hxx
#define included_edu_csdms_models_stm_GravelSandTransition_Impl_hxx

#ifndef included_sidl_cxx_hxx
#include "sidl_cxx.hxx"
#endif
#ifndef included_edu_csdms_models_stm_GravelSandTransition_IOR_h
#include "edu_csdms_models_stm_GravelSandTransition_IOR.h"
#endif
#ifndef included_edu_csdms_models_stm_GravelSandTransition_hxx
#include "edu_csdms_models_stm_GravelSandTransition.hxx"
#endif
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.GravelSandTransition._hincludes)
// Insert-Code-Here {edu.csdms.models.stm.GravelSandTransition._hincludes} (includes or arbitrary code)
#include "Initialize.h"
#include "Run.h"
#include "Finalize.h"
#include "SaveDatatoMatrix.h"
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.GravelSandTransition._hincludes)
  ...
  namespace csdms { 
    namespace models { 
      namespace stm { 
        ...
        /**
         * Symbol "edu.csdms.models.stm.GravelSandTransition" (version 0.0)
         */
        class GravelSandTransition_impl : public virtual 
          ::edu::csdms::models::stm::GravelSandTransition 
        // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.GravelSandTransition._inherits)
        // Insert-Code-Here {edu.csdms.models.stm.GravelSandTransition._inherits} (optional inheritance here)
        // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.GravelSandTransition._inherits)
        ...
        protected:
          ...
          // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.GravelSandTransition._implementation)

  // Insert-UserCode-Here(edu.csdms.models.stm.GravelSandTransition._implementation)
gov::cca::TypeMap userinput;
    int check, prints, iterates, Ms, Mg, k, m;
    double xbarg[101], xbars[101], x[202], eta[202], Sl[203], H[202], qb[202], tau[202];
    double Sgrav[101], Ssand[202], qgrav[101], qsand[202];
    double sgs, Qbf, L, sgsl, ksid, ksidot, subrate, Yearstart, Yearstop;
    ...
    double *sgsvector, *Lvector;

  // Bocca generated code. bocca.protected.begin(edu.csdms.models.stm.GravelSandTransition._implementation)
  
   gov::cca::Services    d_services; // our cca handle.
 

  // Bocca generated code. bocca.protected.end(edu.csdms.models.stm.GravelSandTransition._implementation)

          // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.GravelSandTransition._implementation)

        public:
          // default constructor, used for data wrapping(required)
          GravelSandTransition_impl();
          // sidl constructor (required)
          // Note: alternate Skel constructor doesn't call addref()
          // (fixes bug #275)
            GravelSandTransition_impl( struct 
              edu_csdms_models_stm_GravelSandTransition__object * ior ) : 
              StubBase(ior,true), 
          ...
          virtual ~GravelSandTransition_impl() { _dtor(); }
        ...
        };  // end class GravelSandTransition_impl
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.GravelSandTransition._hmisc)
// Insert-Code-Here {edu.csdms.models.stm.GravelSandTransition._hmisc} (miscellaneous things)
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.GravelSandTransition._hmisc)
