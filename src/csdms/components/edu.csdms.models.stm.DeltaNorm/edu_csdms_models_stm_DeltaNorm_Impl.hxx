// 
// File:          edu_csdms_models_stm_DeltaNorm_Impl.hxx
...
#ifndef included_edu_csdms_models_stm_DeltaNorm_Impl_hxx
#define included_edu_csdms_models_stm_DeltaNorm_Impl_hxx

#ifndef included_sidl_cxx_hxx
#include "sidl_cxx.hxx"
#endif
#ifndef included_edu_csdms_models_stm_DeltaNorm_IOR_h
#include "edu_csdms_models_stm_DeltaNorm_IOR.h"
#endif
#ifndef included_edu_csdms_models_stm_DeltaNorm_hxx
#include "edu_csdms_models_stm_DeltaNorm.hxx"
#endif
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.DeltaNorm._hincludes)
// Insert-Code-Here {edu.csdms.models.stm.DeltaNorm._hincludes} (includes or arbitrary code)
#include "Initialize.h"
#include "Run.h"
#include "Finalize.h"
#include "SaveDatatoMatrix.h"
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.DeltaNorm._hincludes)
  ...
  namespace csdms { 
    namespace models { 
      namespace stm { 
        ...
        /**
         * Symbol "edu.csdms.models.stm.DeltaNorm" (version 0.0)
         */
        class DeltaNorm_impl : public virtual 
          ::edu::csdms::models::stm::DeltaNorm 
        // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.DeltaNorm._inherits)
        // Insert-Code-Here {edu.csdms.models.stm.DeltaNorm._inherits} (optional inheritance here)
        // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.DeltaNorm._inherits)
        ...
        protected:
          ...
          // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.DeltaNorm._implementation)

  // Insert-UserCode-Here(edu.csdms.models.stm.DeltaNorm._implementation)
    ...
    double (*Hmatrix)[102], (*taumatrix)[102], (*xmatrix)[102];
    double *suvector, *sssvector, *sbbvector;
  // Bocca generated code. bocca.protected.begin(edu.csdms.models.stm.DeltaNorm._implementation)
  
   gov::cca::Services    d_services; // our cca handle.
 

  // Bocca generated code. bocca.protected.end(edu.csdms.models.stm.DeltaNorm._implementation)

          // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.DeltaNorm._implementation)
        ...
        public:
          ...
          // (fixes bug #275)
            DeltaNorm_impl( struct edu_csdms_models_stm_DeltaNorm__object * ior 
              ) : StubBase(ior,true), 
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.DeltaNorm._hmisc)
// Insert-Code-Here {edu.csdms.models.stm.DeltaNorm._hmisc} (miscellaneous things)
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.DeltaNorm._hmisc)
