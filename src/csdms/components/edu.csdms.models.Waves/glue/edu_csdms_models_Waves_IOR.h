/*
 * File:          edu_csdms_models_Waves_IOR.h
...
#define included_edu_csdms_models_Waves_IOR_h
...
struct edu_csdms_models_Waves__epv {
  ...
  int32_t (*f_go)(
    /* in */ struct edu_csdms_models_Waves__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in edu.csdms.models.Waves-v0.0 */
...
struct edu_csdms_models_Waves__pre_epv {
...
struct edu_csdms_models_Waves__post_epv {
...
struct edu_csdms_models_Waves__cstats {
  sidl_bool use_hooks;
};
...
struct edu_csdms_models_Waves__object {
  ...
  struct edu_csdms_models_Waves__epv*     d_epv;
  struct edu_csdms_models_Waves__cstats   d_cstats;
  void*                                   d_data;
};

struct edu_csdms_models_Waves__external {
  struct edu_csdms_models_Waves__object*
...
extern struct edu_csdms_models_Waves__object*
edu_csdms_models_Waves__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Waves__init(
  struct edu_csdms_models_Waves__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Waves__getEPVs(
...
extern void edu_csdms_models_Waves__fini(
  struct edu_csdms_models_Waves__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_Waves__IOR_version(int32_t *major, int32_t *minor);
...
struct edu_csdms_openmi_IValueSet__object* 
  ...
  url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_models_Waves__remote{
  int d_refcount;
