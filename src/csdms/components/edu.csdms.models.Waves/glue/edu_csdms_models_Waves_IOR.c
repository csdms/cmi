/*
 * File:          edu_csdms_models_Waves_IOR.c
 * Symbol:        edu.csdms.models.Waves-v0.0
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Intermediate Object Representation for edu.csdms.models.Waves
 * 
...
static struct edu_csdms_models_Waves__epv s_my_epv__edu_csdms_models_waves;

static struct edu_csdms_models_Waves__epv 
  s_my_epv_contracts__edu_csdms_models_waves;

static struct edu_csdms_models_Waves__epv 
  s_my_epv_hooks__edu_csdms_models_waves;
...
static struct edu_csdms_models_Waves__pre_epv s_preEPV;
static struct edu_csdms_models_Waves__post_epv s_postEPV;
...
extern void edu_csdms_models_Waves__set_epv(
...
extern void edu_csdms_models_Waves__call_load(void);
#ifdef __cplusplus
}
#endif

static void
edu_csdms_models_Waves_boccaSetServices__exec(
  ...
  services = skel_edu_csdms_models_Waves_fconnect_gov_cca_Services(services_str,
    TRUE, _ex);SIDL_CHECK(*_ex);
#else
  services_bc = sidl_rmi_InstanceRegistry_getInstanceByString(services_str, 
    _ex);SIDL_CHECK(*_ex);
  if(services_bc != NULL) {
    services= (struct edu_csdms_models_Waves__object*) (
      *services_bc->d_epv->f__cast)(services_bc, "edu.csdms.models.Waves", _ex);
    if(services != NULL) {
...
static void
edu_csdms_models_Waves_boccaReleaseServices__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_checkException__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  excpt = skel_edu_csdms_models_Waves_fconnect_sidl_BaseInterface(excpt_str, 
    TRUE, _ex);SIDL_CHECK(*_ex);
#else
  excpt_bc = sidl_rmi_InstanceRegistry_getInstanceByString(excpt_str, 
    _ex);SIDL_CHECK(*_ex);
  if(excpt_bc != NULL) {
    excpt= (struct edu_csdms_models_Waves__object*) (*excpt_bc->d_epv->f__cast)(
      excpt_bc, "edu.csdms.models.Waves", _ex);
    if(excpt != NULL) {
...
static void
edu_csdms_models_Waves_boccaForceUsePortInclude__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ScalarSet__object* dummy2 = NULL;
  char* dummy3_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy3_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_tools_ConfigDialog__object* dummy3 = NULL;
  char* dummy4_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy4_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_tools_PrintQueue__object* dummy4 = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  ...
  dummy0 = 
    skel_edu_csdms_models_Waves_fconnect_gov_cca_ports_ParameterPortFactory(
    dummy0_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy0_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy0_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy0_bc != NULL) {
    dummy0= (struct edu_csdms_models_Waves__object*) (
      *dummy0_bc->d_epv->f__cast)(dummy0_bc, "edu.csdms.models.Waves", _ex);
    if(dummy0 != NULL) {
  ...
  dummy1 = skel_edu_csdms_models_Waves_fconnect_edu_csdms_tools_Verbose(
    dummy1_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy1_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy1_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy1_bc != NULL) {
    dummy1= (struct edu_csdms_models_Waves__object*) (
      *dummy1_bc->d_epv->f__cast)(dummy1_bc, "edu.csdms.models.Waves", _ex);
    if(dummy1 != NULL) {
  ...
  dummy2 = skel_edu_csdms_models_Waves_fconnect_edu_csdms_openmi_ScalarSet(
    dummy2_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy2_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy2_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy2_bc != NULL) {
    dummy2= (struct edu_csdms_models_Waves__object*) (
      *dummy2_bc->d_epv->f__cast)(dummy2_bc, "edu.csdms.models.Waves", _ex);
    if(dummy2 != NULL) {
  ...
  dummy3 = skel_edu_csdms_models_Waves_fconnect_edu_csdms_tools_ConfigDialog(
    dummy3_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy3_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy3_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy3_bc != NULL) {
    dummy3= (struct edu_csdms_models_Waves__object*) (
      *dummy3_bc->d_epv->f__cast)(dummy3_bc, "edu.csdms.models.Waves", _ex);
    if(dummy3 != NULL) {
  ...
  dummy4 = skel_edu_csdms_models_Waves_fconnect_edu_csdms_tools_PrintQueue(
    dummy4_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy4_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy4_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy4_bc != NULL) {
    dummy4= (struct edu_csdms_models_Waves__object*) (
      *dummy4_bc->d_epv->f__cast)(dummy4_bc, "edu.csdms.models.Waves", _ex);
    if(dummy4 != NULL) {
...
static void
edu_csdms_models_Waves_addRef__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_deleteRef__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_isSame__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_edu_csdms_models_Waves_fconnect_sidl_BaseInterface(iobj_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct edu_csdms_models_Waves__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "edu.csdms.models.Waves", _ex);
    if(iobj != NULL) {
...
static void
edu_csdms_models_Waves_isType__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_getClassInfo__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_setServices__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_releaseServices__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_go__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_initialize__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_run__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_finalize__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_getRaster_nx__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_getRaster_ny__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_getRaster_dx__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_getRaster_dy__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_getRaster_ulx__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_getRaster_uly__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_getRaster_grid__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_get_raster_dimen__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_get_raster_res__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_get_raster_data__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_get_time_span__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_get_element_set__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_get_value_set__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_get_value_set_data__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_models_Waves_set_value_set__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  values = skel_edu_csdms_models_Waves_fconnect_edu_csdms_openmi_IValueSet(
    values_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  values_bc = sidl_rmi_InstanceRegistry_getInstanceByString(values_str, 
    _ex);SIDL_CHECK(*_ex);
  if(values_bc != NULL) {
    values= (struct edu_csdms_models_Waves__object*) (
      *values_bc->d_epv->f__cast)(values_bc, "edu.csdms.models.Waves", _ex);
    if(values != NULL) {
...
static void
edu_csdms_models_Waves__cast__exec(
        struct edu_csdms_models_Waves__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_edu_csdms_models_Waves__set_contracts(
  struct edu_csdms_models_Waves__object* self,
  sidl_bool   enable,
...
static void ior_edu_csdms_models_Waves__dump_stats(
  struct edu_csdms_models_Waves__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_edu_csdms_models_Waves__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    edu_csdms_models_Waves__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_edu_csdms_models_Waves__cast(
  struct edu_csdms_models_Waves__object* self,
...
static void ior_edu_csdms_models_Waves__set_hooks(
  struct edu_csdms_models_Waves__object* self,
...
static void ior_edu_csdms_models_Waves__delete(
  struct edu_csdms_models_Waves__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  edu_csdms_models_Waves__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct edu_csdms_models_Waves__object));
  free((void*) self);
}

static char*
ior_edu_csdms_models_Waves__getURL(
  struct edu_csdms_models_Waves__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_edu_csdms_models_Waves__raddRef(
    struct edu_csdms_models_Waves__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_edu_csdms_models_Waves__isRemote(
    struct edu_csdms_models_Waves__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct edu_csdms_models_Waves__method {
  const char *d_name;
  void (*d_func)(struct edu_csdms_models_Waves__object*,
...
static void
ior_edu_csdms_models_Waves__exec(
  struct edu_csdms_models_Waves__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct edu_csdms_models_Waves__method  s_methods[] = {
    { "_cast", edu_csdms_models_Waves__cast__exec },
    { "addRef", edu_csdms_models_Waves_addRef__exec },
    { "boccaForceUsePortInclude", 
      edu_csdms_models_Waves_boccaForceUsePortInclude__exec },
    { "boccaReleaseServices", edu_csdms_models_Waves_boccaReleaseServices__exec 
      },
    { "boccaSetServices", edu_csdms_models_Waves_boccaSetServices__exec },
    { "checkException", edu_csdms_models_Waves_checkException__exec },
    { "deleteRef", edu_csdms_models_Waves_deleteRef__exec },
    { "finalize", edu_csdms_models_Waves_finalize__exec },
    { "getClassInfo", edu_csdms_models_Waves_getClassInfo__exec },
    { "getRaster_dx", edu_csdms_models_Waves_getRaster_dx__exec },
    { "getRaster_dy", edu_csdms_models_Waves_getRaster_dy__exec },
    { "getRaster_grid", edu_csdms_models_Waves_getRaster_grid__exec },
    { "getRaster_nx", edu_csdms_models_Waves_getRaster_nx__exec },
    { "getRaster_ny", edu_csdms_models_Waves_getRaster_ny__exec },
    { "getRaster_ulx", edu_csdms_models_Waves_getRaster_ulx__exec },
    { "getRaster_uly", edu_csdms_models_Waves_getRaster_uly__exec },
    { "get_element_set", edu_csdms_models_Waves_get_element_set__exec },
    { "get_raster_data", edu_csdms_models_Waves_get_raster_data__exec },
    { "get_raster_dimen", edu_csdms_models_Waves_get_raster_dimen__exec },
    { "get_raster_res", edu_csdms_models_Waves_get_raster_res__exec },
    { "get_time_span", edu_csdms_models_Waves_get_time_span__exec },
    { "get_value_set", edu_csdms_models_Waves_get_value_set__exec },
    { "get_value_set_data", edu_csdms_models_Waves_get_value_set_data__exec },
    { "go", edu_csdms_models_Waves_go__exec },
    { "initialize", edu_csdms_models_Waves_initialize__exec },
    { "isSame", edu_csdms_models_Waves_isSame__exec },
    { "isType", edu_csdms_models_Waves_isType__exec },
    { "releaseServices", edu_csdms_models_Waves_releaseServices__exec },
    { "run", edu_csdms_models_Waves_run__exec },
    { "setServices", edu_csdms_models_Waves_setServices__exec },
    { "set_value_set", edu_csdms_models_Waves_set_value_set__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct edu_csdms_models_Waves__method);
  *_ex  = NULL; /* default to no exception */
...
static void edu_csdms_models_Waves__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct edu_csdms_models_Waves__epv*   epv  = &s_my_epv__edu_csdms_models_waves;
  ...
  epv->f__cast                    = ior_edu_csdms_models_Waves__cast;
  epv->f__delete                  = ior_edu_csdms_models_Waves__delete;
  epv->f__exec                    = ior_edu_csdms_models_Waves__exec;
  epv->f__getURL                  = ior_edu_csdms_models_Waves__getURL;
  epv->f__raddRef                 = ior_edu_csdms_models_Waves__raddRef;
  epv->f__isRemote                = ior_edu_csdms_models_Waves__isRemote;
  epv->f__set_hooks               = ior_edu_csdms_models_Waves__set_hooks;
  epv->f__set_contracts           = ior_edu_csdms_models_Waves__set_contracts;
  epv->f__dump_stats              = ior_edu_csdms_models_Waves__dump_stats;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  ...
  epv->f_addRef                   = (void (*)(struct edu_csdms_models_Waves__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef                = (void (*)(struct edu_csdms_models_Waves__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct edu_csdms_models_Waves__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct edu_csdms_models_Waves__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct edu_csdms_models_Waves__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  ...
  edu_csdms_models_Waves__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  ior_edu_csdms_models_Waves__ensure_load_called();
}

/*
 * edu_csdms_models_Waves__getEPVs: Get my version of all relevant EPVs.
 */

void edu_csdms_models_Waves__getEPVs (
  ...
  struct edu_csdms_models_Waves__epv **s_arg_epv__edu_csdms_models_waves,
  struct edu_csdms_models_Waves__epv **s_arg_epv_hooks__edu_csdms_models_waves)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    edu_csdms_models_Waves__init_epv();
  }
  ...
  *s_arg_epv__edu_csdms_models_waves = &s_my_epv__edu_csdms_models_waves;
  *s_arg_epv_hooks__edu_csdms_models_waves = &s_my_epv_hooks__edu_csdms_models_waves;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* edu_csdms_models_Waves__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "edu.csdms.models.Waves", _ex);
...
static void
initMetadata(struct edu_csdms_models_Waves__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * edu_csdms_models_Waves__createObject: Allocate the object and initialize it.
 */

struct edu_csdms_models_Waves__object*
edu_csdms_models_Waves__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct edu_csdms_models_Waves__object* self =
    (struct edu_csdms_models_Waves__object*) sidl_malloc(
      sizeof(struct edu_csdms_models_Waves__object),
      "Object allocation failed for struct edu_csdms_models_Waves__object",
        __FILE__, __LINE__, "edu_csdms_models_Waves__createObject", _ex);
  if (!self) goto EXIT;
  edu_csdms_models_Waves__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void edu_csdms_models_Waves__init(
  struct edu_csdms_models_Waves__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_models_Waves__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv                            = &s_my_epv__edu_csdms_models_waves;
...
void edu_csdms_models_Waves__fini(
  struct edu_csdms_models_Waves__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_models_Waves__object* s0 = self;
...
void
edu_csdms_models_Waves__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct edu_csdms_models_Waves__external
s_externalEntryPoints = {
  edu_csdms_models_Waves__createObject,
  edu_csdms_models_Waves__getSuperEPV,
  2, 
  0
};
...
const struct edu_csdms_models_Waves__external*
edu_csdms_models_Waves__externals(void)
{
