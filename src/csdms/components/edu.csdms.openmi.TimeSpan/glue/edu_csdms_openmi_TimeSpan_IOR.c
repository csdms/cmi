/*
 * File:          edu_csdms_openmi_TimeSpan_IOR.c
...
static struct edu_csdms_openmi_TimeSpan__epv 
  s_my_epv__edu_csdms_openmi_timespan;

static struct edu_csdms_openmi_TimeSpan__epv 
  s_my_epv_contracts__edu_csdms_openmi_timespan;

static struct edu_csdms_openmi_TimeSpan__epv 
  s_my_epv_hooks__edu_csdms_openmi_timespan;

static struct edu_csdms_openmi_ITimeSpan__epv 
  s_my_epv__edu_csdms_openmi_itimespan;
static struct edu_csdms_openmi_ITimeSpan__epv 
  s_my_epv_hooks__edu_csdms_openmi_itimespan;
...
static struct edu_csdms_openmi_TimeSpan__pre_epv s_preEPV;
static struct edu_csdms_openmi_TimeSpan__post_epv s_postEPV;
...
extern void edu_csdms_openmi_TimeSpan__set_epv(
  struct edu_csdms_openmi_TimeSpan__epv* epv,
    struct edu_csdms_openmi_TimeSpan__pre_epv* pre_epv,
    struct edu_csdms_openmi_TimeSpan__post_epv* post_epv);

extern void edu_csdms_openmi_TimeSpan__call_load(void);
#ifdef __cplusplus
}
#endif

static void
edu_csdms_openmi_TimeSpan_setStart__exec(
  ...
  char* start_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass start_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ITimeStamp__object* start = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackString( inArgs, "start", &start_str, _ex);SIDL_CHECK(
    *_ex);
#ifdef WITH_RMI

  start = skel_edu_csdms_openmi_TimeSpan_fconnect_edu_csdms_openmi_ITimeStamp(
    start_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  start_bc = sidl_rmi_InstanceRegistry_getInstanceByString(start_str, 
    _ex);SIDL_CHECK(*_ex);
  if(start_bc != NULL) {
    start= (struct edu_csdms_openmi_TimeSpan__object*) (
      *start_bc->d_epv->f__cast)(start_bc, "edu.csdms.openmi.TimeSpan", _ex);
    if(start != NULL) {
      (((struct sidl_BaseInterface__object*)(start))->d_epv->f_deleteRef)(((
        struct sidl_BaseInterface__object*)start)->d_object, _ex); SIDL_CHECK(
        *_ex);
    } else {
      (*start_bc->d_epv->f_deleteRef)(start_bc, _ex);
    }
  }
#endif /* WITH_RMI */

  /* make the call */
  (self->d_epv->f_setStart)(
    self,
    start,
    _ex);  SIDL_CHECK(*_ex);
  ...
  if(start) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)start, &_ex3); EXEC_CHECK(
      _ex3);
  }
  EXEC_ERR:
  if(*_ex) { 
...
static void
edu_csdms_openmi_TimeSpan_setEnd__exec(
        struct edu_csdms_openmi_TimeSpan__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  char* end_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass end_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ITimeStamp__object* end = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackString( inArgs, "end", &end_str, _ex);SIDL_CHECK(*_ex);
#ifdef WITH_RMI

  end = skel_edu_csdms_openmi_TimeSpan_fconnect_edu_csdms_openmi_ITimeStamp(
    end_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  end_bc = sidl_rmi_InstanceRegistry_getInstanceByString(end_str, 
    _ex);SIDL_CHECK(*_ex);
  if(end_bc != NULL) {
    end= (struct edu_csdms_openmi_TimeSpan__object*) (*end_bc->d_epv->f__cast)(
      end_bc, "edu.csdms.openmi.TimeSpan", _ex);
    if(end != NULL) {
      (((struct sidl_BaseInterface__object*)(end))->d_epv->f_deleteRef)(((
        struct sidl_BaseInterface__object*)end)->d_object, _ex); SIDL_CHECK(
        *_ex);
    } else {
      (*end_bc->d_epv->f_deleteRef)(end_bc, _ex);
    }
  }
#endif /* WITH_RMI */
  ...
  EXIT:
  /* clean-up dangling references */
  if(end_str) {free(end_str);}
  if(end) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)end, &_ex3); EXEC_CHECK(
      _ex3);
  }
  EXEC_ERR:
  if(*_ex) { 
...
static void
edu_csdms_openmi_TimeSpan_boccaForceUsePortInclude__exec(
        struct edu_csdms_openmi_TimeSpan__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
#endif /* WITH_RMI */
  struct edu_csdms_openmi_TimeStamp__object* dummy0 = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  ...
  dummy0 = skel_edu_csdms_openmi_TimeSpan_fconnect_edu_csdms_openmi_TimeStamp(
    dummy0_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy0_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy0_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy0_bc != NULL) {
    dummy0= (struct edu_csdms_openmi_TimeSpan__object*) (
      *dummy0_bc->d_epv->f__cast)(dummy0_bc, "edu.csdms.openmi.TimeSpan", _ex);
    if(dummy0 != NULL) {
...
static void
edu_csdms_openmi_TimeSpan_addRef__exec(
        struct edu_csdms_openmi_TimeSpan__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_TimeSpan_deleteRef__exec(
        struct edu_csdms_openmi_TimeSpan__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_TimeSpan_isSame__exec(
        struct edu_csdms_openmi_TimeSpan__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_edu_csdms_openmi_TimeSpan_fconnect_sidl_BaseInterface(iobj_str, 
    TRUE, _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct edu_csdms_openmi_TimeSpan__object*) (
      *iobj_bc->d_epv->f__cast)(iobj_bc, "edu.csdms.openmi.TimeSpan", _ex);
    if(iobj != NULL) {
...
static void
edu_csdms_openmi_TimeSpan_isType__exec(
        struct edu_csdms_openmi_TimeSpan__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_TimeSpan_getClassInfo__exec(
        struct edu_csdms_openmi_TimeSpan__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_TimeSpan_getStart__exec(
        struct edu_csdms_openmi_TimeSpan__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  /* stack space for arguments */
  struct edu_csdms_openmi_ITimeStamp__object* _retval = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
...
static void
edu_csdms_openmi_TimeSpan_getEnd__exec(
        struct edu_csdms_openmi_TimeSpan__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_TimeSpan__cast__exec(
        struct edu_csdms_openmi_TimeSpan__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_edu_csdms_openmi_TimeSpan__set_contracts(
  struct edu_csdms_openmi_TimeSpan__object* self,
  sidl_bool   enable,
...
static void ior_edu_csdms_openmi_TimeSpan__dump_stats(
  struct edu_csdms_openmi_TimeSpan__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_edu_csdms_openmi_TimeSpan__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    edu_csdms_openmi_TimeSpan__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_edu_csdms_openmi_TimeSpan__cast(
  struct edu_csdms_openmi_TimeSpan__object* self,
...
static void ior_edu_csdms_openmi_TimeSpan__set_hooks(
  struct edu_csdms_openmi_TimeSpan__object* self,
...
static void ior_edu_csdms_openmi_TimeSpan__delete(
  struct edu_csdms_openmi_TimeSpan__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  edu_csdms_openmi_TimeSpan__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct edu_csdms_openmi_TimeSpan__object));
  free((void*) self);
}

static char*
ior_edu_csdms_openmi_TimeSpan__getURL(
  struct edu_csdms_openmi_TimeSpan__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_edu_csdms_openmi_TimeSpan__raddRef(
    struct edu_csdms_openmi_TimeSpan__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_edu_csdms_openmi_TimeSpan__isRemote(
    struct edu_csdms_openmi_TimeSpan__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct edu_csdms_openmi_TimeSpan__method {
  const char *d_name;
  void (*d_func)(struct edu_csdms_openmi_TimeSpan__object*,
...
static void
ior_edu_csdms_openmi_TimeSpan__exec(
  struct edu_csdms_openmi_TimeSpan__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct edu_csdms_openmi_TimeSpan__method  s_methods[] = {
    { "_cast", edu_csdms_openmi_TimeSpan__cast__exec },
    { "addRef", edu_csdms_openmi_TimeSpan_addRef__exec },
    { "boccaForceUsePortInclude", 
      edu_csdms_openmi_TimeSpan_boccaForceUsePortInclude__exec },
    { "deleteRef", edu_csdms_openmi_TimeSpan_deleteRef__exec },
    { "getClassInfo", edu_csdms_openmi_TimeSpan_getClassInfo__exec },
    { "getEnd", edu_csdms_openmi_TimeSpan_getEnd__exec },
    { "getStart", edu_csdms_openmi_TimeSpan_getStart__exec },
    { "isSame", edu_csdms_openmi_TimeSpan_isSame__exec },
    { "isType", edu_csdms_openmi_TimeSpan_isType__exec },
    { "setEnd", edu_csdms_openmi_TimeSpan_setEnd__exec },
    { "setStart", edu_csdms_openmi_TimeSpan_setStart__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct edu_csdms_openmi_TimeSpan__method);
  *_ex  = NULL; /* default to no exception */
...
static void edu_csdms_openmi_TimeSpan__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct edu_csdms_openmi_TimeSpan__epv*  epv  = &s_my_epv__edu_csdms_openmi_timespan;
  struct edu_csdms_openmi_ITimeSpan__epv* e0   = &s_my_epv__edu_csdms_openmi_itimespan;
  ...
  epv->f__cast                    = ior_edu_csdms_openmi_TimeSpan__cast;
  epv->f__delete                  = ior_edu_csdms_openmi_TimeSpan__delete;
  epv->f__exec                    = ior_edu_csdms_openmi_TimeSpan__exec;
  epv->f__getURL                  = ior_edu_csdms_openmi_TimeSpan__getURL;
  epv->f__raddRef                 = ior_edu_csdms_openmi_TimeSpan__raddRef;
  epv->f__isRemote                = ior_edu_csdms_openmi_TimeSpan__isRemote;
  epv->f__set_hooks               = ior_edu_csdms_openmi_TimeSpan__set_hooks;
  epv->f__set_contracts           = ior_edu_csdms_openmi_TimeSpan__set_contracts;
  epv->f__dump_stats              = ior_edu_csdms_openmi_TimeSpan__dump_stats;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  epv->f_setStart                 = NULL;
  ...
  epv->f_addRef                   = (void (*)(struct edu_csdms_openmi_TimeSpan__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef                = (void (*)(struct edu_csdms_openmi_TimeSpan__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct edu_csdms_openmi_TimeSpan__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct edu_csdms_openmi_TimeSpan__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct edu_csdms_openmi_TimeSpan__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getStart                 = NULL;
  epv->f_getEnd                   = NULL;

  edu_csdms_openmi_TimeSpan__set_epv(epv, &s_preEPV, &s_postEPV);

  /*
   * Override function pointers for edu.csdms.openmi.ITimeSpan with mine, as needed.
   */
  ...
  e0->f_getStart              = (struct edu_csdms_openmi_ITimeStamp__object* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getStart;
  e0->f_getEnd                = (struct edu_csdms_openmi_ITimeStamp__object* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getEnd;
  ...
  ior_edu_csdms_openmi_TimeSpan__ensure_load_called();
}

/*
 * edu_csdms_openmi_TimeSpan__getEPVs: Get my version of all relevant EPVs.
 */

void edu_csdms_openmi_TimeSpan__getEPVs (
  struct sidl_BaseInterface__epv **s_arg_epv__sidl_baseinterface,
  struct sidl_BaseClass__epv **s_arg_epv__sidl_baseclass,
  struct edu_csdms_openmi_ITimeSpan__epv **s_arg_epv__edu_csdms_openmi_itimespan,
  struct edu_csdms_openmi_ITimeSpan__epv **s_arg_epv_hooks__edu_csdms_openmi_itimespan,
  struct edu_csdms_openmi_TimeSpan__epv **s_arg_epv__edu_csdms_openmi_timespan,
  struct edu_csdms_openmi_TimeSpan__epv **s_arg_epv_hooks__edu_csdms_openmi_timespan)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    edu_csdms_openmi_TimeSpan__init_epv();
  }
  UNLOCK_STATIC_GLOBALS;

  *s_arg_epv__sidl_baseinterface = &s_my_epv__sidl_baseinterface;
  *s_arg_epv__sidl_baseclass = &s_my_epv__sidl_baseclass;
  *s_arg_epv__edu_csdms_openmi_itimespan = &s_my_epv__edu_csdms_openmi_itimespan;
  *s_arg_epv_hooks__edu_csdms_openmi_itimespan = &s_my_epv_hooks__edu_csdms_openmi_itimespan;
  *s_arg_epv__edu_csdms_openmi_timespan = &s_my_epv__edu_csdms_openmi_timespan;
  *s_arg_epv_hooks__edu_csdms_openmi_timespan = &s_my_epv_hooks__edu_csdms_openmi_timespan;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* edu_csdms_openmi_TimeSpan__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "edu.csdms.openmi.TimeSpan", _ex);
...
static void
initMetadata(struct edu_csdms_openmi_TimeSpan__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * edu_csdms_openmi_TimeSpan__createObject: Allocate the object and initialize it.
 */

struct edu_csdms_openmi_TimeSpan__object*
edu_csdms_openmi_TimeSpan__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct edu_csdms_openmi_TimeSpan__object* self =
    (struct edu_csdms_openmi_TimeSpan__object*) sidl_malloc(
      sizeof(struct edu_csdms_openmi_TimeSpan__object),
      "Object allocation failed for struct edu_csdms_openmi_TimeSpan__object",
        __FILE__, __LINE__, "edu_csdms_openmi_TimeSpan__createObject", _ex);
  if (!self) goto EXIT;
  edu_csdms_openmi_TimeSpan__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void edu_csdms_openmi_TimeSpan__init(
  struct edu_csdms_openmi_TimeSpan__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_openmi_TimeSpan__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_edu_csdms_openmi_itimespan.d_epv = &s_my_epv__edu_csdms_openmi_itimespan;
  s0->d_epv                              = &s_my_epv__edu_csdms_openmi_timespan;

  s0->d_edu_csdms_openmi_itimespan.d_object = self;
...
void edu_csdms_openmi_TimeSpan__fini(
  struct edu_csdms_openmi_TimeSpan__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_openmi_TimeSpan__object* s0 = self;
...
void
edu_csdms_openmi_TimeSpan__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct edu_csdms_openmi_TimeSpan__external
s_externalEntryPoints = {
  edu_csdms_openmi_TimeSpan__createObject,
  edu_csdms_openmi_TimeSpan__getSuperEPV,
  2, 
  0
};
