...
ppf.addRequestString(userinput, "Input", "Path to input files", "Input directory", "/data/sims/stm/AgDegNormalFault/test.txt");
ppf.addRequestString(userinput, "Output", "Path to output files", "Output directory", "/data/sims/stm/AgDegNormalFault/result.txt");
...
std::string output = userinput.getString("Output","");
    Finalize(printmatrix, x, M, prints, H, taustar, qstar, qt, Gt, qtg, dx, Slmatrix,
	     Hmatrix, taumatrix, qbmatrix, output.c_str());
