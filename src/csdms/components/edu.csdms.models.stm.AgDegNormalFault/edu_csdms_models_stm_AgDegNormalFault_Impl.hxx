// 
// File:          edu_csdms_models_stm_AgDegNormalFault_Impl.hxx
...
#ifndef included_edu_csdms_models_stm_AgDegNormalFault_Impl_hxx
#define included_edu_csdms_models_stm_AgDegNormalFault_Impl_hxx

#ifndef included_sidl_cxx_hxx
#include "sidl_cxx.hxx"
#endif
#ifndef included_edu_csdms_models_stm_AgDegNormalFault_IOR_h
#include "edu_csdms_models_stm_AgDegNormalFault_IOR.h"
#endif
#ifndef included_edu_csdms_models_stm_AgDegNormalFault_hxx
#include "edu_csdms_models_stm_AgDegNormalFault.hxx"
#endif
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormalFault._hincludes)
// Insert-Code-Here {edu.csdms.models.stm.AgDegNormalFault._hincludes} (includes or arbitrary code)
#include "Initialize.h"
#include "Run.h"
#include "Finalize.h"
#include "SaveDatatoMatrix.h"
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormalFault._hincludes)
  ...
  namespace csdms { 
    namespace models { 
      namespace stm { 
        ...
        /**
         * Symbol "edu.csdms.models.stm.AgDegNormalFault" (version 0.0)
         */
        class AgDegNormalFault_impl : public virtual 
          ::edu::csdms::models::stm::AgDegNormalFault 
        // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormalFault._inherits)
        // Insert-Code-Here {edu.csdms.models.stm.AgDegNormalFault._inherits} (optional inheritance here)
        // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormalFault._inherits)
        ...
        protected:
          ...
          // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormalFault._implementation)

  // Insert-UserCode-Here(edu.csdms.models.stm.AgDegNormalFault._implementation)
gov::cca::TypeMap userinput;
  ...
  // Bocca generated code. bocca.protected.begin(edu.csdms.models.stm.AgDegNormalFault._implementation)
  
   gov::cca::Services    d_services; // our cca handle.
 

  // Bocca generated code. bocca.protected.end(edu.csdms.models.stm.AgDegNormalFault._implementation)

          // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormalFault._implementation)

        public:
          // default constructor, used for data wrapping(required)
          AgDegNormalFault_impl();
          // sidl constructor (required)
          // Note: alternate Skel constructor doesn't call addref()
          // (fixes bug #275)
            AgDegNormalFault_impl( struct 
              edu_csdms_models_stm_AgDegNormalFault__object * ior ) : StubBase(
              ior,true), 
          ...
          virtual ~AgDegNormalFault_impl() { _dtor(); }
        ...
        };  // end class AgDegNormalFault_impl
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormalFault._hmisc)
// Insert-Code-Here {edu.csdms.models.stm.AgDegNormalFault._hmisc} (miscellaneous things)
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormalFault._hmisc)
