/*
 * File:          edu_csdms_models_HydroTrend_IOR.h
...
#define included_edu_csdms_models_HydroTrend_IOR_h
...
struct edu_csdms_models_HydroTrend__epv {
  ...
  int32_t (*f_go)(
    /* in */ struct edu_csdms_models_HydroTrend__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in edu.csdms.models.HydroTrend-v0.0 */
...
struct edu_csdms_models_HydroTrend__pre_epv {
...
struct edu_csdms_models_HydroTrend__post_epv {
...
struct edu_csdms_models_HydroTrend__cstats {
  sidl_bool use_hooks;
};
...
struct edu_csdms_models_HydroTrend__object {
  ...
  struct edu_csdms_models_HydroTrend__epv*   d_epv;
  struct edu_csdms_models_HydroTrend__cstats d_cstats;
  void*                                      d_data;
};

struct edu_csdms_models_HydroTrend__external {
  struct edu_csdms_models_HydroTrend__object*
...
extern struct edu_csdms_models_HydroTrend__object*
edu_csdms_models_HydroTrend__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_HydroTrend__init(
  struct edu_csdms_models_HydroTrend__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_HydroTrend__getEPVs(
  ...
  struct edu_csdms_models_HydroTrend__epv 
    **s_arg_epv__edu_csdms_models_hydrotrend,
  struct edu_csdms_models_HydroTrend__epv 
    **s_arg_epv_hooks__edu_csdms_models_hydrotrend);

extern void edu_csdms_models_HydroTrend__fini(
  struct edu_csdms_models_HydroTrend__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_models_HydroTrend__IOR_version(int32_t *major, int32_t 
  *minor);
...
struct edu_csdms_openmi_IValueSet__object* 
  ...
  char* url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_models_HydroTrend__remote{
  int d_refcount;
