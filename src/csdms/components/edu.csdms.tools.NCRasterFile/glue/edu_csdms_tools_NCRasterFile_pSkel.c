/*
 * File:          edu_csdms_tools_NCRasterFile_pSkel.c
 ...
 * This file is for the sidl type edu.csdms.tools.NCRasterFile.
 */
...
static void
pSkel_NCRasterFile_boccaForceUsePortInclude(
  ...
  )
{
  ...
  *_exception = NULL;
  ...
  sidl_Python_LogGILEnsure(__func__, __FILE__, __LINE__, (int)_gstate);
#endif /* Python 2.4 or later */
  if ((_context = PyImport_ImportModule("edu.csdms.tools.NCRasterFile_Impl"))) {
    if ((_pfunc = PyObject_GetAttrString(_context, "NCRasterFile"))) {
      _args = Py_BuildValue("(O&)", (void *)
        edu_csdms_tools_NCRasterFile__weakRef, self);
      if (_args) {
...
void
edu_csdms_tools_NCRasterFile__impl_set_epv(struct 
  edu_csdms_tools_NCRasterFile__epv *epv,
  struct edu_csdms_tools_NCRasterFile__pre_epv *pre_epv, struct 
    edu_csdms_tools_NCRasterFile__post_epv *post_epv)
{
  _importModules();
  epv->f__ctor = pSkel_NCRasterFile__ctor;
  epv->f__ctor2 = pSkel_NCRasterFile__ctor2;
  epv->f__dtor = pSkel_NCRasterFile__dtor;
  pre_epv->f_boccaForceUsePortInclude_pre = NULL;
  epv->f_boccaForceUsePortInclude = pSkel_NCRasterFile_boccaForceUsePortInclude;
  post_epv->f_boccaForceUsePortInclude_post = NULL;
  pre_epv->f_init_pre = NULL;
  epv->f_init = pSkel_NCRasterFile_init;
  post_epv->f_init_post = NULL;
  pre_epv->f_open_pre = NULL;
  epv->f_open = pSkel_NCRasterFile_open;
  post_epv->f_open_post = NULL;
  pre_epv->f_append_pre = NULL;
  epv->f_append = pSkel_NCRasterFile_append;
  post_epv->f_append_post = NULL;
  pre_epv->f_close_pre = NULL;
  epv->f_close = pSkel_NCRasterFile_close;
...
static struct sidl_BaseInterface__object* 
  pskel_edu_csdms_tools_NCRasterFile_fconnect_sidl_BaseInterface(const char* 
...
#ifdef WITH_RMI
static struct edu_csdms_tools_NCRasterFile__rmiExternals s_rmiExtern = {
  pskel_edu_csdms_tools_NCRasterFile_fconnect_sidl_BaseInterface
};
...
struct edu_csdms_tools_NCRasterFile__rmiExternals *
edu_csdms_tools_NCRasterFile__impl_rmi_externals(void) {
  return &s_rmiExtern;
}
#ifdef __cplusplus
}
