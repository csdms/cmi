/*
 * File:          edu_csdms_tools_NCRasterFile_IOR.h
...
#ifndef included_edu_csdms_tools_NCRasterFile_IOR_h
#define included_edu_csdms_tools_NCRasterFile_IOR_h
...
/*
 * Symbol "edu.csdms.tools.NCRasterFile" (version 0.0)
 */
...
struct edu_csdms_tools_NCRasterFile__epv {
  ...
  /* 0 */
  void* (*f__cast)(
    /* in */ struct edu_csdms_tools_NCRasterFile__object* self,
    /* in */ const char* name,
  ...
  void (*f_close)(
    /* in */ struct edu_csdms_tools_NCRasterFile__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in edu.csdms.tools.NCRasterFile-v0.0 */
...
struct edu_csdms_tools_NCRasterFile__cstats {
  sidl_bool use_hooks;
};
...
struct edu_csdms_tools_NCRasterFile__object {
  ...
  struct edu_csdms_tools_NCRasterFile__epv*        d_epv;
  struct edu_csdms_tools_NCRasterFile__cstats      d_cstats;
  void*                                            d_data;
};

struct edu_csdms_tools_NCRasterFile__external {
  struct edu_csdms_tools_NCRasterFile__object*
...
extern struct edu_csdms_tools_NCRasterFile__object*
edu_csdms_tools_NCRasterFile__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void edu_csdms_tools_NCRasterFile__init(
  struct edu_csdms_tools_NCRasterFile__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_tools_NCRasterFile__getEPVs(
  ...
  struct edu_csdms_tools_NCRasterFile__epv 
    **s_arg_epv__edu_csdms_tools_ncrasterfile,
  struct edu_csdms_tools_NCRasterFile__epv 
    **s_arg_epv_hooks__edu_csdms_tools_ncrasterfile);

extern void edu_csdms_tools_NCRasterFile__fini(
  struct edu_csdms_tools_NCRasterFile__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void edu_csdms_tools_NCRasterFile__IOR_version(int32_t *major, int32_t 
  *minor);

struct sidl_BaseInterface__object* 
  skel_edu_csdms_tools_NCRasterFile_fconnect_sidl_BaseInterface(const char* url,
  sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct edu_csdms_tools_NCRasterFile__remote{
  int d_refcount;
