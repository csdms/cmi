/*
 * File:          edu_csdms_tools_NCRasterFile_Module.c
 ...
 * sidl type edu.csdms.tools.NCRasterFile.
 */
...
#define edu_csdms_tools_NCRasterFile_INTERNAL 1
#include "edu_csdms_tools_NCRasterFile_Module.h"
...
edu_csdms_tools_NCRasterFile__connectI(const char * url, sidl_bool ar, struct \
...
static struct edu_csdms_tools_NCRasterFile__epv                               \
  s_rem_epv__edu_csdms_tools_ncrasterfile;
...
static void* remote_edu_csdms_tools_NCRasterFile__cast(
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct                                                  \
      edu_csdms_tools_NCRasterFile__remote*)self->d_data)->d_ih, _ex);
  }
...
static void remote_edu_csdms_tools_NCRasterFile__delete(
  struct edu_csdms_tools_NCRasterFile__object* self,
...
static char* remote_edu_csdms_tools_NCRasterFile__getURL(
  struct edu_csdms_tools_NCRasterFile__object* self, struct                   \
    sidl_BaseInterface__object* *_ex)
{
  struct sidl_rmi_InstanceHandle__object *conn = ((struct                     \
    edu_csdms_tools_NCRasterFile__remote*)self->d_data)->d_ih;
  *_ex = NULL;
  if(conn != NULL) {
...
static void remote_edu_csdms_tools_NCRasterFile__raddRef(
  struct edu_csdms_tools_NCRasterFile__object* self,struct                    \
    sidl_BaseInterface__object* *_ex)
{
...
static sidl_bool
remote_edu_csdms_tools_NCRasterFile__isRemote(
    struct edu_csdms_tools_NCRasterFile__object* self, 
    struct sidl_BaseInterface__object* *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_edu_csdms_tools_NCRasterFile__set_hooks(
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      ...
      "Exception unserialized from edu.csdms.tools.NCRasterFile._set_hooks.",
        &throwaway_exception);
...
static void
remote_edu_csdms_tools_NCRasterFile__set_contracts(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.tools.NCRasterFile._set_contracts.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(   \
        _be,&throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_tools_NCRasterFile__dump_stats(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.tools.NCRasterFile._dump_stats.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(   \
        _be,&throwaway_exception);
      goto EXIT;
...
static void remote_edu_csdms_tools_NCRasterFile__exec(
  struct edu_csdms_tools_NCRasterFile__object* self,const char* methodName,
...
static void
remote_edu_csdms_tools_NCRasterFile_boccaForceUsePortInclude(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.tools.NCRasterFile.boccaForceUsePortInclude.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(   \
        _be,&throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_tools_NCRasterFile_addRef(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    struct edu_csdms_tools_NCRasterFile__remote* r_obj = (struct              \
      edu_csdms_tools_NCRasterFile__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: addRef %p new count %d (type %s)\n",
      r_obj, r_obj->d_refcount, 
      "edu.csdms.tools.NCRasterFile Remote Stub");
...
static void
remote_edu_csdms_tools_NCRasterFile_deleteRef(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    r_obj->d_refcount--;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: deleteRef %p new count %d (type %s)\n",r_obj, r_obj->d_refcount, "edu.csdms.tools.NCRasterFile Remote Stub");
#endif /* SIDL_DEBUG_REFCOUNT */ 
...
static sidl_bool
remote_edu_csdms_tools_NCRasterFile_isSame(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.tools.NCRasterFile.isSame.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(   \
        _be,&throwaway_exception);
      goto EXIT;
...
static sidl_bool
remote_edu_csdms_tools_NCRasterFile_isType(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  /* in */ const char* name,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.tools.NCRasterFile.isType.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(   \
        _be,&throwaway_exception);
      goto EXIT;
...
remote_edu_csdms_tools_NCRasterFile_getClassInfo(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.tools.NCRasterFile.getClassInfo.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(   \
        _be,&throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_tools_NCRasterFile_init(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  /* in */ const char* name,
  /* in */ const char* units,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.tools.NCRasterFile.init.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(   \
        _be,&throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_tools_NCRasterFile_open(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  /* in */ const char* file,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.tools.NCRasterFile.open.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(   \
        _be,&throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_tools_NCRasterFile_append(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.tools.NCRasterFile.append.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(   \
        _be,&throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_tools_NCRasterFile_close(
  /* in */ struct edu_csdms_tools_NCRasterFile__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.tools.NCRasterFile.close.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(   \
        _be,&throwaway_exception);
      goto EXIT;
...
static void edu_csdms_tools_NCRasterFile__init_remote_epv(void)
{
  ...
  epv->f__cast                         =                                      \
    remote_edu_csdms_tools_NCRasterFile__cast;
  epv->f__delete                       =                                      \
    remote_edu_csdms_tools_NCRasterFile__delete;
  epv->f__exec                         =                                      \
    remote_edu_csdms_tools_NCRasterFile__exec;
  epv->f__getURL                       =                                      \
    remote_edu_csdms_tools_NCRasterFile__getURL;
  epv->f__raddRef                      =                                      \
    remote_edu_csdms_tools_NCRasterFile__raddRef;
  epv->f__isRemote                     =                                      \
    remote_edu_csdms_tools_NCRasterFile__isRemote;
  epv->f__set_hooks                    =                                      \
    remote_edu_csdms_tools_NCRasterFile__set_hooks;
...
static struct edu_csdms_tools_NCRasterFile__object*
edu_csdms_tools_NCRasterFile__remoteConnect(const char *url, sidl_bool ar,    \
  struct sidl_BaseInterface__object* *_ex)
{
  struct edu_csdms_tools_NCRasterFile__object* self = NULL;

  struct edu_csdms_tools_NCRasterFile__object* s0;
  struct sidl_BaseClass__object* s1;

  struct edu_csdms_tools_NCRasterFile__remote* r_obj = NULL;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    struct edu_csdms_tools_NCRasterFile__object* retobj = NULL;
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_BaseInterface bi = (                                                 \
      sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(       \
      objectID, _ex); SIDL_CHECK(*_ex);
    (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    retobj = (struct edu_csdms_tools_NCRasterFile__object*) (                 \
      *bi->d_epv->f__cast)(bi->d_object, "edu.csdms.tools.NCRasterFile", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url,                    \
    "edu.csdms.tools.NCRasterFile", ar, _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct edu_csdms_tools_NCRasterFile__object*) malloc(
      sizeof(struct edu_csdms_tools_NCRasterFile__object));

  r_obj =
    (struct edu_csdms_tools_NCRasterFile__remote*) malloc(
      sizeof(struct edu_csdms_tools_NCRasterFile__remote));
  ...
  if(!self || !r_obj) {
    ...
    sidl_MemAllocException_add(ex, __FILE__, __LINE__,                        \
      "edu.csdms.tools.NCRasterFile.EPVgeneration", _ex);
    SIDL_CHECK(*_ex);
  ...
  if (!s_remote_initialized) {
    edu_csdms_tools_NCRasterFile__init_remote_epv();
  }
  UNLOCK_STATIC_GLOBALS;
  ...
  s0->d_epv  = &s_rem_epv__edu_csdms_tools_ncrasterfile;
...
static struct edu_csdms_tools_NCRasterFile__object*
edu_csdms_tools_NCRasterFile__IHConnect(sidl_rmi_InstanceHandle instance,     \
  struct sidl_BaseInterface__object* *_ex)
{
  struct edu_csdms_tools_NCRasterFile__object* self = NULL;
...
static struct edu_csdms_tools_NCRasterFile__object*
edu_csdms_tools_NCRasterFile__remoteCreate(const char *url, struct            \
  sidl_BaseInterface__object **_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance( \
    url, "edu.csdms.tools.NCRasterFile", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct edu_csdms_tools_NCRasterFile__object*) malloc(
      sizeof(struct edu_csdms_tools_NCRasterFile__object));
...
edu_csdms_tools_NCRasterFile__connectI(const char* url, sidl_bool ar, struct  \
  sidl_BaseInterface__object **_ex)
{
  return edu_csdms_tools_NCRasterFile__remoteConnect(url, ar, _ex);
}
...
static PyObject *
pStub_NCRasterFile__connect(PyObject *_ignored, PyObject *_args, PyObject     \
  *_kwdict) {
  ...
  if (_okay) {
...
#endif /* Python 2.4 or later */
    self = edu_csdms_tools_NCRasterFile__remoteConnect(url,1,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)edu_csdms_tools_NCRasterFile__wrap, self);
    }
  }
...
#endif /*WITH_RMI*/
staticforward PyTypeObject _edu_csdms_tools_NCRasterFileType;

static const struct edu_csdms_tools_NCRasterFile__external *_implEPV = NULL;
...
_loadClassImpl(void) {
  if (!_implEPV) {
    ...
    sidl_DLL dll = NULL;
    char *errmsg = NULL;
    struct edu_csdms_tools_NCRasterFile__external*(*_extFunc)(void) = NULL;
    ...
    if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                \
      &throwaway_exception)) {
      _extFunc = (struct edu_csdms_tools_NCRasterFile__external*(*)(void))
        sidl_DLL_lookupSymbol(dll, "edu_csdms_tools_NCRasterFile__externals", \
          &throwaway_exception);
    ...
    if (!_implEPV) {
      dll = sidl_Loader_findLibrary("edu.csdms.tools.NCRasterFile",
        "ior/impl", sidl_Scope_SCLSCOPE,
        sidl_Resolve_SCLRESOLVE, &throwaway_exception);
      if (dll) {
        _extFunc = (struct edu_csdms_tools_NCRasterFile__external*(*)(void))
          sidl_DLL_lookupSymbol(dll,                                          \
            "edu_csdms_tools_NCRasterFile__externals", &throwaway_exception);
        if (!throwaway_exception && _extFunc) {
          _implEPV = (*_extFunc)();
        }
        else {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type edu.csdms.tools.NCRasterFile, ",
            name,
            ", was loaded but is missing a required symbol (edu_csdms_tools_NCRasterFile__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type edu.csdms.tools.NCRasterFile. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for edu.csdms.tools.NCRasterFile.");
...
static PyObject *
pStub_NCRasterFile__exec(PyObject *_self, PyObject *_args, PyObject *_kwdict) \
  {
  PyObject *_return_value = NULL;
  struct edu_csdms_tools_NCRasterFile__object *_self_ior =
    ((struct edu_csdms_tools_NCRasterFile__object *)
     sidl_Cast(_self, "edu.csdms.tools.NCRasterFile"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a edu.csdms.tools.NCRasterFile");
  }
  return _return_value;
}

static PyObject *
pStub_NCRasterFile__getURL(PyObject *_self, PyObject *_args, PyObject         \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct edu_csdms_tools_NCRasterFile__object *_self_ior =
    ((struct edu_csdms_tools_NCRasterFile__object *)
...
static PyObject *
pStub_NCRasterFile__isLocal(PyObject *_self, PyObject *_args, PyObject        \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct edu_csdms_tools_NCRasterFile__object *_self_ior =
    ((struct edu_csdms_tools_NCRasterFile__object *)
...
static PyObject *
pStub_NCRasterFile__isRemote(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct edu_csdms_tools_NCRasterFile__object *_self_ior =
    ((struct edu_csdms_tools_NCRasterFile__object *)
...
static PyObject *
pStub_NCRasterFile__set_hooks(PyObject *_self, PyObject *_args, PyObject      \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct edu_csdms_tools_NCRasterFile__object *_self_ior =
    ((struct edu_csdms_tools_NCRasterFile__object *)
...
static PyObject *
pStub_NCRasterFile_boccaForceUsePortInclude(PyObject *_self, PyObject *_args, \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct edu_csdms_tools_NCRasterFile__object *_self_ior =
    ((struct edu_csdms_tools_NCRasterFile__object *)
...
static int
edu_csdms_tools_NCRasterFile_createCast(PyObject *self, PyObject *args,       \
  PyObject *kwds) {
  struct edu_csdms_tools_NCRasterFile__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)edu_csdms_tools_NCRasterFile__convert, &optarg, &url, &implObj);
  if (_okay) {
    if (!optarg && !url && !implObj) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      optarg = edu_csdms_tools_NCRasterFile__remoteCreate(url,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
static PyMethodDef _NCRasterFileModuleMethods[] = {

#ifdef WITH_RMI

  { "_connect", (PyCFunction)pStub_NCRasterFile__connect,
  (METH_VARARGS | METH_KEYWORDS),
"\
_connect( in string url)\n\
RETURNS\n\
   ( out edu.csdms.tools.NCRasterFile self)\n\
RAISES\n\
...
static PyMethodDef _NCRasterFileObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_NCRasterFile__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_NCRasterFile__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_NCRasterFile__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_NCRasterFile__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_NCRasterFile__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Method to enable/disable method hooks invocation."
  ...
  { "boccaForceUsePortInclude", (                                             \
    PyCFunction)pStub_NCRasterFile_boccaForceUsePortInclude,
  (METH_VARARGS | METH_KEYWORDS),
"\
boccaForceUsePortInclude()\n\
RETURNS\n\
...
static PyTypeObject _edu_csdms_tools_NCRasterFileType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "edu.csdms.tools.NCRasterFile.NCRasterFile", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
  ...
  "\
SIDL wrapper for the edu.csdms.tools.NCRasterFile type.\
", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  ...
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _NCRasterFileObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  edu_csdms_tools_NCRasterFile_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

edu_csdms_tools_NCRasterFile__wrap_RETURN
edu_csdms_tools_NCRasterFile__wrap edu_csdms_tools_NCRasterFile__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _edu_csdms_tools_NCRasterFileType.tp_new(                        \
      &_edu_csdms_tools_NCRasterFileType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
edu_csdms_tools_NCRasterFile_deref edu_csdms_tools_NCRasterFile_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
edu_csdms_tools_NCRasterFile_PyType edu_csdms_tools_NCRasterFile_PyType_PROTO \
  {
  Py_INCREF(&_edu_csdms_tools_NCRasterFileType);
  return &_edu_csdms_tools_NCRasterFileType;
}
...
edu_csdms_tools_NCRasterFile__convert                                         \
  ...
  *sidlobj = sidl_Cast(obj, "edu.csdms.tools.NCRasterFile");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) edu.csdms.tools.NCRasterFile");
    return 0;
  }
  return 1;
}
...
{
  struct edu_csdms_tools_NCRasterFile__object *sidlobj = NULL;
  if (edu_csdms_tools_NCRasterFile__convert(pyobj, &sidlobj)) {
  ...
  if (obj == Py_None) {
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              edu_csdms_tools_NCRasterFile__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct edu_csdms_tools_NCRasterFile__object *sidlobj = (struct              \
    edu_csdms_tools_NCRasterFile__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = edu_csdms_tools_NCRasterFile__wrap(sidlobj);
  return (*dest == NULL);
}
...
void
initNCRasterFile(void) {
  PyObject *module, *dict, *c_api;
  static void *ExternalAPI[edu_csdms_tools_NCRasterFile__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule("NCRasterFile", _NCRasterFileModuleMethods);
  dict = PyModule_GetDict(module);
  ExternalAPI[edu_csdms_tools_NCRasterFile__wrap_NUM] = (                     \
    void*)edu_csdms_tools_NCRasterFile__wrap;
  ExternalAPI[edu_csdms_tools_NCRasterFile__convert_NUM] = (                  \
    void*)edu_csdms_tools_NCRasterFile__convert;
  ExternalAPI[edu_csdms_tools_NCRasterFile__convert_python_array_NUM] = (     \
    void*)edu_csdms_tools_NCRasterFile__convert_python_array;
  ExternalAPI[edu_csdms_tools_NCRasterFile__convert_sidl_array_NUM] = (       \
    void*)edu_csdms_tools_NCRasterFile__convert_sidl_array;
  ExternalAPI[edu_csdms_tools_NCRasterFile__weakRef_NUM] = (                  \
    void*)edu_csdms_tools_NCRasterFile__weakRef;
  ExternalAPI[edu_csdms_tools_NCRasterFile_deref_NUM] = (                     \
    void*)edu_csdms_tools_NCRasterFile_deref;
  ExternalAPI[edu_csdms_tools_NCRasterFile__newRef_NUM] = (                   \
    void*)edu_csdms_tools_NCRasterFile__newRef;
  ExternalAPI[edu_csdms_tools_NCRasterFile__addRef_NUM] = (                   \
    void*)edu_csdms_tools_NCRasterFile__addRef;
  ExternalAPI[edu_csdms_tools_NCRasterFile_PyType_NUM] = (                    \
    void*)edu_csdms_tools_NCRasterFile_PyType;
#ifdef WITH_RMI
  ExternalAPI[edu_csdms_tools_NCRasterFile__connectI_NUM] = (                 \
    void*)edu_csdms_tools_NCRasterFile__connectI;
#endif /*WITH_RMI*/
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  edu_csdms_tools_IRasterOutputFile__import();
  sidl_BaseClass__import();
  _edu_csdms_tools_NCRasterFileType.tp_base = sidl_BaseClass_PyType();
  _edu_csdms_tools_NCRasterFileType.tp_bases = PyTuple_New(2);
  PyTuple_SetItem(_edu_csdms_tools_NCRasterFileType.tp_bases,0, (PyObject     \
    *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_edu_csdms_tools_NCRasterFileType.tp_bases,1, (PyObject     \
    *)edu_csdms_tools_IRasterOutputFile_PyType());
  if (PyType_Ready(&_edu_csdms_tools_NCRasterFileType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on edu.csdms.tools.NCRasterFile failed.\n");
    return;
  }
  Py_INCREF(&_edu_csdms_tools_NCRasterFileType);
  PyDict_SetItemString(dict, "NCRasterFile", (PyObject                        \
    *)&_edu_csdms_tools_NCRasterFileType);

#ifdef WITH_RMI


  sidl_rmi_ConnectRegistry_registerConnect("edu.csdms.tools.NCRasterFile", (  \
    void*)edu_csdms_tools_NCRasterFile__IHConnect, &throwaway_exception);
