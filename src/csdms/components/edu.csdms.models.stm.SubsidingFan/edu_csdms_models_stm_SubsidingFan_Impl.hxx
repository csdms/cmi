// 
// File:          edu_csdms_models_stm_SubsidingFan_Impl.hxx
...
#ifndef included_edu_csdms_models_stm_SubsidingFan_Impl_hxx
#define included_edu_csdms_models_stm_SubsidingFan_Impl_hxx

#ifndef included_sidl_cxx_hxx
#include "sidl_cxx.hxx"
#endif
#ifndef included_edu_csdms_models_stm_SubsidingFan_IOR_h
#include "edu_csdms_models_stm_SubsidingFan_IOR.h"
#endif
#ifndef included_edu_csdms_models_stm_SubsidingFan_hxx
#include "edu_csdms_models_stm_SubsidingFan.hxx"
#endif
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.SubsidingFan._hincludes)
// Insert-Code-Here {edu.csdms.models.stm.SubsidingFan._hincludes} (includes or arbitrary code)
#include "Initialize.h"
#include "Run.h"
#include "Finalize.h"
#include "SaveDatatoMatrix.h"

// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.SubsidingFan._hincludes)
  ...
  namespace csdms { 
    namespace models { 
      namespace stm { 
        ...
        /**
         * Symbol "edu.csdms.models.stm.SubsidingFan" (version 0.0)
         */
        class SubsidingFan_impl : public virtual 
          ::edu::csdms::models::stm::SubsidingFan 
        // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.SubsidingFan._inherits)
        // Insert-Code-Here {edu.csdms.models.stm.SubsidingFan._inherits} (optional inheritance here)
        // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.SubsidingFan._inherits)
        ...
        protected:
          ...
          // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.SubsidingFan._implementation)

  // Insert-UserCode-Here(edu.csdms.models.stm.SubsidingFan._implementation)
gov::cca::TypeMap userinput;
  ...
  // Bocca generated code. bocca.protected.begin(edu.csdms.models.stm.SubsidingFan._implementation)
  
   gov::cca::Services    d_services; // our cca handle.
 

  // Bocca generated code. bocca.protected.end(edu.csdms.models.stm.SubsidingFan._implementation)

          // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.SubsidingFan._implementation)
        ...
        public:
          ...
          // (fixes bug #275)
            SubsidingFan_impl( struct edu_csdms_models_stm_SubsidingFan__object 
          ...
          virtual ~SubsidingFan_impl() { _dtor(); }
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.SubsidingFan._hmisc)
// Insert-Code-Here {edu.csdms.models.stm.SubsidingFan._hmisc} (miscellaneous things)
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.SubsidingFan._hmisc)
