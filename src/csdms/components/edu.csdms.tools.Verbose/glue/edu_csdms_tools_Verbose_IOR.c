/*
 * File:          edu_csdms_tools_Verbose_IOR.c
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t edu_csdms_tools_Verbose__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &edu_csdms_tools_Verbose__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &edu_csdms_tools_Verbose__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &edu_csdms_tools_Verbose__mutex )==EDEADLOCK) */
#else
...
static struct edu_csdms_tools_Verbose__epv s_my_epv__edu_csdms_tools_verbose;

static struct edu_csdms_tools_Verbose__epv 
  s_my_epv_contracts__edu_csdms_tools_verbose;

static struct edu_csdms_tools_Verbose__epv 
  s_my_epv_hooks__edu_csdms_tools_verbose;

static struct edu_csdms_tools_IMessageLogger__epv 
  s_my_epv__edu_csdms_tools_imessagelogger;
static struct edu_csdms_tools_IMessageLogger__epv 
  s_my_epv_hooks__edu_csdms_tools_imessagelogger;
...
static struct edu_csdms_tools_Verbose__pre_epv s_preEPV;
static struct edu_csdms_tools_Verbose__post_epv s_postEPV;
...
extern void edu_csdms_tools_Verbose__set_epv(
  struct edu_csdms_tools_Verbose__epv* epv,
    struct edu_csdms_tools_Verbose__pre_epv* pre_epv,
    struct edu_csdms_tools_Verbose__post_epv* post_epv);

extern void edu_csdms_tools_Verbose__call_load(void);
#ifdef __cplusplus
}
#endif

static void
edu_csdms_tools_Verbose_boccaForceUsePortInclude__exec(
        struct edu_csdms_tools_Verbose__object* self,
...
static void
edu_csdms_tools_Verbose_addRef__exec(
        struct edu_csdms_tools_Verbose__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_tools_Verbose_deleteRef__exec(
        struct edu_csdms_tools_Verbose__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_tools_Verbose_isSame__exec(
        struct edu_csdms_tools_Verbose__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_edu_csdms_tools_Verbose_fconnect_sidl_BaseInterface(iobj_str, 
    TRUE, _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct edu_csdms_tools_Verbose__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "edu.csdms.tools.Verbose", _ex);
    if(iobj != NULL) {
...
static void
edu_csdms_tools_Verbose_isType__exec(
        struct edu_csdms_tools_Verbose__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_tools_Verbose_getClassInfo__exec(
        struct edu_csdms_tools_Verbose__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_tools_Verbose_set_log_level__exec(
        struct edu_csdms_tools_Verbose__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_tools_Verbose_log__exec(
        struct edu_csdms_tools_Verbose__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_tools_Verbose__cast__exec(
        struct edu_csdms_tools_Verbose__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_edu_csdms_tools_Verbose__set_contracts(
  struct edu_csdms_tools_Verbose__object* self,
  sidl_bool   enable,
...
static void ior_edu_csdms_tools_Verbose__dump_stats(
  struct edu_csdms_tools_Verbose__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_edu_csdms_tools_Verbose__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    edu_csdms_tools_Verbose__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_edu_csdms_tools_Verbose__cast(
  struct edu_csdms_tools_Verbose__object* self,
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    cmp = strcmp(name, "edu.csdms.tools.Verbose");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = ((struct edu_csdms_tools_Verbose__object*)self);
      return cast;
    }
    else if (cmp < 0) {
      cmp = strcmp(name, "edu.csdms.tools.IMessageLogger");
      if (!cmp) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
        cast = &((*self).d_edu_csdms_tools_imessagelogger);
        return cast;
      }
    }
  }
...
static void ior_edu_csdms_tools_Verbose__set_hooks(
  struct edu_csdms_tools_Verbose__object* self,
...
static void ior_edu_csdms_tools_Verbose__delete(
  struct edu_csdms_tools_Verbose__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  edu_csdms_tools_Verbose__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct edu_csdms_tools_Verbose__object));
  free((void*) self);
}

static char*
ior_edu_csdms_tools_Verbose__getURL(
  struct edu_csdms_tools_Verbose__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_edu_csdms_tools_Verbose__raddRef(
    struct edu_csdms_tools_Verbose__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_edu_csdms_tools_Verbose__isRemote(
    struct edu_csdms_tools_Verbose__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct edu_csdms_tools_Verbose__method {
  const char *d_name;
  void (*d_func)(struct edu_csdms_tools_Verbose__object*,
...
static void
ior_edu_csdms_tools_Verbose__exec(
  struct edu_csdms_tools_Verbose__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct edu_csdms_tools_Verbose__method  s_methods[] = {
    { "_cast", edu_csdms_tools_Verbose__cast__exec },
    { "addRef", edu_csdms_tools_Verbose_addRef__exec },
    { "boccaForceUsePortInclude", 
      edu_csdms_tools_Verbose_boccaForceUsePortInclude__exec },
    { "deleteRef", edu_csdms_tools_Verbose_deleteRef__exec },
    { "getClassInfo", edu_csdms_tools_Verbose_getClassInfo__exec },
    { "isSame", edu_csdms_tools_Verbose_isSame__exec },
    { "isType", edu_csdms_tools_Verbose_isType__exec },
    { "log", edu_csdms_tools_Verbose_log__exec },
    { "set_log_level", edu_csdms_tools_Verbose_set_log_level__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct edu_csdms_tools_Verbose__method);
  *_ex  = NULL; /* default to no exception */
...
static void edu_csdms_tools_Verbose__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct edu_csdms_tools_Verbose__epv*        epv  = &s_my_epv__edu_csdms_tools_verbose;
  struct edu_csdms_tools_IMessageLogger__epv* e0   = &s_my_epv__edu_csdms_tools_imessagelogger;
  ...
  epv->f__cast                    = ior_edu_csdms_tools_Verbose__cast;
  epv->f__delete                  = ior_edu_csdms_tools_Verbose__delete;
  epv->f__exec                    = ior_edu_csdms_tools_Verbose__exec;
  epv->f__getURL                  = ior_edu_csdms_tools_Verbose__getURL;
  epv->f__raddRef                 = ior_edu_csdms_tools_Verbose__raddRef;
  epv->f__isRemote                = ior_edu_csdms_tools_Verbose__isRemote;
  epv->f__set_hooks               = ior_edu_csdms_tools_Verbose__set_hooks;
  epv->f__set_contracts           = ior_edu_csdms_tools_Verbose__set_contracts;
  epv->f__dump_stats              = ior_edu_csdms_tools_Verbose__dump_stats;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  epv->f_boccaForceUsePortInclude = NULL;
  epv->f_addRef                   = (void (*)(struct edu_csdms_tools_Verbose__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef                = (void (*)(struct edu_csdms_tools_Verbose__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct edu_csdms_tools_Verbose__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct edu_csdms_tools_Verbose__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct edu_csdms_tools_Verbose__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_set_log_level            = NULL;
  epv->f_log                      = NULL;

  edu_csdms_tools_Verbose__set_epv(epv, &s_preEPV, &s_postEPV);

  /*
   * Override function pointers for edu.csdms.tools.IMessageLogger with mine, as needed.
   */
  ...
  e0->f_set_log_level         = (void (*)(void*,int32_t,struct sidl_BaseInterface__object **)) epv->f_set_log_level;
  e0->f_log                   = (void (*)(void*,int32_t,const char*,struct sidl_BaseInterface__object **)) epv->f_log;
  ...
  ior_edu_csdms_tools_Verbose__ensure_load_called();
}

/*
 * edu_csdms_tools_Verbose__getEPVs: Get my version of all relevant EPVs.
 */

void edu_csdms_tools_Verbose__getEPVs (
  struct sidl_BaseInterface__epv **s_arg_epv__sidl_baseinterface,
  struct sidl_BaseClass__epv **s_arg_epv__sidl_baseclass,
  struct edu_csdms_tools_IMessageLogger__epv **s_arg_epv__edu_csdms_tools_imessagelogger,
  struct edu_csdms_tools_IMessageLogger__epv **s_arg_epv_hooks__edu_csdms_tools_imessagelogger,
  struct edu_csdms_tools_Verbose__epv **s_arg_epv__edu_csdms_tools_verbose,
  struct edu_csdms_tools_Verbose__epv **s_arg_epv_hooks__edu_csdms_tools_verbose)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    edu_csdms_tools_Verbose__init_epv();
  }
  UNLOCK_STATIC_GLOBALS;

  *s_arg_epv__sidl_baseinterface = &s_my_epv__sidl_baseinterface;
  *s_arg_epv__sidl_baseclass = &s_my_epv__sidl_baseclass;
  *s_arg_epv__edu_csdms_tools_imessagelogger = &s_my_epv__edu_csdms_tools_imessagelogger;
  *s_arg_epv_hooks__edu_csdms_tools_imessagelogger = &s_my_epv_hooks__edu_csdms_tools_imessagelogger;
  *s_arg_epv__edu_csdms_tools_verbose = &s_my_epv__edu_csdms_tools_verbose;
  *s_arg_epv_hooks__edu_csdms_tools_verbose = &s_my_epv_hooks__edu_csdms_tools_verbose;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* edu_csdms_tools_Verbose__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "edu.csdms.tools.Verbose", _ex);
...
static void
initMetadata(struct edu_csdms_tools_Verbose__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * edu_csdms_tools_Verbose__createObject: Allocate the object and initialize it.
 */

struct edu_csdms_tools_Verbose__object*
edu_csdms_tools_Verbose__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct edu_csdms_tools_Verbose__object* self =
    (struct edu_csdms_tools_Verbose__object*) sidl_malloc(
      sizeof(struct edu_csdms_tools_Verbose__object),
      "Object allocation failed for struct edu_csdms_tools_Verbose__object",
        __FILE__, __LINE__, "edu_csdms_tools_Verbose__createObject", _ex);
  if (!self) goto EXIT;
  edu_csdms_tools_Verbose__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void edu_csdms_tools_Verbose__init(
  struct edu_csdms_tools_Verbose__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_tools_Verbose__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_edu_csdms_tools_imessagelogger.d_epv = &s_my_epv__edu_csdms_tools_imessagelogger;
  s0->d_epv                                  = &s_my_epv__edu_csdms_tools_verbose;

  s0->d_edu_csdms_tools_imessagelogger.d_object = self;
...
void edu_csdms_tools_Verbose__fini(
  struct edu_csdms_tools_Verbose__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_tools_Verbose__object* s0 = self;
...
void
edu_csdms_tools_Verbose__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct edu_csdms_tools_Verbose__external
s_externalEntryPoints = {
  edu_csdms_tools_Verbose__createObject,
  edu_csdms_tools_Verbose__getSuperEPV,
  2, 
  0
};
