/*
 * File:          edu_csdms_openmi_ElementMapper_IOR.c
 * Symbol:        edu.csdms.openmi.ElementMapper-v0.0
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Intermediate Object Representation for edu.csdms.openmi.ElementMapper
 * 
...
static struct edu_csdms_openmi_ElementMapper__epv 
  s_my_epv__edu_csdms_openmi_elementmapper;

static struct edu_csdms_openmi_ElementMapper__epv 
  s_my_epv_contracts__edu_csdms_openmi_elementmapper;

static struct edu_csdms_openmi_ElementMapper__epv 
  s_my_epv_hooks__edu_csdms_openmi_elementmapper;
...
static struct edu_csdms_openmi_ElementMapper__pre_epv s_preEPV;
static struct edu_csdms_openmi_ElementMapper__post_epv s_postEPV;
...
extern void edu_csdms_openmi_ElementMapper__set_epv(
  struct edu_csdms_openmi_ElementMapper__epv* epv,
    struct edu_csdms_openmi_ElementMapper__pre_epv* pre_epv,
    struct edu_csdms_openmi_ElementMapper__post_epv* post_epv);

extern void edu_csdms_openmi_ElementMapper__call_load(void);
#ifdef __cplusplus
}
#endif

static void
edu_csdms_openmi_ElementMapper_initialise__exec(
  ...
  char* methodDescription= NULL;
  char* fromElements_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass fromElements_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ElementSet__object* fromElements = NULL;
  char* toElements_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass toElements_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ElementSet__object* toElements = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackString( inArgs, "methodDescription", &methodDescription, 
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackString( inArgs, "fromElements", &fromElements_str, 
    _ex);SIDL_CHECK(*_ex);
#ifdef WITH_RMI

  fromElements = 
    skel_edu_csdms_openmi_ElementMapper_fconnect_edu_csdms_openmi_ElementSet(
    fromElements_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  fromElements_bc = sidl_rmi_InstanceRegistry_getInstanceByString(
    fromElements_str, _ex);SIDL_CHECK(*_ex);
  if(fromElements_bc != NULL) {
    fromElements= (struct edu_csdms_openmi_ElementMapper__object*) (
      *fromElements_bc->d_epv->f__cast)(fromElements_bc, 
      "edu.csdms.openmi.ElementMapper", _ex);
    if(fromElements != NULL) {
      (((struct sidl_BaseInterface__object*)(
        fromElements))->d_epv->f_deleteRef)(((struct 
        sidl_BaseInterface__object*)fromElements)->d_object, _ex); SIDL_CHECK(
        *_ex);
    } else {
      (*fromElements_bc->d_epv->f_deleteRef)(fromElements_bc, _ex);
    }
  }
#endif /* WITH_RMI */
  sidl_rmi_Call_unpackString( inArgs, "toElements", &toElements_str, 
    _ex);SIDL_CHECK(*_ex);
#ifdef WITH_RMI

  toElements = 
    skel_edu_csdms_openmi_ElementMapper_fconnect_edu_csdms_openmi_ElementSet(
    toElements_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  toElements_bc = sidl_rmi_InstanceRegistry_getInstanceByString(toElements_str, 
    _ex);SIDL_CHECK(*_ex);
  if(toElements_bc != NULL) {
    toElements= (struct edu_csdms_openmi_ElementMapper__object*) (
      *toElements_bc->d_epv->f__cast)(toElements_bc, 
      "edu.csdms.openmi.ElementMapper", _ex);
    if(toElements != NULL) {
      (((struct sidl_BaseInterface__object*)(toElements))->d_epv->f_deleteRef)((
        (struct sidl_BaseInterface__object*)toElements)->d_object, _ex); 
        SIDL_CHECK(*_ex);
    } else {
      (*toElements_bc->d_epv->f_deleteRef)(toElements_bc, _ex);
    }
  }
#endif /* WITH_RMI */

  /* make the call */
  (self->d_epv->f_initialise)(
    self,
    methodDescription,
    fromElements,
    toElements,
  ...
  if(methodDescription) {free(methodDescription);}
  if(fromElements_str) {free(fromElements_str);}
  if(fromElements) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)fromElements, &_ex3); 
      EXEC_CHECK(_ex3);
  }
  if(toElements_str) {free(toElements_str);}
  if(toElements) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)toElements, &_ex3); 
      EXEC_CHECK(_ex3);
  }
  EXEC_ERR:
  if(*_ex) { 
...
static void
edu_csdms_openmi_ElementMapper_mapValues__exec(
        struct edu_csdms_openmi_ElementMapper__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  /* stack space for arguments */
  char* inputValues_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass inputValues_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_IValueSet__object* inputValues = NULL;
  struct edu_csdms_openmi_IValueSet__object* _retval = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackString( inArgs, "inputValues", &inputValues_str, 
    _ex);SIDL_CHECK(*_ex);
#ifdef WITH_RMI

  inputValues = 
    skel_edu_csdms_openmi_ElementMapper_fconnect_edu_csdms_openmi_IValueSet(
    inputValues_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  inputValues_bc = sidl_rmi_InstanceRegistry_getInstanceByString(
    inputValues_str, _ex);SIDL_CHECK(*_ex);
  if(inputValues_bc != NULL) {
    inputValues= (struct edu_csdms_openmi_ElementMapper__object*) (
      *inputValues_bc->d_epv->f__cast)(inputValues_bc, 
      "edu.csdms.openmi.ElementMapper", _ex);
    if(inputValues != NULL) {
      (((struct sidl_BaseInterface__object*)(inputValues))->d_epv->f_deleteRef)(
        ((struct sidl_BaseInterface__object*)inputValues)->d_object, _ex); 
        SIDL_CHECK(*_ex);
    } else {
      (*inputValues_bc->d_epv->f_deleteRef)(inputValues_bc, _ex);
    }
  }
#endif /* WITH_RMI */

  /* make the call */
  _retval = (self->d_epv->f_mapValues)(
    self,
    inputValues,
    _ex);  SIDL_CHECK(*_ex);
  ...
  if(inputValues_str) {free(inputValues_str);}
  if(inputValues) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)inputValues, &_ex3); 
      EXEC_CHECK(_ex3);
  }
  EXEC_ERR:
  if(*_ex) { 
...
static void
edu_csdms_openmi_ElementMapper_mapScalarValues__exec(
        struct edu_csdms_openmi_ElementMapper__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  sidl_BaseClass inputValues_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ScalarSet__object* inputValues = NULL;
  struct edu_csdms_openmi_IScalarSet__object* _retval = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  ...
  inputValues = 
    skel_edu_csdms_openmi_ElementMapper_fconnect_edu_csdms_openmi_ScalarSet(
    inputValues_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  inputValues_bc = sidl_rmi_InstanceRegistry_getInstanceByString(
    inputValues_str, _ex);SIDL_CHECK(*_ex);
  ...
  /* make the call */
  _retval = (self->d_epv->f_mapScalarValues)(
    self,
    inputValues,
    _ex);  SIDL_CHECK(*_ex);
...
static void
edu_csdms_openmi_ElementMapper_boccaForceUsePortInclude__exec(
        struct edu_csdms_openmi_ElementMapper__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
#endif /* WITH_RMI */
  struct edu_csdms_openmi_IValueSet__object* dummy0 = NULL;
  char* dummy1_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy1_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ScalarSet__object* dummy1 = NULL;
  char* dummy2_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy2_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_ElementSet__object* dummy2 = NULL;
  char* dummy3_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy3_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_Element__object* dummy3 = NULL;
  char* dummy4_str = NULL;
#ifndef WITH_RMI
  sidl_BaseClass dummy4_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_IScalarSet__object* dummy4 = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  ...
  dummy0_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy0_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy0_bc != NULL) {
    dummy0= (struct edu_csdms_openmi_ElementMapper__object*) (
      *dummy0_bc->d_epv->f__cast)(dummy0_bc, "edu.csdms.openmi.ElementMapper", 
      _ex);
    if(dummy0 != NULL) {
  ...
  dummy1_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy1_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy1_bc != NULL) {
    dummy1= (struct edu_csdms_openmi_ElementMapper__object*) (
      *dummy1_bc->d_epv->f__cast)(dummy1_bc, "edu.csdms.openmi.ElementMapper", 
      _ex);
    if(dummy1 != NULL) {
  ...
  dummy2_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy2_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy2_bc != NULL) {
    dummy2= (struct edu_csdms_openmi_ElementMapper__object*) (
      *dummy2_bc->d_epv->f__cast)(dummy2_bc, "edu.csdms.openmi.ElementMapper", 
      _ex);
    if(dummy2 != NULL) {
  ...
  dummy3 = 
    skel_edu_csdms_openmi_ElementMapper_fconnect_edu_csdms_openmi_Element(
    dummy3_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy3_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy3_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy3_bc != NULL) {
    dummy3= (struct edu_csdms_openmi_ElementMapper__object*) (
      *dummy3_bc->d_epv->f__cast)(dummy3_bc, "edu.csdms.openmi.ElementMapper", 
      _ex);
    if(dummy3 != NULL) {
  ...
  dummy4 = 
    skel_edu_csdms_openmi_ElementMapper_fconnect_edu_csdms_openmi_IScalarSet(
    dummy4_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy4_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy4_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy4_bc != NULL) {
    dummy4= (struct edu_csdms_openmi_ElementMapper__object*) (
      *dummy4_bc->d_epv->f__cast)(dummy4_bc, "edu.csdms.openmi.ElementMapper", 
      _ex);
    if(dummy4 != NULL) {
...
static void
edu_csdms_openmi_ElementMapper_addRef__exec(
        struct edu_csdms_openmi_ElementMapper__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_ElementMapper_deleteRef__exec(
        struct edu_csdms_openmi_ElementMapper__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_ElementMapper_isSame__exec(
        struct edu_csdms_openmi_ElementMapper__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_edu_csdms_openmi_ElementMapper_fconnect_sidl_BaseInterface(
    iobj_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct edu_csdms_openmi_ElementMapper__object*) (
      *iobj_bc->d_epv->f__cast)(iobj_bc, "edu.csdms.openmi.ElementMapper", _ex);
    if(iobj != NULL) {
...
static void
edu_csdms_openmi_ElementMapper_isType__exec(
        struct edu_csdms_openmi_ElementMapper__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_ElementMapper_getClassInfo__exec(
        struct edu_csdms_openmi_ElementMapper__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_ElementMapper__cast__exec(
        struct edu_csdms_openmi_ElementMapper__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_edu_csdms_openmi_ElementMapper__set_contracts(
  struct edu_csdms_openmi_ElementMapper__object* self,
  sidl_bool   enable,
...
static void ior_edu_csdms_openmi_ElementMapper__dump_stats(
  struct edu_csdms_openmi_ElementMapper__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_edu_csdms_openmi_ElementMapper__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    edu_csdms_openmi_ElementMapper__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_edu_csdms_openmi_ElementMapper__cast(
  struct edu_csdms_openmi_ElementMapper__object* self,
...
static void ior_edu_csdms_openmi_ElementMapper__set_hooks(
  struct edu_csdms_openmi_ElementMapper__object* self,
...
static void ior_edu_csdms_openmi_ElementMapper__delete(
  struct edu_csdms_openmi_ElementMapper__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  edu_csdms_openmi_ElementMapper__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct edu_csdms_openmi_ElementMapper__object));
  free((void*) self);
}

static char*
ior_edu_csdms_openmi_ElementMapper__getURL(
  struct edu_csdms_openmi_ElementMapper__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_edu_csdms_openmi_ElementMapper__raddRef(
    struct edu_csdms_openmi_ElementMapper__object* self, sidl_BaseInterface* 
  _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_edu_csdms_openmi_ElementMapper__isRemote(
    struct edu_csdms_openmi_ElementMapper__object* self, sidl_BaseInterface* 
  _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
...
struct edu_csdms_openmi_ElementMapper__method {
  const char *d_name;
  void (*d_func)(struct edu_csdms_openmi_ElementMapper__object*,
...
static void
ior_edu_csdms_openmi_ElementMapper__exec(
  struct edu_csdms_openmi_ElementMapper__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct edu_csdms_openmi_ElementMapper__method  s_methods[] = {
    { "_cast", edu_csdms_openmi_ElementMapper__cast__exec },
    { "addRef", edu_csdms_openmi_ElementMapper_addRef__exec },
    { "boccaForceUsePortInclude", 
      edu_csdms_openmi_ElementMapper_boccaForceUsePortInclude__exec },
    { "deleteRef", edu_csdms_openmi_ElementMapper_deleteRef__exec },
    { "getClassInfo", edu_csdms_openmi_ElementMapper_getClassInfo__exec },
    { "initialise", edu_csdms_openmi_ElementMapper_initialise__exec },
    { "isSame", edu_csdms_openmi_ElementMapper_isSame__exec },
    { "isType", edu_csdms_openmi_ElementMapper_isType__exec },
    { "mapScalarValues", edu_csdms_openmi_ElementMapper_mapScalarValues__exec },
    { "mapValues", edu_csdms_openmi_ElementMapper_mapValues__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct 
    edu_csdms_openmi_ElementMapper__method);
  *_ex  = NULL; /* default to no exception */
...
static void edu_csdms_openmi_ElementMapper__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct edu_csdms_openmi_ElementMapper__epv*  epv  = &s_my_epv__edu_csdms_openmi_elementmapper;
  ...
  epv->f__cast                    = ior_edu_csdms_openmi_ElementMapper__cast;
  epv->f__delete                  = ior_edu_csdms_openmi_ElementMapper__delete;
  epv->f__exec                    = ior_edu_csdms_openmi_ElementMapper__exec;
  epv->f__getURL                  = ior_edu_csdms_openmi_ElementMapper__getURL;
  epv->f__raddRef                 = ior_edu_csdms_openmi_ElementMapper__raddRef;
  epv->f__isRemote                = ior_edu_csdms_openmi_ElementMapper__isRemote;
  epv->f__set_hooks               = ior_edu_csdms_openmi_ElementMapper__set_hooks;
  epv->f__set_contracts           = ior_edu_csdms_openmi_ElementMapper__set_contracts;
  epv->f__dump_stats              = ior_edu_csdms_openmi_ElementMapper__dump_stats;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  epv->f_initialise               = NULL;
  epv->f_mapValues                = NULL;
  epv->f_mapScalarValues          = NULL;
  epv->f_boccaForceUsePortInclude = NULL;
  epv->f_addRef                   = (void (*)(struct edu_csdms_openmi_ElementMapper__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef                = (void (*)(struct edu_csdms_openmi_ElementMapper__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct edu_csdms_openmi_ElementMapper__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct edu_csdms_openmi_ElementMapper__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct edu_csdms_openmi_ElementMapper__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;

  edu_csdms_openmi_ElementMapper__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  ior_edu_csdms_openmi_ElementMapper__ensure_load_called();
}

/*
 * edu_csdms_openmi_ElementMapper__getEPVs: Get my version of all relevant EPVs.
 */

void edu_csdms_openmi_ElementMapper__getEPVs (
  struct sidl_BaseInterface__epv **s_arg_epv__sidl_baseinterface,
  struct sidl_BaseClass__epv **s_arg_epv__sidl_baseclass,
  struct edu_csdms_openmi_ElementMapper__epv **s_arg_epv__edu_csdms_openmi_elementmapper,
  struct edu_csdms_openmi_ElementMapper__epv **s_arg_epv_hooks__edu_csdms_openmi_elementmapper)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    edu_csdms_openmi_ElementMapper__init_epv();
  }
  UNLOCK_STATIC_GLOBALS;

  *s_arg_epv__sidl_baseinterface = &s_my_epv__sidl_baseinterface;
  *s_arg_epv__sidl_baseclass = &s_my_epv__sidl_baseclass;
  *s_arg_epv__edu_csdms_openmi_elementmapper = &s_my_epv__edu_csdms_openmi_elementmapper;
  *s_arg_epv_hooks__edu_csdms_openmi_elementmapper = &s_my_epv_hooks__edu_csdms_openmi_elementmapper;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* edu_csdms_openmi_ElementMapper__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "edu.csdms.openmi.ElementMapper", _ex);
...
static void
initMetadata(struct edu_csdms_openmi_ElementMapper__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * edu_csdms_openmi_ElementMapper__createObject: Allocate the object and initialize it.
 */

struct edu_csdms_openmi_ElementMapper__object*
edu_csdms_openmi_ElementMapper__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct edu_csdms_openmi_ElementMapper__object* self =
    (struct edu_csdms_openmi_ElementMapper__object*) sidl_malloc(
      sizeof(struct edu_csdms_openmi_ElementMapper__object),
      "Object allocation failed for struct edu_csdms_openmi_ElementMapper__object",
        __FILE__, __LINE__, "edu_csdms_openmi_ElementMapper__createObject", _ex);
  if (!self) goto EXIT;
  edu_csdms_openmi_ElementMapper__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void edu_csdms_openmi_ElementMapper__init(
  struct edu_csdms_openmi_ElementMapper__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_openmi_ElementMapper__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__edu_csdms_openmi_elementmapper;
...
void edu_csdms_openmi_ElementMapper__fini(
  struct edu_csdms_openmi_ElementMapper__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_openmi_ElementMapper__object* s0 = self;
...
void
edu_csdms_openmi_ElementMapper__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct edu_csdms_openmi_ElementMapper__external
s_externalEntryPoints = {
  edu_csdms_openmi_ElementMapper__createObject,
  edu_csdms_openmi_ElementMapper__getSuperEPV,
  2, 
  0
};
...
const struct edu_csdms_openmi_ElementMapper__external*
edu_csdms_openmi_ElementMapper__externals(void)
{
