/*
 * File:          edu_csdms_openmi_ElementMapper_jniStub.h
 * Symbol:        edu.csdms.openmi.ElementMapper-v0.0
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Client-side header code for edu.csdms.openmi.ElementMapper
 * 
...
#define included_edu_csdms_openmi_ElementMapper_jniStub_h
...
#pragma weak edu_csdms_openmi_ElementMapper__connectI
