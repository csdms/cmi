/*
 * File:          edu_csdms_openmi_Element_IOR.c
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t edu_csdms_openmi_Element__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &edu_csdms_openmi_Element__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &edu_csdms_openmi_Element__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &edu_csdms_openmi_Element__mutex )==EDEADLOCK) */
#else
...
static struct edu_csdms_openmi_Element__epv s_my_epv__edu_csdms_openmi_element;

static struct edu_csdms_openmi_Element__epv 
  s_my_epv_contracts__edu_csdms_openmi_element;

static struct edu_csdms_openmi_Element__epv 
  s_my_epv_hooks__edu_csdms_openmi_element;
...
static struct edu_csdms_openmi_Element__pre_epv s_preEPV;
static struct edu_csdms_openmi_Element__post_epv s_postEPV;
...
extern void edu_csdms_openmi_Element__set_epv(
  struct edu_csdms_openmi_Element__epv* epv,
    struct edu_csdms_openmi_Element__pre_epv* pre_epv,
    struct edu_csdms_openmi_Element__post_epv* post_epv);

extern void edu_csdms_openmi_Element__call_load(void);
#ifdef __cplusplus
}
#endif

static void
edu_csdms_openmi_Element_setVertices__exec(
  ...
  struct edu_csdms_openmi_Vertex__array* vertices = NULL;
  ...
  sidl__array_deleteRef((struct sidl__array*)vertices);
  if(*_ex) { 
...
static void
edu_csdms_openmi_Element_getID__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_Element_setID__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_Element_getVertex__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  /* stack space for arguments */
  int32_t index = 0;
  struct edu_csdms_openmi_Vertex__object* _retval = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  ...
  /* make the call */
  _retval = (self->d_epv->f_getVertex)(
    self,
    index,
    _ex);  SIDL_CHECK(*_ex);
...
static void
edu_csdms_openmi_Element_getVertexCount__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_Element_addVertex__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
#ifndef WITH_RMI
  sidl_BaseClass vertex_bc = NULL;
#endif /* WITH_RMI */
  struct edu_csdms_openmi_Vertex__object* vertex = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackString( inArgs, "vertex", &vertex_str, _ex);SIDL_CHECK(
    *_ex);
#ifdef WITH_RMI

  vertex = skel_edu_csdms_openmi_Element_fconnect_edu_csdms_openmi_Vertex(
    vertex_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  vertex_bc = sidl_rmi_InstanceRegistry_getInstanceByString(vertex_str, 
    _ex);SIDL_CHECK(*_ex);
  if(vertex_bc != NULL) {
    vertex= (struct edu_csdms_openmi_Element__object*) (
      *vertex_bc->d_epv->f__cast)(vertex_bc, "edu.csdms.openmi.Element", _ex);
    if(vertex != NULL) {
      (((struct sidl_BaseInterface__object*)(vertex))->d_epv->f_deleteRef)(((
        struct sidl_BaseInterface__object*)vertex)->d_object, _ex); SIDL_CHECK(
        *_ex);
    } else {
      (*vertex_bc->d_epv->f_deleteRef)(vertex_bc, _ex);
    }
  }
#endif /* WITH_RMI */

  /* make the call */
  (self->d_epv->f_addVertex)(
    self,
    vertex,
    _ex);  SIDL_CHECK(*_ex);
  ...
  if(vertex) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)vertex, &_ex3); EXEC_CHECK(
      _ex3);
  }
  EXEC_ERR:
  if(*_ex) { 
...
static void
edu_csdms_openmi_Element_getFaceCount__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_Element_addFace__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  /* stack space for arguments */
  struct sidl_int__array* vertexIndices = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackIntArray( inArgs, "vertexIndices", &vertexIndices,0,0,
    FALSE, _ex);SIDL_CHECK(*_ex);

  /* make the call */
  (self->d_epv->f_addFace)(
    self,
    vertexIndices,
    _ex);  SIDL_CHECK(*_ex);
  ...
  EXIT:
  /* clean-up dangling references */
  sidl__array_deleteRef((struct sidl__array*)vertexIndices);
  if(*_ex) { 
    _SIDLex = sidl_BaseException__cast(*_ex,&_throwaway_exception);
    sidl_rmi_Return_throwException(outArgs, _SIDLex, &_throwaway_exception); 
    if(_throwaway_exception) {
...
static void
edu_csdms_openmi_Element_getFaceVertexIndices__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_Element_boccaForceUsePortInclude__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
#endif /* WITH_RMI */
  struct edu_csdms_openmi_Vertex__object* dummy0 = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  ...
  dummy0 = skel_edu_csdms_openmi_Element_fconnect_edu_csdms_openmi_Vertex(
    dummy0_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  dummy0_bc = sidl_rmi_InstanceRegistry_getInstanceByString(dummy0_str, 
    _ex);SIDL_CHECK(*_ex);
  if(dummy0_bc != NULL) {
    dummy0= (struct edu_csdms_openmi_Element__object*) (
      *dummy0_bc->d_epv->f__cast)(dummy0_bc, "edu.csdms.openmi.Element", _ex);
    if(dummy0 != NULL) {
...
static void
edu_csdms_openmi_Element_addRef__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_Element_deleteRef__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_Element_isSame__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_edu_csdms_openmi_Element_fconnect_sidl_BaseInterface(iobj_str, 
    TRUE, _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct edu_csdms_openmi_Element__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "edu.csdms.openmi.Element", _ex);
    if(iobj != NULL) {
...
static void
edu_csdms_openmi_Element_isType__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_Element_getClassInfo__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_Element__cast__exec(
        struct edu_csdms_openmi_Element__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_edu_csdms_openmi_Element__set_contracts(
  struct edu_csdms_openmi_Element__object* self,
  sidl_bool   enable,
...
static void ior_edu_csdms_openmi_Element__dump_stats(
  struct edu_csdms_openmi_Element__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_edu_csdms_openmi_Element__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    edu_csdms_openmi_Element__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_edu_csdms_openmi_Element__cast(
  struct edu_csdms_openmi_Element__object* self,
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    cmp = strcmp(name, "edu.csdms.openmi.Element");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = ((struct edu_csdms_openmi_Element__object*)self);
      return cast;
    }
  }
  else if (cmp > 0) {
...
static void ior_edu_csdms_openmi_Element__set_hooks(
  struct edu_csdms_openmi_Element__object* self,
...
static void ior_edu_csdms_openmi_Element__delete(
  struct edu_csdms_openmi_Element__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  edu_csdms_openmi_Element__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct edu_csdms_openmi_Element__object));
  free((void*) self);
}

static char*
ior_edu_csdms_openmi_Element__getURL(
  struct edu_csdms_openmi_Element__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_edu_csdms_openmi_Element__raddRef(
    struct edu_csdms_openmi_Element__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_edu_csdms_openmi_Element__isRemote(
    struct edu_csdms_openmi_Element__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct edu_csdms_openmi_Element__method {
  const char *d_name;
  void (*d_func)(struct edu_csdms_openmi_Element__object*,
...
static void
ior_edu_csdms_openmi_Element__exec(
  struct edu_csdms_openmi_Element__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct edu_csdms_openmi_Element__method  s_methods[] = {
    { "_cast", edu_csdms_openmi_Element__cast__exec },
    { "addFace", edu_csdms_openmi_Element_addFace__exec },
    { "addRef", edu_csdms_openmi_Element_addRef__exec },
    { "addVertex", edu_csdms_openmi_Element_addVertex__exec },
    { "boccaForceUsePortInclude", 
      edu_csdms_openmi_Element_boccaForceUsePortInclude__exec },
    { "deleteRef", edu_csdms_openmi_Element_deleteRef__exec },
    { "getClassInfo", edu_csdms_openmi_Element_getClassInfo__exec },
    { "getFaceCount", edu_csdms_openmi_Element_getFaceCount__exec },
    { "getFaceVertexIndices", 
      edu_csdms_openmi_Element_getFaceVertexIndices__exec },
    { "getID", edu_csdms_openmi_Element_getID__exec },
    { "getVertex", edu_csdms_openmi_Element_getVertex__exec },
    { "getVertexCount", edu_csdms_openmi_Element_getVertexCount__exec },
    { "isSame", edu_csdms_openmi_Element_isSame__exec },
    { "isType", edu_csdms_openmi_Element_isType__exec },
    { "setID", edu_csdms_openmi_Element_setID__exec },
    { "setVertices", edu_csdms_openmi_Element_setVertices__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct edu_csdms_openmi_Element__method);
  *_ex  = NULL; /* default to no exception */
...
static void edu_csdms_openmi_Element__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct edu_csdms_openmi_Element__epv*  epv  = &s_my_epv__edu_csdms_openmi_element;
  ...
  epv->f__cast                    = ior_edu_csdms_openmi_Element__cast;
  epv->f__delete                  = ior_edu_csdms_openmi_Element__delete;
  epv->f__exec                    = ior_edu_csdms_openmi_Element__exec;
  epv->f__getURL                  = ior_edu_csdms_openmi_Element__getURL;
  epv->f__raddRef                 = ior_edu_csdms_openmi_Element__raddRef;
  epv->f__isRemote                = ior_edu_csdms_openmi_Element__isRemote;
  epv->f__set_hooks               = ior_edu_csdms_openmi_Element__set_hooks;
  epv->f__set_contracts           = ior_edu_csdms_openmi_Element__set_contracts;
  epv->f__dump_stats              = ior_edu_csdms_openmi_Element__dump_stats;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  epv->f_setVertices              = NULL;
  epv->f_getID                    = NULL;
  epv->f_setID                    = NULL;
  epv->f_getVertex                = NULL;
  epv->f_getVertexCount           = NULL;
  epv->f_addVertex                = NULL;
  epv->f_getFaceCount             = NULL;
  epv->f_addFace                  = NULL;
  epv->f_getFaceVertexIndices     = NULL;
  epv->f_boccaForceUsePortInclude = NULL;
  epv->f_addRef                   = (void (*)(struct edu_csdms_openmi_Element__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef                = (void (*)(struct edu_csdms_openmi_Element__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct edu_csdms_openmi_Element__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct edu_csdms_openmi_Element__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct edu_csdms_openmi_Element__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;

  edu_csdms_openmi_Element__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  ior_edu_csdms_openmi_Element__ensure_load_called();
}

/*
 * edu_csdms_openmi_Element__getEPVs: Get my version of all relevant EPVs.
 */

void edu_csdms_openmi_Element__getEPVs (
  struct sidl_BaseInterface__epv **s_arg_epv__sidl_baseinterface,
  struct sidl_BaseClass__epv **s_arg_epv__sidl_baseclass,
  struct edu_csdms_openmi_Element__epv **s_arg_epv__edu_csdms_openmi_element,
  struct edu_csdms_openmi_Element__epv **s_arg_epv_hooks__edu_csdms_openmi_element)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    edu_csdms_openmi_Element__init_epv();
  }
  UNLOCK_STATIC_GLOBALS;

  *s_arg_epv__sidl_baseinterface = &s_my_epv__sidl_baseinterface;
  *s_arg_epv__sidl_baseclass = &s_my_epv__sidl_baseclass;
  *s_arg_epv__edu_csdms_openmi_element = &s_my_epv__edu_csdms_openmi_element;
  *s_arg_epv_hooks__edu_csdms_openmi_element = &s_my_epv_hooks__edu_csdms_openmi_element;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* edu_csdms_openmi_Element__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "edu.csdms.openmi.Element", _ex);
...
static void
initMetadata(struct edu_csdms_openmi_Element__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * edu_csdms_openmi_Element__createObject: Allocate the object and initialize it.
 */

struct edu_csdms_openmi_Element__object*
edu_csdms_openmi_Element__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct edu_csdms_openmi_Element__object* self =
    (struct edu_csdms_openmi_Element__object*) sidl_malloc(
      sizeof(struct edu_csdms_openmi_Element__object),
      "Object allocation failed for struct edu_csdms_openmi_Element__object",
        __FILE__, __LINE__, "edu_csdms_openmi_Element__createObject", _ex);
  if (!self) goto EXIT;
  edu_csdms_openmi_Element__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void edu_csdms_openmi_Element__init(
  struct edu_csdms_openmi_Element__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_openmi_Element__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__edu_csdms_openmi_element;
...
void edu_csdms_openmi_Element__fini(
  struct edu_csdms_openmi_Element__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_openmi_Element__object* s0 = self;
...
void
edu_csdms_openmi_Element__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct edu_csdms_openmi_Element__external
s_externalEntryPoints = {
  edu_csdms_openmi_Element__createObject,
  edu_csdms_openmi_Element__getSuperEPV,
  2, 
  0
};
