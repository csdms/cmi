// 
// File:          edu_csdms_models_stm_DeltaBW_Impl.hxx
...
#ifndef included_edu_csdms_models_stm_DeltaBW_Impl_hxx
#define included_edu_csdms_models_stm_DeltaBW_Impl_hxx

#ifndef included_sidl_cxx_hxx
#include "sidl_cxx.hxx"
#endif
#ifndef included_edu_csdms_models_stm_DeltaBW_IOR_h
#include "edu_csdms_models_stm_DeltaBW_IOR.h"
#endif
#ifndef included_edu_csdms_models_stm_DeltaBW_hxx
#include "edu_csdms_models_stm_DeltaBW.hxx"
#endif
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.DeltaBW._hincludes)
// Insert-Code-Here {edu.csdms.models.stm.DeltaBW._hincludes} (includes or arbitrary code)
#include "Initialize.h"
#include "Run.h"
#include "Finalize.h"
#include "SaveDatatoMatrix.h"
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.DeltaBW._hincludes)
  ...
  namespace csdms { 
    namespace models { 
      namespace stm { 
        ...
        /**
         * Symbol "edu.csdms.models.stm.DeltaBW" (version 0.0)
         */
        class DeltaBW_impl : public virtual ::edu::csdms::models::stm::DeltaBW 
        // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.DeltaBW._inherits)
        // Insert-Code-Here {edu.csdms.models.stm.DeltaBW._inherits} (optional inheritance here)
        // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.DeltaBW._inherits)
        ...
        protected:
          ...
          // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.DeltaBW._implementation)

  // Insert-UserCode-Here(edu.csdms.models.stm.DeltaBW._implementation)

    gov::cca::TypeMap userinput; // added for user input
    int check, M, prints, iterates, formulation, bombed, k, m;
    ...
    double Sa, ssfi, R, lamdap, ks, alphat, alphar, dt, dxbar;
    double Cf, sfmax, ksid, Volinit, abase, etasdot, etatop, etabot;
    double sss, sbb, tsn, Sn, Hn, Frn, __time, ssdot, sbdot, Volfed;
    double Volfin, ervol;

    double (*printmatrix)[102], (*Slmatrix)[102], (*qbmatrix)[102];
    double (*taumatrix)[102], (*Hmatrix)[102], (*xmatrix)[102];
    double sssvector[102], sbbvector[102];
  // Bocca generated code. bocca.protected.begin(edu.csdms.models.stm.DeltaBW._implementation)
  
   gov::cca::Services    d_services; // our cca handle.
 

  // Bocca generated code. bocca.protected.end(edu.csdms.models.stm.DeltaBW._implementation)

          // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.DeltaBW._implementation)
        ...
        public:
          ...
          // (fixes bug #275)
            DeltaBW_impl( struct edu_csdms_models_stm_DeltaBW__object * ior ) : 
              StubBase(ior,true), 
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.DeltaBW._hmisc)
// Insert-Code-Here {edu.csdms.models.stm.DeltaBW._hmisc} (miscellaneous things)
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.DeltaBW._hmisc)
