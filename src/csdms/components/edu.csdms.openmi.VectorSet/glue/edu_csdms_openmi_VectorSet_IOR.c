/*
 * File:          edu_csdms_openmi_VectorSet_IOR.c
...
#include "sidlOps.h"
#endif
#include "edu_csdms_openmi_VectorSet_IOR.h"
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t edu_csdms_openmi_VectorSet__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &edu_csdms_openmi_VectorSet__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &edu_csdms_openmi_VectorSet__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &edu_csdms_openmi_VectorSet__mutex )==EDEADLOCK) */
#else
...
static struct edu_csdms_openmi_VectorSet__epv 
  s_my_epv__edu_csdms_openmi_vectorset;

static struct edu_csdms_openmi_VectorSet__epv 
  s_my_epv_contracts__edu_csdms_openmi_vectorset;

static struct edu_csdms_openmi_VectorSet__epv 
  s_my_epv_hooks__edu_csdms_openmi_vectorset;
...
static struct edu_csdms_openmi_IVector__epv s_my_epv__edu_csdms_openmi_ivector;
static struct edu_csdms_openmi_IVector__epv 
  s_my_epv_hooks__edu_csdms_openmi_ivector;

static struct edu_csdms_openmi_IVectorSet__epv 
  s_my_epv__edu_csdms_openmi_ivectorset;
static struct edu_csdms_openmi_IVectorSet__epv 
  s_my_epv_hooks__edu_csdms_openmi_ivectorset;
...
static struct edu_csdms_openmi_VectorSet__pre_epv s_preEPV;
static struct edu_csdms_openmi_VectorSet__post_epv s_postEPV;
...
extern void edu_csdms_openmi_VectorSet__set_epv(
  struct edu_csdms_openmi_VectorSet__epv* epv,
    struct edu_csdms_openmi_VectorSet__pre_epv* pre_epv,
    struct edu_csdms_openmi_VectorSet__post_epv* post_epv);

extern void edu_csdms_openmi_VectorSet__call_load(void);
#ifdef __cplusplus
}
#endif

static void
edu_csdms_openmi_VectorSet_init__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  /* stack space for arguments */
  struct edu_csdms_openmi_IVector__array* values = NULL;
...
static void
edu_csdms_openmi_VectorSet_boccaForceUsePortInclude__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_VectorSet_addRef__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_VectorSet_deleteRef__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_VectorSet_isSame__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_edu_csdms_openmi_VectorSet_fconnect_sidl_BaseInterface(iobj_str, 
    TRUE, _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct edu_csdms_openmi_VectorSet__object*) (
      *iobj_bc->d_epv->f__cast)(iobj_bc, "edu.csdms.openmi.VectorSet", _ex);
    if(iobj != NULL) {
...
static void
edu_csdms_openmi_VectorSet_isType__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_VectorSet_getClassInfo__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_VectorSet_getVector__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  struct edu_csdms_openmi_IVector__object* _retval = NULL;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  ...
  /* make the call */
  _retval = (self->d_epv->f_getVector)(
    self,
    elementIndex,
    _ex);  SIDL_CHECK(*_ex);
...
static void
edu_csdms_openmi_VectorSet_getCount__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_VectorSet_isValid__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
edu_csdms_openmi_VectorSet_getXComponent__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  /* make the call */
  _retval = (self->d_epv->f_getXComponent)(
    self,
    _ex);  SIDL_CHECK(*_ex);
...
static void
edu_csdms_openmi_VectorSet_getYComponent__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  /* make the call */
  _retval = (self->d_epv->f_getYComponent)(
    self,
    _ex);  SIDL_CHECK(*_ex);
...
static void
edu_csdms_openmi_VectorSet_getZComponent__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  /* make the call */
  _retval = (self->d_epv->f_getZComponent)(
    self,
    _ex);  SIDL_CHECK(*_ex);
...
static void
edu_csdms_openmi_VectorSet__cast__exec(
        struct edu_csdms_openmi_VectorSet__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_edu_csdms_openmi_VectorSet__set_contracts(
  struct edu_csdms_openmi_VectorSet__object* self,
  sidl_bool   enable,
...
static void ior_edu_csdms_openmi_VectorSet__dump_stats(
  struct edu_csdms_openmi_VectorSet__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_edu_csdms_openmi_VectorSet__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    edu_csdms_openmi_VectorSet__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_edu_csdms_openmi_VectorSet__cast(
  struct edu_csdms_openmi_VectorSet__object* self,
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  cmp = strcmp(name, "edu.csdms.openmi.VectorSet");
  if (!cmp) {
    (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
    cast = ((struct edu_csdms_openmi_VectorSet__object*)self);
    return cast;
  }
  else if (cmp < 0) {
    cmp = strcmp(name, "edu.csdms.openmi.IVector");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = &((*self).d_edu_csdms_openmi_ivector);
      return cast;
    }
    else if (cmp < 0) {
      ...
      cmp = strcmp(name, "edu.csdms.openmi.IVectorSet");
      if (!cmp) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
        cast = &((*self).d_edu_csdms_openmi_ivectorset);
        return cast;
      }
    }
  }
...
static void ior_edu_csdms_openmi_VectorSet__set_hooks(
  struct edu_csdms_openmi_VectorSet__object* self,
...
static void ior_edu_csdms_openmi_VectorSet__delete(
  struct edu_csdms_openmi_VectorSet__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  edu_csdms_openmi_VectorSet__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct edu_csdms_openmi_VectorSet__object));
  free((void*) self);
}

static char*
ior_edu_csdms_openmi_VectorSet__getURL(
  struct edu_csdms_openmi_VectorSet__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_edu_csdms_openmi_VectorSet__raddRef(
    struct edu_csdms_openmi_VectorSet__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_edu_csdms_openmi_VectorSet__isRemote(
    struct edu_csdms_openmi_VectorSet__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct edu_csdms_openmi_VectorSet__method {
  const char *d_name;
  void (*d_func)(struct edu_csdms_openmi_VectorSet__object*,
...
static void
ior_edu_csdms_openmi_VectorSet__exec(
  struct edu_csdms_openmi_VectorSet__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct edu_csdms_openmi_VectorSet__method  s_methods[] = {
    { "_cast", edu_csdms_openmi_VectorSet__cast__exec },
    { "addRef", edu_csdms_openmi_VectorSet_addRef__exec },
    { "boccaForceUsePortInclude", 
      edu_csdms_openmi_VectorSet_boccaForceUsePortInclude__exec },
    { "deleteRef", edu_csdms_openmi_VectorSet_deleteRef__exec },
    { "getClassInfo", edu_csdms_openmi_VectorSet_getClassInfo__exec },
    { "getCount", edu_csdms_openmi_VectorSet_getCount__exec },
    { "getVector", edu_csdms_openmi_VectorSet_getVector__exec },
    { "getXComponent", edu_csdms_openmi_VectorSet_getXComponent__exec },
    { "getYComponent", edu_csdms_openmi_VectorSet_getYComponent__exec },
    { "getZComponent", edu_csdms_openmi_VectorSet_getZComponent__exec },
    { "init", edu_csdms_openmi_VectorSet_init__exec },
    { "isSame", edu_csdms_openmi_VectorSet_isSame__exec },
    { "isType", edu_csdms_openmi_VectorSet_isType__exec },
    { "isValid", edu_csdms_openmi_VectorSet_isValid__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct edu_csdms_openmi_VectorSet__method);
  *_ex  = NULL; /* default to no exception */
...
static void edu_csdms_openmi_VectorSet__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct edu_csdms_openmi_VectorSet__epv*  epv  = &s_my_epv__edu_csdms_openmi_vectorset;
  struct edu_csdms_openmi_IValueSet__epv*  e0   = &s_my_epv__edu_csdms_openmi_ivalueset;
  struct edu_csdms_openmi_IVector__epv*    e1   = &s_my_epv__edu_csdms_openmi_ivector;
  struct edu_csdms_openmi_IVectorSet__epv* e2   = &s_my_epv__edu_csdms_openmi_ivectorset;
  ...
  epv->f__cast                    = ior_edu_csdms_openmi_VectorSet__cast;
  epv->f__delete                  = ior_edu_csdms_openmi_VectorSet__delete;
  epv->f__exec                    = ior_edu_csdms_openmi_VectorSet__exec;
  epv->f__getURL                  = ior_edu_csdms_openmi_VectorSet__getURL;
  epv->f__raddRef                 = ior_edu_csdms_openmi_VectorSet__raddRef;
  epv->f__isRemote                = ior_edu_csdms_openmi_VectorSet__isRemote;
  epv->f__set_hooks               = ior_edu_csdms_openmi_VectorSet__set_hooks;
  epv->f__set_contracts           = ior_edu_csdms_openmi_VectorSet__set_contracts;
  epv->f__dump_stats              = ior_edu_csdms_openmi_VectorSet__dump_stats;
  epv->f__ctor                    = NULL;
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  epv->f_init                     = NULL;
  epv->f_boccaForceUsePortInclude = NULL;
  epv->f_addRef                   = (void (*)(struct edu_csdms_openmi_VectorSet__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef                = (void (*)(struct edu_csdms_openmi_VectorSet__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct edu_csdms_openmi_VectorSet__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct edu_csdms_openmi_VectorSet__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct edu_csdms_openmi_VectorSet__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getVector                = NULL;
  epv->f_getCount                 = NULL;
  epv->f_isValid                  = NULL;
  epv->f_getXComponent            = NULL;
  epv->f_getYComponent            = NULL;
  epv->f_getZComponent            = NULL;

  edu_csdms_openmi_VectorSet__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  /*
   * Override function pointers for edu.csdms.openmi.IVector with mine, as needed.
   */
  ...
  e1->f_getXComponent         = (double (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getXComponent;
  e1->f_getYComponent         = (double (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getYComponent;
  e1->f_getZComponent         = (double (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getZComponent;
  ...
  /*
   * Override function pointers for edu.csdms.openmi.IVectorSet with mine, as needed.
   */
  ...
  e2->f_getVector             = (struct edu_csdms_openmi_IVector__object* (*)(void*,int32_t,struct sidl_BaseInterface__object **)) epv->f_getVector;
  e2->f_getCount              = (int32_t (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getCount;
  e2->f_isValid               = (sidl_bool (*)(void*,int32_t,struct sidl_BaseInterface__object **)) epv->f_isValid;
  ...
  ior_edu_csdms_openmi_VectorSet__ensure_load_called();
}

/*
 * edu_csdms_openmi_VectorSet__getEPVs: Get my version of all relevant EPVs.
 */

void edu_csdms_openmi_VectorSet__getEPVs (
  ...
  struct edu_csdms_openmi_IVector__epv **s_arg_epv_hooks__edu_csdms_openmi_ivector,
  struct edu_csdms_openmi_IVectorSet__epv **s_arg_epv__edu_csdms_openmi_ivectorset,
  struct edu_csdms_openmi_IVectorSet__epv **s_arg_epv_hooks__edu_csdms_openmi_ivectorset,
  struct edu_csdms_openmi_VectorSet__epv **s_arg_epv__edu_csdms_openmi_vectorset,
  struct edu_csdms_openmi_VectorSet__epv **s_arg_epv_hooks__edu_csdms_openmi_vectorset)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    edu_csdms_openmi_VectorSet__init_epv();
  }
  ...
  *s_arg_epv__edu_csdms_openmi_ivector = &s_my_epv__edu_csdms_openmi_ivector;
  *s_arg_epv_hooks__edu_csdms_openmi_ivector = &s_my_epv_hooks__edu_csdms_openmi_ivector;
  *s_arg_epv__edu_csdms_openmi_ivectorset = &s_my_epv__edu_csdms_openmi_ivectorset;
  *s_arg_epv_hooks__edu_csdms_openmi_ivectorset = &s_my_epv_hooks__edu_csdms_openmi_ivectorset;
  *s_arg_epv__edu_csdms_openmi_vectorset = &s_my_epv__edu_csdms_openmi_vectorset;
  *s_arg_epv_hooks__edu_csdms_openmi_vectorset = &s_my_epv_hooks__edu_csdms_openmi_vectorset;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* edu_csdms_openmi_VectorSet__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "edu.csdms.openmi.VectorSet", _ex);
...
static void
initMetadata(struct edu_csdms_openmi_VectorSet__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * edu_csdms_openmi_VectorSet__createObject: Allocate the object and initialize it.
 */

struct edu_csdms_openmi_VectorSet__object*
edu_csdms_openmi_VectorSet__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct edu_csdms_openmi_VectorSet__object* self =
    (struct edu_csdms_openmi_VectorSet__object*) sidl_malloc(
      sizeof(struct edu_csdms_openmi_VectorSet__object),
      "Object allocation failed for struct edu_csdms_openmi_VectorSet__object",
        __FILE__, __LINE__, "edu_csdms_openmi_VectorSet__createObject", _ex);
  if (!self) goto EXIT;
  edu_csdms_openmi_VectorSet__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void edu_csdms_openmi_VectorSet__init(
  struct edu_csdms_openmi_VectorSet__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_openmi_VectorSet__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_edu_csdms_openmi_ivector.d_epv    = &s_my_epv__edu_csdms_openmi_ivector;
  s0->d_edu_csdms_openmi_ivectorset.d_epv = &s_my_epv__edu_csdms_openmi_ivectorset;
  s0->d_epv                               = &s_my_epv__edu_csdms_openmi_vectorset;

  s0->d_edu_csdms_openmi_ivalueset.d_object = self;

  s0->d_edu_csdms_openmi_ivector.d_object = self;

  s0->d_edu_csdms_openmi_ivectorset.d_object = self;
...
void edu_csdms_openmi_VectorSet__fini(
  struct edu_csdms_openmi_VectorSet__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct edu_csdms_openmi_VectorSet__object* s0 = self;
...
void
edu_csdms_openmi_VectorSet__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct edu_csdms_openmi_VectorSet__external
s_externalEntryPoints = {
  edu_csdms_openmi_VectorSet__createObject,
  edu_csdms_openmi_VectorSet__getSuperEPV,
  2, 
  0
};
