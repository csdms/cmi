/*
 * File:          edu_csdms_openmi_VectorSet_jniSkel.c
 * Symbol:        edu.csdms.openmi.VectorSet-v0.0
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Server-side JNI glue code for edu.csdms.openmi.VectorSet
 * 
 ...
 */
static struct edu_csdms_openmi_VectorSet_jniSkel__data
{
  jclass thisCls;
  jmethodID ctorMID;
  jmethodID dtorMID;
...
init_data(void)
{
  ...
  {
    jclass tempCls = NULL;
    tempCls = (*env)->FindClass(env, "edu/csdms/openmi/VectorSet_Impl");
  ...
  s_data.init_ImplMID = (*env)->GetMethodID(env, s_data.thisCls, "init_Impl", 
    "(Ledu/csdms/openmi/IVector$Array1;)V");
  if ((*env)->ExceptionCheck(env)) {
    (*env)->ExceptionDescribe(env);
    return ;
  }
  ...
  s_data.getVector_ImplMID = (*env)->GetMethodID(env, s_data.thisCls, 
    "getVector_Impl", "(I)Ledu/csdms/openmi/IVector;");
  if ((*env)->ExceptionCheck(env)) {
    (*env)->ExceptionDescribe(env);
    return ;
  }
 ...
 */
static void
jni__ctor(struct edu_csdms_openmi_VectorSet__object *self, struct 
 ...
 */
static void
jni__ctor2(struct edu_csdms_openmi_VectorSet__object *self, void* ddata, struct 
  sidl_BaseInterface__object * *_ex)
{ *_ex = NULL; }
/**
 ...
 */
static void
jni__dtor(struct edu_csdms_openmi_VectorSet__object *self, struct 
  sidl_BaseInterface__object * *_ex)
{
  jfieldID j_ior = NULL;
  JNIEnv* env = sidl_Java_getEnv();
...
void edu_csdms_openmi_VectorSet__call_load(void) { 
...
jni_init(
  ...
  struct edu_csdms_openmi_IVector__array* values,
  ...
  )
{
  ...
  *_ex = NULL;
  ...
  _tmp_values = sidl_Java_I2J_new_array_server(env, values, 
    "edu.csdms.openmi.IVector$Array1");
  ...
  )
{
  ...
  struct edu_csdms_openmi_IVector__object* _retval = (struct 
  ...
  *_ex = NULL;
  ...
  /* Callback to java method */
  _j_retval = (*env)->CallObjectMethod(env, this, s_data.getVector_ImplMID, 
    _tmp_elementIndex);
  JAVA_CHECK(env);
  /* Postprocess inout/out args */
  _retval = (struct edu_csdms_openmi_IVector__object*) sidl_Java_J2I_ifc(env, 
    _j_retval, "edu.csdms.openmi.IVector", TRUE);JAVA_CHECK(env);
...
void
edu_csdms_openmi_VectorSet__set_epv(struct edu_csdms_openmi_VectorSet__epv *epv)
{
