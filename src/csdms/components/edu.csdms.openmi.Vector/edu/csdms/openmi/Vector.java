 ...
 * Description:   Client-side glue code for edu.csdms.openmi.Vector
 * 
  ...
  sidl.BaseInterface
{
  ...
  static {
    gov.llnl.sidl.BaseClass._registerNatives("edu.csdms.openmi.Vector");
  }
   ...
   */
  protected static native long _wrap(Vector ddata);

  /**
   * Remote constructor for the class.
   */
  public Vector(java.lang.String url) {
  ...
  public static gov.llnl.sidl.BaseClass _connect(java.lang.String url) {
    return (gov.llnl.sidl.BaseClass) new Vector(_connect_remote_ior(url));
  }
  ...
  public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
    ...
    long ior = obj._cast_ior("edu.csdms.openmi.Vector");
    if (ior != 0) {
      Class java_class = null;
      try {
        java_class = Class.forName("edu.csdms.openmi.Vector");
      } catch (Exception ex) {
  ...
  public static class Holder {
    private edu.csdms.openmi.Vector d_obj;
     ...
     */
    public Holder(edu.csdms.openmi.Vector obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(edu.csdms.openmi.Vector obj) {
      d_obj = obj;
    }
     ...
     */
    public edu.csdms.openmi.Vector get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public edu.csdms.openmi.Vector _get(int i, int j, int k, int l, int m, int 
      n, int o) {
      edu.csdms.openmi.Vector ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (edu.csdms.openmi.Vector) preCast._cast2(
          "edu.csdms.openmi.Vector");
      } else {
        return null;
      }
      return (edu.csdms.openmi.Vector) ret;
    }
     ...
     */
    public edu.csdms.openmi.Vector.Array _slice(int dimen, int[] numElem, int[] 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new edu.csdms.openmi.Vector.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new edu.csdms.openmi.Vector.Array(
        preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(edu.csdms.openmi.Vector.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        edu.csdms.openmi.Vector.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new edu.csdms.openmi.Vector.Array1(
            getBaseInterfaceArray());
          return ret;
        case 2:
          ret = (Array) new edu.csdms.openmi.Vector.Array2(
            getBaseInterfaceArray());
          return ret;
        case 3:
          ret = (Array) new edu.csdms.openmi.Vector.Array3(
            getBaseInterfaceArray());
          return ret;
        case 4:
          ret = (Array) new edu.csdms.openmi.Vector.Array4(
            getBaseInterfaceArray());
          return ret;
        case 5:
          ret = (Array) new edu.csdms.openmi.Vector.Array5(
            getBaseInterfaceArray());
          return ret;
        case 6:
          ret = (Array) new edu.csdms.openmi.Vector.Array6(
            getBaseInterfaceArray());
          return ret;
        case 7:
          ret = (Array) new edu.csdms.openmi.Vector.Array7(
            getBaseInterfaceArray());
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Vector.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Vector.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Vector.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Vector.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Vector 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(edu.csdms.openmi.Vector[] array, boolean isRow) {
      super();
     ...
     */
    public edu.csdms.openmi.Vector _get( int j0) {
      return (edu.csdms.openmi.Vector)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.Vector get( int j0) {
      checkBounds(  j0);
      edu.csdms.openmi.Vector ret = null;
      ret = (edu.csdms.openmi.Vector) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public edu.csdms.openmi.Vector.Array1 smartCopy() {
      edu.csdms.openmi.Vector.Array1 ret = null;
      edu.csdms.openmi.Vector.Array preCast = null;
      preCast = (edu.csdms.openmi.Vector.Array) _smartCopy();
      return new edu.csdms.openmi.Vector.Array1(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     */
    public void copy(edu.csdms.openmi.Vector.Array1 dest) {
      _copy((edu.csdms.openmi.Vector.Array) dest);
    }
     ...
     */
    public void _set( int j0,edu.csdms.openmi.Vector value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,edu.csdms.openmi.Vector value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( edu.csdms.openmi.Vector[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public edu.csdms.openmi.Vector[] toArray() {
      edu.csdms.openmi.Vector[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new edu.csdms.openmi.Vector[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Vector.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Vector.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Vector.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Vector.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Vector 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(edu.csdms.openmi.Vector[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.Vector _get( int j0, int j1) {
      return (edu.csdms.openmi.Vector)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.Vector get( int j0, int j1) {
      checkBounds(  j0,  j1);
      edu.csdms.openmi.Vector ret = null;
      ret = (edu.csdms.openmi.Vector) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Vector.Array2 smartCopy() {
      edu.csdms.openmi.Vector.Array2 ret = null;
      edu.csdms.openmi.Vector.Array preCast = null;
      preCast = (edu.csdms.openmi.Vector.Array) _smartCopy();
      return new edu.csdms.openmi.Vector.Array2(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Vector.Array2 dest) {
      _copy((edu.csdms.openmi.Vector.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,edu.csdms.openmi.Vector value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,edu.csdms.openmi.Vector value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public edu.csdms.openmi.Vector[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new edu.csdms.openmi.Vector[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new edu.csdms.openmi.Vector[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Vector.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Vector.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Vector.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Vector.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Vector 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(edu.csdms.openmi.Vector[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.Vector _get( int j0, int j1, int j2) {
      return (edu.csdms.openmi.Vector)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.Vector get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      edu.csdms.openmi.Vector ret = null;
      ret = (edu.csdms.openmi.Vector) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Vector.Array3 smartCopy() {
      edu.csdms.openmi.Vector.Array3 ret = null;
      edu.csdms.openmi.Vector.Array preCast = null;
      preCast = (edu.csdms.openmi.Vector.Array) _smartCopy();
      return new edu.csdms.openmi.Vector.Array3(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Vector.Array3 dest) {
      _copy((edu.csdms.openmi.Vector.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,edu.csdms.openmi.Vector value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,edu.csdms.openmi.Vector value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public edu.csdms.openmi.Vector[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new edu.csdms.openmi.Vector[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new edu.csdms.openmi.Vector[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Vector.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Vector.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Vector.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Vector.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Vector 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(edu.csdms.openmi.Vector[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.Vector _get( int j0, int j1, int j2, int j3) {
      return (edu.csdms.openmi.Vector)_get(  j0,  j1,  j2,  j3, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.Vector get( int j0, int j1, int j2, int j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      edu.csdms.openmi.Vector ret = null;
      ret = (edu.csdms.openmi.Vector) _get(  j0,  j1,  j2,  j3, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Vector.Array4 smartCopy() {
      edu.csdms.openmi.Vector.Array4 ret = null;
      edu.csdms.openmi.Vector.Array preCast = null;
      preCast = (edu.csdms.openmi.Vector.Array) _smartCopy();
      return new edu.csdms.openmi.Vector.Array4(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Vector.Array4 dest) {
      _copy((edu.csdms.openmi.Vector.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,edu.csdms.openmi.Vector 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,edu.csdms.openmi.Vector 
      value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( edu.csdms.openmi.Vector[][][][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new edu.csdms.openmi.Vector[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new edu.csdms.openmi.Vector[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Vector.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Vector.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Vector.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Vector.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Vector 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(edu.csdms.openmi.Vector[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.Vector _get( int j0, int j1, int j2, int j3, int 
      j4) {
      return (edu.csdms.openmi.Vector)_get(  j0,  j1,  j2,  j3,  j4, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.Vector get( int j0, int j1, int j2, int j3, int j4) 
      {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      edu.csdms.openmi.Vector ret = null;
      ret = (edu.csdms.openmi.Vector) _get(  j0,  j1,  j2,  j3,  j4, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Vector.Array5 smartCopy() {
      edu.csdms.openmi.Vector.Array5 ret = null;
      edu.csdms.openmi.Vector.Array preCast = null;
      preCast = (edu.csdms.openmi.Vector.Array) _smartCopy();
      return new edu.csdms.openmi.Vector.Array5(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Vector.Array5 dest) {
      _copy((edu.csdms.openmi.Vector.Array) dest);
    }
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new edu.csdms.openmi.Vector[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new edu.csdms.openmi.Vector[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Vector.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Vector.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Vector.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Vector.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Vector 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(edu.csdms.openmi.Vector[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.Vector _get( int j0, int j1, int j2, int j3, int j4,
      int j5) {
      return (edu.csdms.openmi.Vector)_get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
    }
    ...
    public edu.csdms.openmi.Vector get( int j0, int j1, int j2, int j3, int j4, 
      ...
      edu.csdms.openmi.Vector ret = null;
      ret = (edu.csdms.openmi.Vector) _get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Vector.Array6 smartCopy() {
      edu.csdms.openmi.Vector.Array6 ret = null;
      edu.csdms.openmi.Vector.Array preCast = null;
      preCast = (edu.csdms.openmi.Vector.Array) _smartCopy();
      return new edu.csdms.openmi.Vector.Array6(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Vector.Array6 dest) {
      _copy((edu.csdms.openmi.Vector.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new edu.csdms.openmi.Vector[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new edu.csdms.openmi.Vector[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Vector.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Vector.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Vector.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Vector.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Vector 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(edu.csdms.openmi.Vector[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public edu.csdms.openmi.Vector get( int j0, int j1, int j2, int j3, int j4, 
      ...
      edu.csdms.openmi.Vector ret = null;
      ret = (edu.csdms.openmi.Vector) _get(  j0,  j1,  j2,  j3,  j4,  j5,  j6);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Vector.Array7 smartCopy() {
      edu.csdms.openmi.Vector.Array7 ret = null;
      edu.csdms.openmi.Vector.Array preCast = null;
      preCast = (edu.csdms.openmi.Vector.Array) _smartCopy();
      return new edu.csdms.openmi.Vector.Array7(preCast.getBaseInterfaceArray(
        ));
    }
     ...
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Vector.Array7 dest) {
      _copy((edu.csdms.openmi.Vector.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( edu.csdms.openmi.Vector[][][][][][][] orray , 
      boolean inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
                ...
                for (int m = l4; m <= u4; m++) {
                  ...
                  for (int n = l5; n <= u5; n++) {
                    array[i][j][k][l][m][n] = new 
                      edu.csdms.openmi.Vector[u5-l5+1];
                    for (int o = l6; o <= u6; o++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Vector.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Vector.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Vector.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Vector.Array7 get() {
        return d_obj;
      }
