/*
 * File:          edu_csdms_openmi_Vector_jniStub.c
 * Symbol:        edu.csdms.openmi.Vector-v0.0
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Client-side JNI glue code for edu.csdms.openmi.Vector
 * 
...
static struct edu_csdms_openmi_Vector__epv s_rem_epv__edu_csdms_openmi_vector;
...
static void* remote_edu_csdms_openmi_Vector__cast(
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct 
      edu_csdms_openmi_Vector__remote*)self->d_data)->d_ih, _ex);
  }
...
static void remote_edu_csdms_openmi_Vector__delete(
  struct edu_csdms_openmi_Vector__object* self,
...
static char* remote_edu_csdms_openmi_Vector__getURL(
  struct edu_csdms_openmi_Vector__object* self, struct 
    sidl_BaseInterface__object* *_ex)
{
  struct sidl_rmi_InstanceHandle__object *conn = ((struct 
    edu_csdms_openmi_Vector__remote*)self->d_data)->d_ih;
  *_ex = NULL;
  if(conn != NULL) {
...
static void remote_edu_csdms_openmi_Vector__raddRef(
  struct edu_csdms_openmi_Vector__object* self,struct 
    sidl_BaseInterface__object* *_ex)
{
...
static sidl_bool
remote_edu_csdms_openmi_Vector__isRemote(
    struct edu_csdms_openmi_Vector__object* self, 
    struct sidl_BaseInterface__object* *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_edu_csdms_openmi_Vector__set_hooks(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      ...
      "Exception unserialized from edu.csdms.openmi.Vector._set_hooks.",
        &throwaway_exception);
...
static void
remote_edu_csdms_openmi_Vector__set_contracts(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vector._set_contracts.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_openmi_Vector__dump_stats(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vector._dump_stats.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void remote_edu_csdms_openmi_Vector__exec(
  struct edu_csdms_openmi_Vector__object* self,const char* methodName,
...
static void
remote_edu_csdms_openmi_Vector_set(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* in */ double x,
  /* in */ double y,
  /* in */ double z,
  ...
  *_ex = NULL;
  {
    ...
    /* pack in and inout arguments */
    sidl_rmi_Invocation_packDouble( _inv, "x", x, _ex);SIDL_CHECK(*_ex);
    sidl_rmi_Invocation_packDouble( _inv, "y", y, _ex);SIDL_CHECK(*_ex);
    sidl_rmi_Invocation_packDouble( _inv, "z", z, _ex);SIDL_CHECK(*_ex);
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vector.set.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_openmi_Vector_boccaForceUsePortInclude(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vector.boccaForceUsePortInclude.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_edu_csdms_openmi_Vector_addRef(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    struct edu_csdms_openmi_Vector__remote* r_obj = (struct 
      edu_csdms_openmi_Vector__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: addRef %p new count %d (type %s)\n",
      r_obj, r_obj->d_refcount, 
      "edu.csdms.openmi.Vector Remote Stub");
...
static void
remote_edu_csdms_openmi_Vector_deleteRef(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    r_obj->d_refcount--;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: deleteRef %p new count %d (type %s)\n",r_obj, r_obj->d_refcount, "edu.csdms.openmi.Vector Remote Stub");
#endif /* SIDL_DEBUG_REFCOUNT */ 
...
static sidl_bool
remote_edu_csdms_openmi_Vector_isSame(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vector.isSame.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static sidl_bool
remote_edu_csdms_openmi_Vector_isType(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* in */ const char* name,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vector.isType.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
remote_edu_csdms_openmi_Vector_getClassInfo(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vector.getClassInfo.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static double
remote_edu_csdms_openmi_Vector_getXComponent(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vector.getXComponent.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static double
remote_edu_csdms_openmi_Vector_getYComponent(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vector.getYComponent.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static double
remote_edu_csdms_openmi_Vector_getZComponent(
  /* in */ struct edu_csdms_openmi_Vector__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from edu.csdms.openmi.Vector.getZComponent.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void edu_csdms_openmi_Vector__init_remote_epv(void)
{
  /* assert( HAVE_LOCKED_STATIC_GLOBALS ); */
  struct edu_csdms_openmi_Vector__epv*  epv = 
    &s_rem_epv__edu_csdms_openmi_vector;
  struct edu_csdms_openmi_IVector__epv* e0  = 
  ...
  epv->f__cast                         = remote_edu_csdms_openmi_Vector__cast;
  epv->f__delete                       = remote_edu_csdms_openmi_Vector__delete;
  epv->f__exec                         = remote_edu_csdms_openmi_Vector__exec;
  epv->f__getURL                       = remote_edu_csdms_openmi_Vector__getURL;
  epv->f__raddRef                      = 
    remote_edu_csdms_openmi_Vector__raddRef;
  epv->f__isRemote                     = 
    remote_edu_csdms_openmi_Vector__isRemote;
  epv->f__set_hooks                    = 
    remote_edu_csdms_openmi_Vector__set_hooks;
  ...
  epv->f__ctor2                        = NULL;
  epv->f__dtor                         = NULL;
  epv->f_set                           = remote_edu_csdms_openmi_Vector_set;
  epv->f_boccaForceUsePortInclude      = 
    remote_edu_csdms_openmi_Vector_boccaForceUsePortInclude;
  epv->f_addRef                        = remote_edu_csdms_openmi_Vector_addRef;
  epv->f_deleteRef                     = 
    remote_edu_csdms_openmi_Vector_deleteRef;
  epv->f_isSame                        = remote_edu_csdms_openmi_Vector_isSame;
  epv->f_isType                        = remote_edu_csdms_openmi_Vector_isType;
  epv->f_getClassInfo                  = 
    remote_edu_csdms_openmi_Vector_getClassInfo;
  epv->f_getXComponent                 = 
    remote_edu_csdms_openmi_Vector_getXComponent;
  ...
  e0->f_getXComponent  = (double (*)(void*,struct sidl_BaseInterface__object 
    **)) epv->f_getXComponent;
  e0->f_getYComponent  = (double (*)(void*,struct sidl_BaseInterface__object 
    **)) epv->f_getYComponent;
  e0->f_getZComponent  = (double (*)(void*,struct sidl_BaseInterface__object 
    **)) epv->f_getZComponent;
...
static struct edu_csdms_openmi_Vector__object*
edu_csdms_openmi_Vector__remoteConnect(const char *url, sidl_bool ar, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct edu_csdms_openmi_Vector__object* self = NULL;

  struct edu_csdms_openmi_Vector__object* s0;
  struct sidl_BaseClass__object* s1;

  struct edu_csdms_openmi_Vector__remote* r_obj = NULL;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    struct edu_csdms_openmi_Vector__object* retobj = NULL;
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_BaseInterface bi = (
      sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(objectID,
      _ex); SIDL_CHECK(*_ex);
    (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    retobj = (struct edu_csdms_openmi_Vector__object*) (*bi->d_epv->f__cast)(
      bi->d_object, "edu.csdms.openmi.Vector", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, 
    "edu.csdms.openmi.Vector", ar, _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct edu_csdms_openmi_Vector__object*) malloc(
      sizeof(struct edu_csdms_openmi_Vector__object));

  r_obj =
    (struct edu_csdms_openmi_Vector__remote*) malloc(
      sizeof(struct edu_csdms_openmi_Vector__remote));
  ...
  if(!self || !r_obj) {
    ...
    sidl_MemAllocException_add(ex, __FILE__, __LINE__, 
      "edu.csdms.openmi.Vector.EPVgeneration", _ex);
    SIDL_CHECK(*_ex);
  ...
  if (!s_remote_initialized) {
    edu_csdms_openmi_Vector__init_remote_epv();
  }
  UNLOCK_STATIC_GLOBALS;
  ...
  s0->d_epv  = &s_rem_epv__edu_csdms_openmi_vector;
...
static struct edu_csdms_openmi_Vector__object*
edu_csdms_openmi_Vector__IHConnect(sidl_rmi_InstanceHandle instance, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct edu_csdms_openmi_Vector__object* self = NULL;
...
static struct edu_csdms_openmi_Vector__object*
edu_csdms_openmi_Vector__remoteCreate(const char *url, struct 
  sidl_BaseInterface__object **_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "edu.csdms.openmi.Vector", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct edu_csdms_openmi_Vector__object*) malloc(
      sizeof(struct edu_csdms_openmi_Vector__object));
...
edu_csdms_openmi_Vector__connectI(const char* url, sidl_bool ar, struct 
  sidl_BaseInterface__object **_ex)
{
  return edu_csdms_openmi_Vector__remoteConnect(url, ar, _ex);
}
...
static struct edu_csdms_openmi_Vector__object* _get_ior(
  JNIEnv* env,
  jobject obj)
{
  void* ptr = NULL;
  ...
  return (struct edu_csdms_openmi_Vector__object*) ptr;
}
...
static const struct edu_csdms_openmi_Vector__external* s_external = NULL;
  ...
  jstring url)
{
  ...
  _res = POINTER_TO_JLONG(edu_csdms_openmi_Vector__remoteCreate(_tmp_url, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jobject obj)
{
  ...
  struct edu_csdms_openmi_Vector__object *_ptr = (*s_external->createObject)(
    g_data, &_ex);
  (void) env;
  (void) cls;
  if(_ex) {
  ...
  jstring url)
{
  ...
  struct sidl_BaseInterface__object *_ex = NULL;
  char* _tmp_url = sidl_Java_J2I_string(env, url);
  _res = POINTER_TO_JLONG(edu_csdms_openmi_Vector__remoteConnect(_tmp_url, 1, 
    &_ex));
  if(_ex) {
    sidl_Java_CheckException(
      env,
  ...
  jdouble _arg_z)
{
  ...
  struct edu_csdms_openmi_Vector__object* _ior = NULL;
  double _tmp_x = 0.0;
  double _tmp_y = 0.0;
  double _tmp_z = 0.0;
  struct sidl_BaseInterface__object *_ex = NULL;
  ...
  _tmp_x = (double) _arg_x;
  _tmp_y = (double) _arg_y;
  _tmp_z = (double) _arg_z;
...
void edu_csdms_openmi_Vector__register(JNIEnv* env)
{
  JNINativeMethod methods[11];
  jclass cls;

#ifdef SIDL_STATIC_LIBRARY
  s_external = edu_csdms_openmi_Vector__externals();
#else
  s_external = (struct edu_csdms_openmi_Vector__external*)sidl_dynamicLoadIOR(
    "edu.csdms.openmi.Vector","edu_csdms_openmi_Vector__externals") ;
  sidl_checkIORVersion("edu.csdms.openmi.Vector", 
  ...
  methods[2].signature = "(Ledu/csdms/openmi/Vector;)J";
  ...
  methods[6].name      = "set";
  methods[6].signature = "(DDD)V";
  methods[6].fnPtr     = (void *)jni_set;
  methods[7].name      = "boccaForceUsePortInclude";
  methods[7].signature = "()V";
  methods[7].fnPtr     = (void *)jni_boccaForceUsePortInclude;
  methods[8].name      = "getXComponent";
  methods[8].signature = "()D";
  methods[8].fnPtr     = (void *)jni_getXComponent;
  methods[9].name      = "getYComponent";
  methods[9].signature = "()D";
  methods[9].fnPtr     = (void *)jni_getYComponent;
  methods[10].name      = "getZComponent";
  methods[10].signature = "()D";
  methods[10].fnPtr     = (void *)jni_getZComponent;


  cls = (*env)->FindClass(env, "edu/csdms/openmi/Vector");
  if (cls) {
