 ...
 * Description:   Client-side glue code for edu.csdms.openmi.Time
 * 
  ...
  sidl.BaseInterface
{
  ...
  static {
    gov.llnl.sidl.BaseClass._registerNatives("edu.csdms.openmi.Time");
  }
   ...
   */
  protected static native long _wrap(Time ddata);

  /**
   * Remote constructor for the class.
   */
  public Time(java.lang.String url) {
  ...
  public static gov.llnl.sidl.BaseClass _connect(java.lang.String url) {
    return (gov.llnl.sidl.BaseClass) new Time(_connect_remote_ior(url));
  }
  ...
  public static sidl.BaseInterface _cast(gov.llnl.sidl.BaseClass obj) {
    ...
    long ior = obj._cast_ior("edu.csdms.openmi.Time");
    if (ior != 0) {
      Class java_class = null;
      try {
        java_class = Class.forName("edu.csdms.openmi.Time");
      } catch (Exception ex) {
  ...
  public static class Holder {
    private edu.csdms.openmi.Time d_obj;
     ...
     */
    public Holder(edu.csdms.openmi.Time obj) {
      d_obj = obj;
    }
     ...
     */
    public void set(edu.csdms.openmi.Time obj) {
      d_obj = obj;
    }
     ...
     */
    public edu.csdms.openmi.Time get() {
      return d_obj;
    }
  }
  /**
  ...
  private sidl.BaseInterface.Array a;
     ...
     */
    public edu.csdms.openmi.Time _get(int i, int j, int k, int l, int m, int n, 
      int o) {
      edu.csdms.openmi.Time ret = null;
      sidl.BaseInterface.Wrapper preCast = null;
      preCast = a._get(i,j,k,l,m,n,o);
      if(preCast != null) {
        ret = (edu.csdms.openmi.Time) preCast._cast2("edu.csdms.openmi.Time");
      } else {
        return null;
      }
      return (edu.csdms.openmi.Time) ret;
    }
     ...
     */
    public edu.csdms.openmi.Time.Array _slice(int dimen, int[] numElem, int[] 
      ...
      preCast = (sidl.BaseInterface.Array) a._slice(dimen,numElem,srcStart,
        srcStride,newStart);
      return new edu.csdms.openmi.Time.Array(preCast);
    }
    ...
    public gov.llnl.sidl.BaseArray _smartCopy() {
      ...
      return (gov.llnl.sidl.BaseArray) new edu.csdms.openmi.Time.Array(preCast);
    }
     ...
     * Copies borrowed arrays, addRefs otherwise.
     */
    public void _copy(edu.csdms.openmi.Time.Array dest) {
    ...
    public Array _dcast() {
      try{ 
        int dimen = _dim();
        edu.csdms.openmi.Time.Array ret = null;
        switch (dimen) {
        case 1:
          ret = (Array) new edu.csdms.openmi.Time.Array1(getBaseInterfaceArray(
            ));
          return ret;
        case 2:
          ret = (Array) new edu.csdms.openmi.Time.Array2(getBaseInterfaceArray(
            ));
          return ret;
        case 3:
          ret = (Array) new edu.csdms.openmi.Time.Array3(getBaseInterfaceArray(
            ));
          return ret;
        case 4:
          ret = (Array) new edu.csdms.openmi.Time.Array4(getBaseInterfaceArray(
            ));
          return ret;
        case 5:
          ret = (Array) new edu.csdms.openmi.Time.Array5(getBaseInterfaceArray(
            ));
          return ret;
        case 6:
          ret = (Array) new edu.csdms.openmi.Time.Array6(getBaseInterfaceArray(
            ));
          return ret;
        case 7:
          ret = (Array) new edu.csdms.openmi.Time.Array7(getBaseInterfaceArray(
            ));
          return ret;
        default:
          return null;
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Time.Array d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Time.Array obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Time.Array obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Time.Array get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Time 1 arrays.
   */
  public static class Array1 extends Array {
     ...
     * bounds are invalid.
     */
    public Array1(edu.csdms.openmi.Time[] array, boolean isRow) {
      super();
     ...
     */
    public edu.csdms.openmi.Time _get( int j0) {
      return (edu.csdms.openmi.Time)_get(  j0, 0, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.Time get( int j0) {
      checkBounds(  j0);
      edu.csdms.openmi.Time ret = null;
      ret = (edu.csdms.openmi.Time) _get(  j0, 0, 0, 0, 0, 0, 0);
      return ret;
     ...
     */
    public edu.csdms.openmi.Time.Array1 smartCopy() {
      edu.csdms.openmi.Time.Array1 ret = null;
      edu.csdms.openmi.Time.Array preCast = null;
      preCast = (edu.csdms.openmi.Time.Array) _smartCopy();
      return new edu.csdms.openmi.Time.Array1(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Time.Array1 dest) {
      _copy((edu.csdms.openmi.Time.Array) dest);
    }
     ...
     */
    public void _set( int j0,edu.csdms.openmi.Time value) {
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0,edu.csdms.openmi.Time value) {
      checkBounds(  j0);
      _set(  j0, 0, 0, 0, 0, 0, 0, value);
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( edu.csdms.openmi.Time[] orray , boolean inRow) {
      int[] lower = new int[7];
     ...
     * 
     */
    public edu.csdms.openmi.Time[] toArray() {
      edu.csdms.openmi.Time[] array = null;
      if (!isNull()) {
        checkDimension(1);
        int l0 = _lower(0);
        int u0 = _upper(0);
        array = new edu.csdms.openmi.Time[u0-l0+1];
        for (int i = l0; i <= u0; i++) {
          array[i-l0] = _get(i);
          }
        }
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Time.Array1 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Time.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Time.Array1 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Time.Array1 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Time 2 arrays.
   */
  public static class Array2 extends Array {
     ...
     * bounds are invalid.
     */
    public Array2(edu.csdms.openmi.Time[][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.Time _get( int j0, int j1) {
      return (edu.csdms.openmi.Time)_get(  j0,  j1, 0, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.Time get( int j0, int j1) {
      checkBounds(  j0,  j1);
      edu.csdms.openmi.Time ret = null;
      ret = (edu.csdms.openmi.Time) _get(  j0,  j1, 0, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Time.Array2 smartCopy() {
      edu.csdms.openmi.Time.Array2 ret = null;
      edu.csdms.openmi.Time.Array preCast = null;
      preCast = (edu.csdms.openmi.Time.Array) _smartCopy();
      return new edu.csdms.openmi.Time.Array2(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Time.Array2 dest) {
      _copy((edu.csdms.openmi.Time.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1,edu.csdms.openmi.Time value) {
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1,edu.csdms.openmi.Time value) {
      checkBounds(  j0,  j1);
      _set(  j0,  j1, 0, 0, 0, 0, 0, value);
    ...
    public edu.csdms.openmi.Time[][] toArray() {
      ...
      if (!isNull()) {
        ...
        array = new edu.csdms.openmi.Time[u0-l0+1][];
        for (int i = l0; i <= u0; i++) {
          array[i] = new edu.csdms.openmi.Time[u1-l1+1];
          for (int j = l1; j <= u1; j++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Time.Array2 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Time.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Time.Array2 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Time.Array2 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Time 3 arrays.
   */
  public static class Array3 extends Array {
     ...
     * bounds are invalid.
     */
    public Array3(edu.csdms.openmi.Time[][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.Time _get( int j0, int j1, int j2) {
      return (edu.csdms.openmi.Time)_get(  j0,  j1,  j2, 0, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.Time get( int j0, int j1, int j2) {
      checkBounds(  j0,  j1,  j2);
      edu.csdms.openmi.Time ret = null;
      ret = (edu.csdms.openmi.Time) _get(  j0,  j1,  j2, 0, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Time.Array3 smartCopy() {
      edu.csdms.openmi.Time.Array3 ret = null;
      edu.csdms.openmi.Time.Array preCast = null;
      preCast = (edu.csdms.openmi.Time.Array) _smartCopy();
      return new edu.csdms.openmi.Time.Array3(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Time.Array3 dest) {
      _copy((edu.csdms.openmi.Time.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2,edu.csdms.openmi.Time value) {
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    }
    /**
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2,edu.csdms.openmi.Time value) {
      checkBounds(  j0,  j1,  j2);
      _set(  j0,  j1,  j2, 0, 0, 0, 0, value);
    ...
    public edu.csdms.openmi.Time[][][] toArray() {
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          array[i] = new edu.csdms.openmi.Time[u1-l1+1][];
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new edu.csdms.openmi.Time[u2-l2+1];
            for (int k = l2; k <= u2; k++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Time.Array3 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Time.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Time.Array3 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Time.Array3 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Time 4 arrays.
   */
  public static class Array4 extends Array {
     ...
     * bounds are invalid.
     */
    public Array4(edu.csdms.openmi.Time[][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.Time _get( int j0, int j1, int j2, int j3) {
      return (edu.csdms.openmi.Time)_get(  j0,  j1,  j2,  j3, 0, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.Time get( int j0, int j1, int j2, int j3) {
      checkBounds(  j0,  j1,  j2,  j3);
      edu.csdms.openmi.Time ret = null;
      ret = (edu.csdms.openmi.Time) _get(  j0,  j1,  j2,  j3, 0, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Time.Array4 smartCopy() {
      edu.csdms.openmi.Time.Array4 ret = null;
      edu.csdms.openmi.Time.Array preCast = null;
      preCast = (edu.csdms.openmi.Time.Array) _smartCopy();
      return new edu.csdms.openmi.Time.Array4(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Time.Array4 dest) {
      _copy((edu.csdms.openmi.Time.Array) dest);
    }
     ...
     * Set the element at the specified array w/o bounds checking
     */
    public void _set( int j0, int j1, int j2, int j3,edu.csdms.openmi.Time 
      value) {
     ...
     * Set the element at the specified array with bounds checking
     */
    public void set( int j0, int j1, int j2, int j3,edu.csdms.openmi.Time 
      value) {
      checkBounds(  j0,  j1,  j2,  j3);
      _set(  j0,  j1,  j2,  j3, 0, 0, 0, value);
      ...
      if (!isNull()) {
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            array[i][j] = new edu.csdms.openmi.Time[u2-l2+1][];
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new edu.csdms.openmi.Time[u3-l3+1];
              for (int l = l3; l <= u3; l++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Time.Array4 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Time.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Time.Array4 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Time.Array4 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Time 5 arrays.
   */
  public static class Array5 extends Array {
     ...
     * bounds are invalid.
     */
    public Array5(edu.csdms.openmi.Time[][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
     ...
     * Get the element at the specified array w/o bounds checking (Is not written for 7 dimensions, as this functionality is inherited from Array
     */
    public edu.csdms.openmi.Time _get( int j0, int j1, int j2, int j3, int j4) {
      return (edu.csdms.openmi.Time)_get(  j0,  j1,  j2,  j3,  j4, 0, 0);
    }

    /**
     * Get the element at the specified array with bounds checking
     */
    public edu.csdms.openmi.Time get( int j0, int j1, int j2, int j3, int j4) {
      checkBounds(  j0,  j1,  j2,  j3,  j4);
      edu.csdms.openmi.Time ret = null;
      ret = (edu.csdms.openmi.Time) _get(  j0,  j1,  j2,  j3,  j4, 0, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Time.Array5 smartCopy() {
      edu.csdms.openmi.Time.Array5 ret = null;
      edu.csdms.openmi.Time.Array preCast = null;
      preCast = (edu.csdms.openmi.Time.Array) _smartCopy();
      return new edu.csdms.openmi.Time.Array5(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Time.Array5 dest) {
      _copy((edu.csdms.openmi.Time.Array) dest);
    }
     ...
     * Set the element at the specified array with bounds checking
     */
    public void fromArray( edu.csdms.openmi.Time[][][][][] orray , boolean 
      inRow) {
      int[] lower = new int[7];
      lower[0] = orray.length-1;
      lower[1] = orray.length-1;
        ...
        for (int i = l0; i <= u0; i++) {
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              array[i][j][k] = new edu.csdms.openmi.Time[u3-l3+1][];
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new edu.csdms.openmi.Time[u4-l4+1];
                for (int m = l4; m <= u4; m++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Time.Array5 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Time.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Time.Array5 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Time.Array5 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Time 6 arrays.
   */
  public static class Array6 extends Array {
     ...
     * bounds are invalid.
     */
    public Array6(edu.csdms.openmi.Time[][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public edu.csdms.openmi.Time _get( int j0, int j1, int j2, int j3, int j4, 
      int j5) {
      return (edu.csdms.openmi.Time)_get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
    }
    ...
    public edu.csdms.openmi.Time get( int j0, int j1, int j2, int j3, int j4, 
      ...
      edu.csdms.openmi.Time ret = null;
      ret = (edu.csdms.openmi.Time) _get(  j0,  j1,  j2,  j3,  j4,  j5, 0);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Time.Array6 smartCopy() {
      edu.csdms.openmi.Time.Array6 ret = null;
      edu.csdms.openmi.Time.Array preCast = null;
      preCast = (edu.csdms.openmi.Time.Array) _smartCopy();
      return new edu.csdms.openmi.Time.Array6(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Time.Array6 dest) {
      _copy((edu.csdms.openmi.Time.Array) dest);
    }
          ...
          for (int j = l1; j <= u1; j++) {
            ...
            for (int k = l2; k <= u2; k++) {
              ...
              for (int l = l3; l <= u3; l++) {
                array[i][j][k][l] = new edu.csdms.openmi.Time[u4-l4+1][];
                for (int m = l4; m <= u4; m++) {
                  array[i][j][k][l][m] = new edu.csdms.openmi.Time[u4-l4+1];
                  for (int n = l5; n <= u5; n++) {
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Time.Array6 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Time.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Time.Array6 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Time.Array6 get() {
        return d_obj;
      }
  ...
  /**
   * The implementation of edu.csdms.openmi.Time 7 arrays.
   */
  public static class Array7 extends Array {
     ...
     * bounds are invalid.
     */
    public Array7(edu.csdms.openmi.Time[][][][][][][] array, boolean isRow) {
      super();
      fromArray(array, isRow);
    }
    ...
    public edu.csdms.openmi.Time get( int j0, int j1, int j2, int j3, int j4, 
      ...
      edu.csdms.openmi.Time ret = null;
      ret = (edu.csdms.openmi.Time) _get(  j0,  j1,  j2,  j3,  j4,  j5,  j6);
      return ret;
     ...
     * Make a copy of a borrowed array, addref otherwise
     */
    public edu.csdms.openmi.Time.Array7 smartCopy() {
      edu.csdms.openmi.Time.Array7 ret = null;
      edu.csdms.openmi.Time.Array preCast = null;
      preCast = (edu.csdms.openmi.Time.Array) _smartCopy();
      return new edu.csdms.openmi.Time.Array7(preCast.getBaseInterfaceArray());
    }

    /**
     * Copy elements of this array into a passed in array of exactly the smae size
     */
    public void copy(edu.csdms.openmi.Time.Array7 dest) {
      _copy((edu.csdms.openmi.Time.Array) dest);
    }
     ...
     */
    public static class Holder {
      private edu.csdms.openmi.Time.Array7 d_obj;
       ...
       * Create a holder with the specified object.
       */
      public Holder(edu.csdms.openmi.Time.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Set the value of the holdee object.
       */
      public void set(edu.csdms.openmi.Time.Array7 obj) {
        d_obj = obj;
      }
       ...
       * Get the value of the holdee object.
       */
      public edu.csdms.openmi.Time.Array7 get() {
        return d_obj;
      }
