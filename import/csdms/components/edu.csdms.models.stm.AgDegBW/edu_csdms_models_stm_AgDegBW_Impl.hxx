// 
// File:          edu_csdms_models_stm_AgDegBW_Impl.hxx
...
#ifndef included_edu_csdms_models_stm_AgDegBW_Impl_hxx
#define included_edu_csdms_models_stm_AgDegBW_Impl_hxx

#ifndef included_sidl_cxx_hxx
#include "sidl_cxx.hxx"
#endif
#ifndef included_edu_csdms_models_stm_AgDegBW_IOR_h
#include "edu_csdms_models_stm_AgDegBW_IOR.h"
#endif
#ifndef included_edu_csdms_models_stm_AgDegBW_hxx
#include "edu_csdms_models_stm_AgDegBW.hxx"
#endif
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegBW._hincludes)
// Insert-Code-Here {edu.csdms.models.stm.AgDegBW._hincludes} (includes or arbitrary code)
#include "Initialize.h"
#include "Run.h"
#include "Finalize.h"
#include "SaveDatatoMatrix.h"
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegBW._hincludes)
  ...
  namespace csdms { 
    namespace models { 
      namespace stm { 
        ...
        /**
         * Symbol "edu.csdms.models.stm.AgDegBW" (version 0.0)
         */
        class AgDegBW_impl : public virtual ::edu::csdms::models::stm::AgDegBW 
        // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegBW._inherits)
        // Insert-Code-Here {edu.csdms.models.stm.AgDegBW._inherits} (optional inheritance here)
        // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegBW._inherits)
        ...
        protected:
          ...
          // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegBW._implementation)

  // Insert-UserCode-Here(edu.csdms.models.stm.AgDegBW._implementation)
gov::cca::TypeMap userinput;
    float Qf, If, B, D, lamdap, kc, S, Gtf, dt, alphau, alphar;
    float alphat, nt, tauc, phis, R, Cf, ksio, dx, qw, L, qtg;
    float Ha, taustar, qstar, qt, Gt, qtf, tauult, Sult, Hult, time;
    double Frni, Frnu, Hc, ksimin, ksiinit;
    int iterate, prints, M, formulation, j, k, check;
    double eta[101], x[101], ksi[101], H[101];
        double *qb, *tau, *Sl;
        double (*printmatrix)[101], (*Slmatrix)[101], (*Hmatrix)[101];
        double (*taumatrix)[101], (*qbmatrix)[101], (*ksimatrix)[101];

  // Bocca generated code. bocca.protected.begin(edu.csdms.models.stm.AgDegBW._implementation)
  
   gov::cca::Services    d_services; // our cca handle.
 

  // Bocca generated code. bocca.protected.end(edu.csdms.models.stm.AgDegBW._implementation)

          // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegBW._implementation)
        ...
        public:
          ...
          // (fixes bug #275)
            AgDegBW_impl( struct edu_csdms_models_stm_AgDegBW__object * ior ) : 
              StubBase(ior,true), 
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegBW._hmisc)
// Insert-Code-Here {edu.csdms.models.stm.AgDegBW._hmisc} (miscellaneous things)
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegBW._hmisc)
