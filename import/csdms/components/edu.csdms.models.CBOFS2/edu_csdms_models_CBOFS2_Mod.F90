! 
! File:          edu_csdms_models_CBOFS2_Mod.F90
! Symbol:        edu.csdms.models.CBOFS2-v0.0
! Symbol Type:   class
! Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
! Description:   Server-side private data module for edu.csdms.models.CBOFS2
! 
...
module edu_csdms_models_CBOFS2_impl

  ! DO-NOT-DELETE splicer.begin(edu.csdms.models.CBOFS2.use)
...
! Bocca generated code. bocca.protected.end(edu.csdms.models.ROMS.use)
  ...
  ! DO-NOT-DELETE splicer.end(edu.csdms.models.CBOFS2.use)
  ...
  type edu_csdms_models_CBOFS2_priv
    sequence
    ! DO-NOT-DELETE splicer.begin(edu.csdms.models.CBOFS2.private_data)
...
! Bocca generated code. bocca.protected.end(edu.csdms.models.ROMS.private_data)
    ...
    ! DO-NOT-DELETE splicer.end(edu.csdms.models.CBOFS2.private_data)
  end type edu_csdms_models_CBOFS2_priv

  type edu_csdms_models_CBOFS2_wrap
    sequence
    type(edu_csdms_models_CBOFS2_priv), pointer :: d_private_data
  end type edu_csdms_models_CBOFS2_wrap
  ...
  recursive subroutine wrapObj_s(private_data, retval, exception)
    ...
    implicit none
    ! out edu_csdms_models_CBOFS2 retval
    type(edu_csdms_models_CBOFS2_t) , intent(out) :: retval
    ! out sidl_BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception
    ! in edu_csdms_models_CBOFS2_wrap private_data
    type(edu_csdms_models_CBOFS2_wrap), intent(in) :: private_data
    external edu_csdms_models_CBOFS2_wrapObj_m
    call edu_csdms_models_CBOFS2_wrapObj_m(private_data, retval, exception)
   end subroutine wrapObj_s
end module edu_csdms_models_CBOFS2_impl
