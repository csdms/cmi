#
# File:          BaseLevel_Impl.py
# Symbol:        edu.csdms.models.BaseLevel-v0.0
# Symbol Type:   class
# Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
# Description:   Implementation of sidl class edu.csdms.models.BaseLevel in Python.
# 
...
from cmt.components import BaseLevel as bmi_component
import cmt.status
import numpy as np
...
import edu.csdms.models.BaseLevel
...
# that means this Impl class is being constructed for native delegation
  def __init__(self, IORself = None):
    if (IORself == None):
      self.__IORself = edu.csdms.models.BaseLevel.BaseLevel(impl = self)
    else:
      self.__IORself = IORself
# DO-NOT-DELETE splicer.begin(__init__)

    # Put your code here...
    print '%s: Creating logger' % 'BaseLevel'
    try:
        self.name = 'BaseLevel'
        self.log = edu.csdms.tools.Verbose.Verbose ()
        self.log.initialize (self.name, 2)
    except Exception as e:
        print '%s: Error creating logger' % 'BaseLevel'
    else:
        print '%s: Created logger' % 'BaseLevel'
    ...
    try:
        ...
        self.log.info ('Created component')

    # Bocca generated code. bocca.protected.begin(edu.csdms.models.BaseLevel._init)
    self.d_services = None 
    self.bocca_print_errs = True
    # Bocca generated code. bocca.protected.end(edu.csdms.models.BaseLevel._init) 
...
# Bocca generated code. bocca.protected.begin(boccaSetServices) 
    ...
    if not port:
      ...
      ex.setNote(__name__,0, 'Error casting self edu.csdms.models.BaseLevel to to gov.cca.Port')
    ...
    # Provide a edu.csdms.ports.CMIPort port with port name BaseLevel 
    try:
      self.d_services.addProvidesPort(port,    # the implementing object
                              'BaseLevel',       # the name the user will see
                              'edu.csdms.ports.CMIPort',          # the sidl name of the port type.
                              mymap);         # extra properties.
    except sidl.BaseException._Exception, e:
      (etype, eobj, etb) = sys.exc_info()
      eobj.add(__name__, 0, 'Error - could not addProvidesPort(port, '           + '"BaseLevel","edu.csdms.ports.CMIPort",mymap)')
      raise sidl.BaseException._Exception, e
    ...
    try:
      ...
      eobj.exception.add(__name__,0, 
             'Error - could not registerForRelease(self) in edu.csdms.models.BaseLevel')
      raise sidl.BaseException._Exception, e
...
# DO-NOT-DELETE splicer.begin(boccaReleaseServices)
    # DO-NOT-EDIT-BOCCA
    # Bocca generated code. bocca.protected.begin(edu.csdms.models.BaseLevel.boccaReleaseServices)
    self.d_services = None
    ...
    # UN-Provide a edu.csdms.ports.CMIPort port with port name BaseLevel 
    try:
      services.removeProvidesPort('BaseLevel')
    except sidl.BaseException._Exception, e:
      (etype, eobj, etb) = sys.exc_info()
      eobj.exception.add(__name__,0, 'Error - could not remove provided port '           + 'edu.csdms.ports.CMIPort:BaseLevel')
      raise sidl.BaseException._Exception, e
    ...
    return
    # Bocca generated code. bocca.protected.end(edu.csdms.models.BaseLevel.boccaReleaseServices)
...
# DO-NOT-DELETE splicer.begin(CMI_has_output_item)
    return long_var_name in self.get_output_var_names ()
...
# DO-NOT-DELETE splicer.begin(CMI_has_input_item)
    return long_var_name in self.get_input_var_names ()
...
# DO-NOT-DELETE splicer.begin(CMI_get_grid_lower_left)
    return self.bmi.get_grid_origin ()
...
# DO-NOT-DELETE splicer.begin(get_grid_z)
    ...
    # DO-DELETE-WHEN-IMPLEMENTING exception.begin(get_grid_z)
    noImpl = sidl.NotImplementedException.NotImplementedException()
    noImpl.setNote("This method has not been implemented.")
    raise  sidl.NotImplementedException._Exception, noImpl
    # DO-DELETE-WHEN-IMPLEMENTING exception.end(get_grid_z)
...
# DO-NOT-DELETE splicer.begin(get_grid_connectivity)
    return self.bmi.get_grid_connectivity ()
...
# DO-NOT-DELETE splicer.begin(get_grid_offset)
    return self.bmi.get_grid_offset ()
