// 
// File:          edu_csdms_models_stm_AgDegNormGravMixSubPW_Impl.hxx
...
#ifndef included_edu_csdms_models_stm_AgDegNormGravMixSubPW_Impl_hxx
#define included_edu_csdms_models_stm_AgDegNormGravMixSubPW_Impl_hxx

#ifndef included_sidl_cxx_hxx
#include "sidl_cxx.hxx"
#endif
#ifndef included_edu_csdms_models_stm_AgDegNormGravMixSubPW_IOR_h
#include "edu_csdms_models_stm_AgDegNormGravMixSubPW_IOR.h"
#endif
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormGravMixSubPW._hincludes)
// Insert-Code-Here {edu.csdms.models.stm.AgDegNormGravMixSubPW._hincludes} (includes or arbitrary code)
#include "Initialize.h"
#include "Run.h"
#include "Finalize.h"
#include "SaveDatatoMatrix.h"
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormGravMixSubPW._hincludes)
  ...
  namespace csdms { 
    namespace models { 
      namespace stm { 
        ...
        /**
         * Symbol "edu.csdms.models.stm.AgDegNormGravMixSubPW" (version 0.0)
         */
        class AgDegNormGravMixSubPW_impl : public virtual 
          ::edu::csdms::models::stm::AgDegNormGravMixSubPW 
        // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormGravMixSubPW._inherits)
        // Insert-Code-Here {edu.csdms.models.stm.AgDegNormGravMixSubPW._inherits} (optional inheritance here)
        // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormGravMixSubPW._inherits)
        ...
        protected:
          ...
          // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormGravMixSubPW._implementation)

  // Insert-UserCode-Here(edu.csdms.models.stm.AgDegNormGravMixSubPW._implementation)
gov::cca::TypeMap userinput;
  ...
  // Bocca generated code. bocca.protected.begin(edu.csdms.models.stm.AgDegNormGravMixSubPW._implementation)
  
   gov::cca::Services    d_services; // our cca handle.
 

  // Bocca generated code. bocca.protected.end(edu.csdms.models.stm.AgDegNormGravMixSubPW._implementation)

          // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormGravMixSubPW._implementation)

        public:
          // default constructor, used for data wrapping(required)
          AgDegNormGravMixSubPW_impl();
          // sidl constructor (required)
          // Note: alternate Skel constructor doesn't call addref()
          // (fixes bug #275)
            AgDegNormGravMixSubPW_impl( struct 
          ...
          virtual ~AgDegNormGravMixSubPW_impl() { _dtor(); }
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormGravMixSubPW._hmisc)
// Insert-Code-Here {edu.csdms.models.stm.AgDegNormGravMixSubPW._hmisc} (miscellaneous things)
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormGravMixSubPW._hmisc)
