// 
// File:          edu_csdms_models_stm_AgDegNormGravMixPW_Impl.hxx
...
#ifndef included_edu_csdms_models_stm_AgDegNormGravMixPW_Impl_hxx
#define included_edu_csdms_models_stm_AgDegNormGravMixPW_Impl_hxx

#ifndef included_sidl_cxx_hxx
#include "sidl_cxx.hxx"
#endif
#ifndef included_edu_csdms_models_stm_AgDegNormGravMixPW_IOR_h
#include "edu_csdms_models_stm_AgDegNormGravMixPW_IOR.h"
#endif
#ifndef included_edu_csdms_models_stm_AgDegNormGravMixPW_hxx
#include "edu_csdms_models_stm_AgDegNormGravMixPW.hxx"
#endif
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormGravMixPW._hincludes)
// Insert-Code-Here {edu.csdms.models.stm.AgDegNormGravMixPW._hincludes} (includes or arbitrary code)
#include "Initialize.h"
#include "Run.h"
#include "Finalize.h"
#include "SaveDatatoMatrix.h"
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormGravMixPW._hincludes)
  ...
  namespace csdms { 
    namespace models { 
      namespace stm { 
        ...
        /**
         * Symbol "edu.csdms.models.stm.AgDegNormGravMixPW" (version 0.0)
         */
        class AgDegNormGravMixPW_impl : public virtual 
          ::edu::csdms::models::stm::AgDegNormGravMixPW 
        // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormGravMixPW._inherits)
        // Insert-Code-Here {edu.csdms.models.stm.AgDegNormGravMixPW._inherits} (optional inheritance here)
        // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormGravMixPW._inherits)
        ...
        protected:
          ...
          // DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormGravMixPW._implementation)

  // Insert-UserCode-Here(edu.csdms.models.stm.AgDegNormGravMixPW._implementation)
gov::cca::TypeMap userinput;
	...
	double (*Hmatrix)[101], (*tausgmatrix)[101], (*Slmatrix)[101];
        double (*D90matrix)[101] ;

  // Bocca generated code. bocca.protected.begin(edu.csdms.models.stm.AgDegNormGravMixPW._implementation)
  
   gov::cca::Services    d_services; // our cca handle.
 

  // Bocca generated code. bocca.protected.end(edu.csdms.models.stm.AgDegNormGravMixPW._implementation)

          // DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormGravMixPW._implementation)

        public:
          // default constructor, used for data wrapping(required)
          AgDegNormGravMixPW_impl();
          // sidl constructor (required)
          // Note: alternate Skel constructor doesn't call addref()
          // (fixes bug #275)
            AgDegNormGravMixPW_impl( struct 
              edu_csdms_models_stm_AgDegNormGravMixPW__object * ior ) : 
              StubBase(ior,true), 
          ...
          virtual ~AgDegNormGravMixPW_impl() { _dtor(); }
        ...
        };  // end class AgDegNormGravMixPW_impl
...
// DO-NOT-DELETE splicer.begin(edu.csdms.models.stm.AgDegNormGravMixPW._hmisc)
// Insert-Code-Here {edu.csdms.models.stm.AgDegNormGravMixPW._hmisc} (miscellaneous things)
// DO-NOT-DELETE splicer.end(edu.csdms.models.stm.AgDegNormGravMixPW._hmisc)
