...
! Add edu.csdms.ports.IRFPort:ROMS provides port
  call addProvidesPort(dp%d_private_data%d_services, port, &
       ...
       typeMap, exception)
  BOCCA_SIDL_CHECK_F90(exception,'edu.csdms.models.chesROMS failed addProvidesPort ROMS ')
...
recursive subroutine chesROM_initializegkwqtkjwp2_mi(self, properties,         &
  exception)
  use sidl
  use sidl_NotImplementedException
  use sidl_BaseInterface
...
recursive subroutine chesROMS_run9s4ewmm5nldmuutn_mi(self, time, exception)
  use sidl
  use sidl_NotImplementedException
  use sidl_BaseInterface
  use sidl_RuntimeException
  use edu_csdms_models_chesROMS
  use edu_csdms_models_chesROMS_impl
  ! DO-NOT-DELETE splicer.begin(edu.csdms.models.chesROMS.run.use)
  ! Insert-Code-Here {edu.csdms.models.ROMS.run.use} (use statements)
  ! DO-NOT-DELETE splicer.end(edu.csdms.models.chesROMS.run.use)
  implicit none
  type(edu_csdms_models_chesROMS_t) :: self
  ! in
...
! DO-NOT-DELETE splicer.begin(edu.csdms.models.chesROMS.run)
...
! DO-NOT-DELETE splicer.end(edu.csdms.models.chesROMS.run)
end subroutine chesROMS_run9s4ewmm5nldmuutn_mi
...
recursive subroutine ch_get_element_set6vkvyvhsi5_mi(self, val_string, retval, &
  exception)
  use sidl
  use sidl_NotImplementedException
  ...
  use edu_csdms_models_chesROMS
  use edu_csdms_models_chesROMS_impl
  ! DO-NOT-DELETE splicer.begin(edu.csdms.models.chesROMS.get_element_set.use)
  ! Insert-Code-Here {edu.csdms.models.ROMS.get_element_set.use} (use statements)
  ! DO-NOT-DELETE splicer.end(edu.csdms.models.chesROMS.get_element_set.use)
  implicit none
  type(edu_csdms_models_chesROMS_t) :: self
  ! in
  character (len=*) :: val_string
...
! DO-NOT-DELETE splicer.begin(edu.csdms.models.chesROMS.get_element_set)
...
! DO-NOT-DELETE splicer.end(edu.csdms.models.chesROMS.get_element_set)
end subroutine ch_get_element_set6vkvyvhsi5_mi
...
recursive subroutine ches_get_value_setoc8yk3t3d9_mi(self, val_string, retval, &
  exception)
  use sidl
  use sidl_NotImplementedException
  ...
  use edu_csdms_models_chesROMS
  use edu_csdms_models_chesROMS_impl
  ! DO-NOT-DELETE splicer.begin(edu.csdms.models.chesROMS.get_value_set.use)
  ! Insert-Code-Here {edu.csdms.models.ROMS.get_value_set.use} (use statements)
  ! DO-NOT-DELETE splicer.end(edu.csdms.models.chesROMS.get_value_set.use)
  implicit none
  type(edu_csdms_models_chesROMS_t) :: self
  ! in
  character (len=*) :: val_string
...
! DO-NOT-DELETE splicer.begin(edu.csdms.models.chesROMS.get_value_set)
...
! DO-NOT-DELETE splicer.end(edu.csdms.models.chesROMS.get_value_set)
end subroutine ches_get_value_setoc8yk3t3d9_mi
...
recursive subroutine ches_set_value_seti3lbxtozvf_mi(self, val_string, values, &
  exception)
  use sidl
  use sidl_NotImplementedException
  use edu_csdms_openmi_IValueSet
  ...
  use edu_csdms_models_chesROMS
  use edu_csdms_models_chesROMS_impl
  ! DO-NOT-DELETE splicer.begin(edu.csdms.models.chesROMS.set_value_set.use)
  ! Insert-Code-Here {edu.csdms.models.ROMS.set_value_set.use} (use statements)
  ! DO-NOT-DELETE splicer.end(edu.csdms.models.chesROMS.set_value_set.use)
  implicit none
  type(edu_csdms_models_chesROMS_t) :: self
  ! in
  character (len=*) :: val_string
...
! DO-NOT-DELETE splicer.begin(edu.csdms.models.chesROMS.set_value_set)
...
! DO-NOT-DELETE splicer.end(edu.csdms.models.chesROMS.set_value_set)
end subroutine ches_set_value_seti3lbxtozvf_mi
